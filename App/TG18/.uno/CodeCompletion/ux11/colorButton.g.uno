...
public partial class colorButton: customButtonCircle
{
    ...
    void InitializeUX()
    {
        ...
        var temp5 = new global::Fuse.Reactive.Property(temp2, TG18_accessor_colorButton_ButtonColor.Singleton);
        this_ButtonName_inst = new TG18_colorButton_ButtonName_Property(this, __selector1);
        this_ButtonColor_inst = new TG18_colorButton_ButtonColor_Property(this, __selector2);
