...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp18 = new global::ControlPage();
        var temp19 = new global::Fuse.Controls.Panel();
        var temp20 = new global::CustomButton();
        var temp21 = new global::CustomButton();
        temp16.Children.Add(temp17);
        temp17.Children.Add(temp18);
        temp18.Title = "Hev og senk";
        temp18.Color = float4(0.9960784f, 0.9921569f, 0.9882353f, 1f);
        temp18.HeaderColor = float4(0.3490196f, 0.372549f, 1f, 1f);
        temp18.HeaderTextColor = float4(1f, 1f, 1f, 1f);
        temp18.Children.Add(temp19);
        temp19.Color = float4(0f, 0f, 0f, 1f);
        temp19.Children.Add(temp20);
        temp19.Children.Add(temp21);
        temp20.Width = new Uno.UX.Size(50f, Uno.UX.Unit.Percent);
        temp20.Height = new Uno.UX.Size(20f, Uno.UX.Unit.Percent);
        temp20.TextColor = float4(0f, 0f, 0f, 255f);
        temp20.Text = "Opp";
        temp21.Width = new Uno.UX.Size(50f, Uno.UX.Unit.Percent);
        temp21.Height = new Uno.UX.Size(20f, Uno.UX.Unit.Percent);
        temp21.TextColor = float4(0f, 0f, 0f, 255f);
        temp21.Text = "Ned";
