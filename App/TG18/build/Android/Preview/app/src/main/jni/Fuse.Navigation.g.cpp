...
#include <Fuse.Animations.Anima-274f2a53.h>
#include <Fuse.Animations.Easing.h>
#include <Fuse.Diagnostics.h>
#include <Fuse.Elements.Element.h>
#include <Fuse.Gestures.DegreeSpan.h>
#include <Fuse.Gestures.Edge.h>
#include <Fuse.Gestures.Interna-5ee863d1.h>
#include <Fuse.Gestures.SwipeGe-776b1f69.h>
...
#include <Fuse.Input.PointerPre-46d8c90c.h>
#include <Fuse.Input.PointerPressedArgs.h>
#include <Fuse.Input.PointerRel-d13a8586.h>
...
#include <Fuse.Motion.Simulatio-3c9694a.h>
#include <Fuse.Motion.Simulatio-625f2f9b.h>
#include <Fuse.Motion.Simulatio-856a768f.h>
#include <Fuse.Motion.Simulatio-92cee221.h>
#include <Fuse.Motion.Simulatio-a58c577b.h>
#include <Fuse.Navigation.Activ-2c58c273.h>
#include <Fuse.Navigation.Activated.h>
#include <Fuse.Navigation.Activ-ba581989.h>
#include <Fuse.Navigation.Activ-ff905cbb.h>
#include <Fuse.Navigation.Allow-96c44606.h>
#include <Fuse.Navigation.BackB-bb3d9d11.h>
#include <Fuse.Navigation.BackF-474a16c6.h>
#include <Fuse.Navigation.Deact-dff1431e.h>
#include <Fuse.Navigation.Deactivated.h>
#include <Fuse.Navigation.Direc-a636f54.h>
#include <Fuse.Navigation.EdgeNavigation.h>
#include <Fuse.Navigation.EndSeekArgs.h>
#include <Fuse.Navigation.Enter-58096783.h>
#include <Fuse.Navigation.Enter-e6d0da19.h>
#include <Fuse.Navigation.Exiti-5497b5ec.h>
#include <Fuse.Navigation.Expli-b29b2019.h>
#include <Fuse.Navigation.GoBack.h>
#include <Fuse.Navigation.GoForward.h>
#include <Fuse.Navigation.Hiera-14d792a9.h>
#include <Fuse.Navigation.Histo-b609392.h>
#include <Fuse.Navigation.IBase-6ef44c1d.h>
#include <Fuse.Navigation.INavigation.h>
#include <Fuse.Navigation.IPage-680831c5.h>
#include <Fuse.Navigation.IPage-bc066382.h>
#include <Fuse.Navigation.IRouterOutlet.h>
#include <Fuse.Navigation.ISeek-5e75bfda.h>
#include <Fuse.Navigation.Linea-538b6e7a.h>
#include <Fuse.Navigation.ModifyRouteHow.h>
#include <Fuse.Navigation.Navig-5565398f.h>
#include <Fuse.Navigation.Navig-59d0e775.h>
#include <Fuse.Navigation.Navig-7bfa875e.h>
#include <Fuse.Navigation.Navig-896d01fb.h>
#include <Fuse.Navigation.Navig-90b5b121.h>
#include <Fuse.Navigation.Navig-90c1eee8.h>
#include <Fuse.Navigation.Navig-981191bf.h>
#include <Fuse.Navigation.Navig-a2eacdbd.h>
#include <Fuse.Navigation.Navig-adff794c.h>
...
#include <Fuse.Navigation.Navig-ba21f3a3.h>
#include <Fuse.Navigation.Navig-bdb3602c.h>
#include <Fuse.Navigation.Navig-cf4a7cb0.h>
#include <Fuse.Navigation.Navig-d2503dd0.h>
#include <Fuse.Navigation.Navig-d3aeb022.h>
#include <Fuse.Navigation.NavTriggerUtil.h>
#include <Fuse.Navigation.OutletType.h>
#include <Fuse.Navigation.PageE-240783e6.h>
#include <Fuse.Navigation.PageExpression.h>
#include <Fuse.Navigation.PageR-ae858a14.h>
#include <Fuse.Navigation.Route.h>
#include <Fuse.Navigation.Route-b21d265.h>
#include <Fuse.Navigation.Route-dbaafdf.h>
#include <Fuse.Navigation.Router.h>
#include <Fuse.Navigation.RouterModify.h>
#include <Fuse.Navigation.Routi-985a8d5a.h>
#include <Fuse.Navigation.RoutingResult.h>
#include <Fuse.Navigation.SnapTo.h>
#include <Fuse.Navigation.Struc-cf29dee4.h>
#include <Fuse.Navigation.Struc-e50a61f1.h>
#include <Fuse.Navigation.SwipeDirection.h>
#include <Fuse.Navigation.SwipeNavigate.h>
#include <Fuse.Navigation.UpdateSeekArgs.h>
#include <Fuse.Navigation.Visua-4f488356.h>
#include <Fuse.Navigation.Visua-b0ea7b98.h>
#include <Fuse.Navigation.While-19639125.h>
#include <Fuse.Navigation.While-2b1763fb.h>
#include <Fuse.Navigation.While-361ff13c.h>
#include <Fuse.Navigation.While-55b8facb.h>
#include <Fuse.Navigation.While-8bec3276.h>
#include <Fuse.Navigation.WhileActive.h>
#include <Fuse.Navigation.While-b8230eb3.h>
#include <Fuse.Navigation.While-bd15b6ce.h>
...
#include <Fuse.Time.h>
#include <Fuse.Triggers.PulseTr-b668fdd1.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Navigation\0.47.7\$.uno
// ----------------------------------------------------------------------------
...
static void BackForwardNavigationTriggerAction_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
...
void BackForwardNavigationTriggerAction__Perform_fn(BackForwardNavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (nav != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"No Navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4395, ::STRINGS[2/*"Perform"*/], NULL);
}
...
static void EdgeNavigation_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("../../../Packages/Fuse.Navigation/0.47.7/$.uno");
...
void EdgeNavigation__OnRooted_fn(EdgeNavigation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[7/*"Element"*/], __this->Parent(), __this, ::STRINGS[1/*"C:\\Users\\...*/], 363, ::STRINGS[8/*"OnRooted"*/]);
...
void EdgeNavigation::OnProgressChanged(uObject* s, double progress)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Unexpected ...*/], 1, ::STRINGS[6/*"../../../Pa...*/], 440);
        return;
    }
...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"No Page was...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4376, ::STRINGS[2/*"Perform"*/], NULL);
}
...
uObject* Navigation::TryFindBaseNavigation1(::g::Fuse::Node* node, ::g::Fuse::Visual** parent)
{
    ...
    *parent = NULL;
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"TryFindBase...*/], node, ::STRINGS[1/*"C:\\Users\\...*/], 857, ::STRINGS[14/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"TryFindPage...*/], node, ::STRINGS[1/*"C:\\Users\\...*/], 918, ::STRINGS[16/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[17/*"`Page` set ...*/], p, ::STRINGS[1/*"C:\\Users\\...*/], 939, ::STRINGS[16/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
static void NavigationPageProxy_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("Rooted");
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Got an unde...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1069, ::STRINGS[19/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"Attempting ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1032, ::STRINGS[21/*"Rooted"*/]);
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"Unable to l...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1039, ::STRINGS[21/*"Rooted"*/], NULL);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[23/*"Something w...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1056, ::STRINGS[21/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[24/*"No navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4272, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
{
    ::STRINGS[25] = uString::Const("PageResourceBinding has been deprecated. Use DataBinding instead");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[26] = uString::Const(".ctor");
    ::STRINGS[27] = uString::Const("target");
...
void PageResourceBinding::ctor_3(::g::Uno::UX::Property1* target, uString* key)
{
    ...
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[25/*"PageResourc...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1639, ::STRINGS[26/*".ctor"*/]);

    if (target == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[27/*"target"*/]));
...
void PageResourceBinding::OnChanged()
{
    ...
    if (page != NULL)
    {
        if ((::g::Uno::String::op_Equality(Key(), ::STRINGS[28/*"Visual"*/]) || ::g::Uno::String::op_Equality(Key(), ::STRINGS[29/*"Node"*/])) && uIs(page, __types[0]))
...
static void Route_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("count can't be < 0");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[33] = uString::Const("SubDepth");
    type->SetFields(0,
...
uString* Route::Format()
{
    ...
    if (::g::Uno::String::op_Inequality(Parameter, NULL))
        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition2(::STRINGS[30/*"?"*/], Parameter));

    if (SubRoute != NULL)
        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition2(::STRINGS[31/*"/"*/], uPtr(SubRoute)->Format()));
...
Route* Route::SubDepth(int count)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[32/*"count can't...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2034, ::STRINGS[33/*"SubDepth"*/]);
        return NULL;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[34/*Fuse.Scripting.ScriptMember[]*/], 8, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[34/*"bookmark"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Bookmark_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[35/*"getRoute"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__GetRoute_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[36/*"goBack"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__GoBack1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[37/*"goto"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Goto1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[38/*"gotoRelative"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__GotoRelative_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[39/*"modify"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Modify1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[40/*"push"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Push1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[35/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[41/*"pushRelative"*/], uDelegate::New(::TYPES[36/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__PushRelative_fn), 2)));
}

static void Router_build(uType* type)
{
    ::STRINGS[34] = uString::Const("bookmark");
    ::STRINGS[35] = uString::Const("getRoute");
    ::STRINGS[36] = uString::Const("goBack");
    ::STRINGS[37] = uString::Const("goto");
    ::STRINGS[38] = uString::Const("gotoRelative");
    ::STRINGS[39] = uString::Const("modify");
    ::STRINGS[40] = uString::Const("push");
    ::STRINGS[41] = uString::Const("pushRelative");
    ::STRINGS[42] = uString::Const("`Router.bookmark` takes one argument");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[43] = uString::Const("Bookmark");
    ::STRINGS[44] = uString::Const("`Router.bookmark` should be passed an object");
    ::STRINGS[10] = uString::Const("name");
    ::STRINGS[45] = uString::Const("relative");
    ::STRINGS[46] = uString::Const("Could not find an outlet from the `relative` node");
    ::STRINGS[47] = uString::Const("path");
    ::STRINGS[48] = uString::Const("`path` should be an array");
    ::STRINGS[49] = uString::Const("Unrecognized argument: ");
    ::STRINGS[50] = uString::Const("A `name` is required for the bookmark");
    ::STRINGS[51] = uString::Const("No active navigation that can be cancelled");
    ::STRINGS[52] = uString::Const("CancelNavigation");
    ::STRINGS[11] = uString::Const("");
    ::STRINGS[53] = uString::Const("Router.gotoRelative(): requires 1+ parameters");
    ::STRINGS[54] = uString::Const("GetRelative");
    ::STRINGS[55] = uString::Const("Cannot calculate relative node if not rooted");
    ::STRINGS[56] = uString::Const("GetRelativeRoute");
    ::STRINGS[57] = uString::Const("Did not find an outlet relative to the provided Node");
    ::STRINGS[58] = uString::Const("Router.getRoute(): must provide exactly 1 argument.");
    ::STRINGS[59] = uString::Const("GetRoute");
    ::STRINGS[60] = uString::Const("Router.getRoute(): argument must be a function.");
    ::STRINGS[61] = uString::Const("Router.goBack takes no parameters");
    ::STRINGS[62] = uString::Const("GoBack");
    ::STRINGS[63] = uString::Const("Router.goto(): invalid route provided");
    ::STRINGS[64] = uString::Const("Goto");
    ::STRINGS[65] = uString::Const("PrepareBack does not support an explicit route");
    ::STRINGS[66] = uString::Const("Modify");
    ::STRINGS[67] = uString::Const("There is no history for PrepareBack");
    ::STRINGS[68] = uString::Const("`Router.modify` takes one argument");
    ::STRINGS[69] = uString::Const("`Router.modify` should be passed an object");
    ::STRINGS[70] = uString::Const("how");
    ::STRINGS[71] = uString::Const("transition");
    ::STRINGS[72] = uString::Const("Unknown bookmark: ");
    ::STRINGS[73] = uString::Const("style");
    ::STRINGS[74] = uString::Const("Cannot pop() - history is empty");
    ::STRINGS[75] = uString::Const("Pop");
    ::STRINGS[76] = uString::Const("Invalid outlet depth in prepare progress");
    ::STRINGS[77] = uString::Const("SetPrepareProgress");
    ::STRINGS[78] = uString::Const("Unable to navigate to route: ");
    ::STRINGS[79] = uString::Const("SetRoute");
    ::STRINGS[80] = uString::Const("No router outlet found to handle route: ");
    ::STRINGS[81] = uString::Const("SetRouteImpl");
    ::STRINGS[82] = uString::Const("SubRoute requested but outlet has no active path: ");
    ::STRINGS[83] = uString::Const("Route parameter must be serializeable, it contains reference loops or is too large");
    ::STRINGS[84] = uString::Const("ValidateParameter");
    ::STRINGS[85] = uString::Const("Route parameter must be serializeable, cannot contain Observables.");
    ::STRINGS[86] = uString::Const("Route parameter must be serializeable, cannot contain functions.");
...
void Router::CancelNavigation()
{
    ...
    if (_prepareOutlet != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[51/*"No active n...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2937, ::STRINGS[52/*"CancelNavig...*/]);
}
...
::g::Fuse::Navigation::Route* Router::GetRelativeRoute(::g::Fuse::Node* from, ::g::Fuse::Navigation::Route* rel)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[55/*"Cannot calc...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3135, ::STRINGS[56/*"GetRelative...*/], NULL);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[57/*"Did not fin...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3142, ::STRINGS[56/*"GetRelative...*/], NULL);
        return NULL;
    }
...
void Router::Modify(int how, ::g::Fuse::Navigation::Route* route, int mode, uString* operationStyle)
{
    ...
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(::STRINGS[65/*"PrepareBack...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2757, ::STRINGS[66/*"Modify"*/]);

            if (uPtr(_history)->Count() == 0)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"There is no...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2761, ::STRINGS[66/*"Modify"*/], NULL);
                return;
            }
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[74/*"Cannot pop(...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2839, ::STRINGS[75/*"Pop"*/], NULL);
        return;
    }
...
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[76/*"Invalid out...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2918, ::STRINGS[77/*"SetPrepareP...*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        uString* msg = ::g::Uno::String::op_Addition2(::STRINGS[78/*"Unable to n...*/], uPtr(r)->Format());

        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"C:\\Users\\...*/], 2955, ::STRINGS[79/*"SetRoute"*/], NULL);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"C:\\Users\\...*/], 2957, ::STRINGS[79/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, uObject** majorChange)
{
    ...
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[80/*"No router o...*/], r), this, ::STRINGS[1/*"C:\\Users\\...*/], 2976, ::STRINGS[81/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[82/*"SubRoute re...*/], r), this, ::STRINGS[1/*"C:\\Users\\...*/], 3002, ::STRINGS[81/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[42/*"`Router.boo...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2337, ::STRINGS[43/*"Bookmark"*/], NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"`Router.boo...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2344, ::STRINGS[43/*"Bookmark"*/], NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[45/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Could not f...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2368, ::STRINGS[43/*"Bookmark"*/], NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[47/*"path"*/]))
        {
            ::g::Fuse::Scripting::Array* path = uAs< ::g::Fuse::Scripting::Array*>(o, ::TYPES[42/*Fuse.Scripting.Array*/]);

            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"`path` shou...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2377, ::STRINGS[43/*"Bookmark"*/], NULL);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[49/*"Unrecognize...*/], p), r, ::STRINGS[1/*"C:\\Users\\...*/], 2385, ::STRINGS[43/*"Bookmark"*/], NULL);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"A `name` is...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2398, ::STRINGS[43/*"Bookmark"*/], NULL);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2148, ::STRINGS[54/*"GetRelative"*/], NULL);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[58/*"Router.getR...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2490, ::STRINGS[59/*"GetRoute"*/], NULL);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"Router.getR...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2496, ::STRINGS[59/*"GetRoute"*/], NULL);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"Router.goBa...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2193, ::STRINGS[62/*"GoBack"*/], NULL);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2097, ::STRINGS[64/*"Goto"*/], NULL);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"`Router.mod...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2234, ::STRINGS[66/*"Modify"*/], NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[69/*"`Router.mod...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2241, ::STRINGS[66/*"Modify"*/], NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        if (::g::Uno::String::op_Equality(p, ::STRINGS[70/*"how"*/]))
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[47/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"`path` shou...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2265, ::STRINGS[66/*"Modify"*/], NULL);
                return;
            }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[45/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Could not f...*/], r, ::STRINGS[1/*"C:\\Users\\...*/], 2277, ::STRINGS[66/*"Modify"*/], NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[71/*"transition"*/]))
            mode = (::g::Fuse::Marshal__ToType_fn(::TYPES[46/*Fuse.Marshal.ToType<Fuse.Navigation.NavigationGotoMode>*/], o, &ret7), ret7);
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[34/*"bookmark"*/]))
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[72/*"Unknown boo...*/], bk), r, ::STRINGS[1/*"C:\\Users\\...*/], 2290, ::STRINGS[66/*"Modify"*/], NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[73/*"style"*/]))
            style = (::g::Fuse::Marshal__ToType_fn(::TYPES[40/*Fuse.Marshal.ToType<string>*/], o, &ret10), ret10);
        else
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[49/*"Unrecognize...*/], p), r, ::STRINGS[1/*"C:\\Users\\...*/], 2300, ::STRINGS[66/*"Modify"*/], NULL);
            return;
        }
    }
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[83/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2409, ::STRINGS[84/*"ValidatePar...*/], NULL);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[39/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[85/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2418, ::STRINGS[84/*"ValidatePar...*/], NULL);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[86/*"Route param...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 2441, ::STRINGS[84/*"ValidatePar...*/], NULL);
        return false;
    }
...
{
    ::STRINGS[87] = uString::Const("Router not set and none could be found");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetFields(9,
...
void RouterCancelNavigation__Perform_fn(RouterCancelNavigation* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[87/*"Router not ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3224, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void RouterModify__Perform_fn(RouterModify* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[87/*"Router not ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3276, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
    ...
    if (::g::Uno::String::op_Inequality(__this->Bookmark(), NULL))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[72/*"Unknown boo...*/], __this->Bookmark()), __this, ::STRINGS[1/*"C:\\Users\\...*/], 3286, ::STRINGS[2/*"Perform"*/], NULL);
            return;
        }
    }
...
{
    ::STRINGS[88] = uString::Const("Seek being called on an unrooted navigation");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[89] = uString::Const("Fuse.Navigation.ISeekableNavigation.Seek");
    ::STRINGS[90] = uString::Const("Attempting to navigate to element with different parent");
    ::STRINGS[91] = uString::Const("GotoImpl");
    ::STRINGS[92] = uString::Const("Updated called without a region");
    ::STRINGS[93] = uString::Const("OnUpdated");
    ::STRINGS[94] = uString::Const("Use a `NavigationMotion` and the `GotoDuration` property instead of `Navigation.Duration`");
    ::STRINGS[95] = uString::Const("set_Duration");
    ::STRINGS[96] = uString::Const("Use a `NavigationMotion` and the `GotoEasing` property instead of `Navigation.Easing`");
    ::STRINGS[97] = uString::Const("set_Easing");
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[88/*"Seek being ...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 3705, ::STRINGS[89/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::Duration(double value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[94/*"Use a `Navi...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3607, ::STRINGS[95/*"set_Duration"*/]);
}
...
void StructuredNavigation::Easing(::g::Fuse::Animations::Easing* value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[96/*"Use a `Navi...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3598, ::STRINGS[97/*"set_Easing"*/]);
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[90/*"Attempting ...*/], element, ::STRINGS[1/*"C:\\Users\\...*/], 3414, ::STRINGS[91/*"GotoImpl"*/], NULL);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[98/*"Motion shou...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3341, ::STRINGS[99/*"set_Motion"*/], NULL);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[92/*"Updated cal...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 3505, ::STRINGS[93/*"OnUpdated"*/]);
        return;
    }
...
{
    ::STRINGS[100] = uString::Const("SwipeNavigate: failed to find suitable Navigation object");
    ::STRINGS[6] = uString::Const("../../../Packages/Fuse.Navigation/0.47.7/$.uno");
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[100/*"SwipeNaviga...*/], 1, ::STRINGS[6/*"../../../Pa...*/], 4055);
        return;
    }
...
{
    VisualNavigation::ActiveIndexName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[101/*"ActiveIndex"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[34/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[61/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[37/*"goto"*/], uDelegate::New(::TYPES[62/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}

static void VisualNavigation_build(uType* type)
{
    ::STRINGS[101] = uString::Const("ActiveIndex");
    ::STRINGS[37] = uString::Const("goto");
    ::STRINGS[102] = uString::Const("Navigation.goto() : Argument must be a node object");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[103] = uString::Const("gotoNode");
    ::TYPES[33] = ::g::Uno::Type_typeof();
    ::TYPES[34] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[102/*"Navigation....*/], nav, ::STRINGS[1/*"C:\\Users\\...*/], 4508, ::STRINGS[103/*"gotoNode"*/], NULL);
}
// }
...
{
    ::STRINGS[104] = uString::Const("WhileHistoryTrigger requires a Navigation context");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[8] = uString::Const("OnRooted");
    ::TYPES[17] = ::g::Fuse::Navigation::IBaseNavigation_typeof();
    ::TYPES[50] = ::g::Fuse::Navigation::HistoryChangedHandler_typeof();
...
void WhileHistoryTrigger__OnRooted_fn(WhileHistoryTrigger* __this)
{
    ...
    if (__this->NavigationContext() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[104/*"WhileHistor...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4779, ::STRINGS[8/*"OnRooted"*/], NULL);
        return;
    }
...
{
    ::STRINGS[105] = uString::Const("WhileNavigating requires a Navigation context");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[8] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[67] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
...
void WhileNavigating__OnRooted_fn(WhileNavigating* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[105/*"WhileNaviga...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 4860, ::STRINGS[8/*"OnRooted"*/], NULL);
        return;
    }
...
{
    ::STRINGS[106] = uString::Const("Must be used within a navigation context");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\0.47.7\\$.uno");
    ::STRINGS[8] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[23] = ::g::Fuse::Navigation::NavigationHandler_typeof();
...
void WhilePageActive__OnRooted_fn(WhilePageActive* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[106/*"Must be use...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 5175, ::STRINGS[8/*"OnRooted"*/], NULL);
        return;
    }
