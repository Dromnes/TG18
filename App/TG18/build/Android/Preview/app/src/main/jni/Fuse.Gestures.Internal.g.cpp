...
#include <Fuse.Gestures.Interna-45d198d0.h>
...
#include <Fuse.Gestures.Interna-cace70c8.h>
#include <Fuse.Gestures.Interna-d11b2f49.h>
#include <Fuse.Gestures.Interna-e8e4a78e.h>
...
#include <Fuse.Motion.Simulatio-bdef395c.h>
#include <Fuse.Node.h>
...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\0.47.7\\internal\\$.uno");
...
void Swiper__FuseInputIGestureOnCapture_fn(Swiper* __this, ::g::Fuse::Input::PointerEventArgs* args, int* how)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"invalid OnC...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 1088, ::STRINGS[4/*"Fuse.Input....*/]);
        return;
    }
...
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"incomplete ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1010, ::STRINGS[2/*"CheckNeedUp...*/]);
...
bool SwipeRegion::SetProgress(double value, int flags)
{
    ...
    if (endProgress)
    {
        if (!((_progress == 1.0) || (_progress == 0.0)))
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"Unexpected ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 748, ::STRINGS[9/*"SetProgress"*/]);
