...
#include <Android.Base.Wrappers-f1c8189.h>
...
#include <Fuse.Controls.Default-e6102a36.h>
#include <Fuse.Controls.GraphicsView.h>
#include <Fuse.Controls.INativeViewRoot.h>
#include <Fuse.Controls.ITextRenderer.h>
#include <Fuse.Controls.Native.-c7645e49.h>
#include <Fuse.Controls.TextControl.h>
#include <Fuse.Controls.TreeRen-f1d031eb.h>
...
#include <Fuse.Input.FocusNavig-815405e7.h>
#include <Fuse.Input.Keyboard.h>
#include <Fuse.Input.TextService.h>
#include <Fuse.Internal.FontFac-ce1c8c0c.h>
...
#include <Fuse.RequestBringInto-8d69fdcc.h>
...
#include <Fuse.Resources.Resour-628dd08f.h>
...
#include <Fuse.Scripting.IEvent-d7a82197.h>
#include <Fuse.Scripting.Object.h>
#include <Fuse.Scripting.Script-27b2f32f.h>
#include <Fuse.Scripting.Script-6731f3bf.h>
...
#include <Fuse.TranslationModes-53aa3ad2.h>
#include <Fuse.TranslationModes-689c6616.h>
#include <Fuse.TranslationModes-a0eb9bb.h>
#include <Fuse.TranslationModes-bb76b1d1.h>
...
#include <Fuse.Visual.CancelInt-fe0ed2d2.h>
#include <Fuse.Visual.h>
#include <Fuse.Visual.HitTestRecord.h>
#include <Fuse.Visual.HitTestTr-c7ce7669.h>
...
#include <Uno.ArgumentOutOfRang-fec1f9ca.h>
#include <Uno.Array.h>
#include <Uno.Bool.h>
#include <Uno.Buffer.h>
#include <Uno.Byte.h>
#include <Uno.Char.h>
#include <Uno.Collections.Dicti-a9ba497d.h>
#include <Uno.Collections.Dicti-c31dd20b.h>
#include <Uno.Collections.Dicti-c7b6fb8d.h>
#include <Uno.Collections.Dictionary-2.h>
#include <Uno.Collections.Enume-975d23de.h>
...
#include <Uno.Collections.IList-468b1241.h>
#include <Uno.Collections.KeyValuePair-2.h>
#include <Uno.Collections.List-1.h>
#include <Uno.Collections.List--a77a08a2.h>
#include <Uno.Collections.Obser-e1062ea9.h>
#include <Uno.Collections.Prior-338f7fba.h>
#include <Uno.Collections.Prior-faf91ab2.h>
#include <Uno.Color.h>
#include <Uno.Comparison-1.h>
#include <Uno.Compiler.ExportTa-8df74b00.h>
#include <Uno.Data.Json.JsonWriter.h>
#include <Uno.Delegate.h>
#include <Uno.Diagnostics.Clock.h>
#include <Uno.Diagnostics.Debug.h>
#include <Uno.Diagnostics.Debug-71284d3.h>
...
#include <Uno.Platform.EventSou-1ddd7161.h>
#include <Uno.Platform.Key.h>
#include <Uno.Platform.KeyEventArgs.h>
#include <Uno.Platform.TextInpu-b36b7d02.h>
...
#include <Uno.Runtime.Implement-7b5e00e3.h>
#include <Uno.Runtime.Implement-c5fadc0b.h>
#include <Uno.Runtime.Implement-f3527fda.h>
#include <Uno.SByte.h>
#include <Uno.Short.h>
#include <Uno.String.h>
#include <Uno.Text.StringBuilder.h>
#include <Uno.Threading.Concurr-8340a947.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Nodes\0.47.7\$.uno
// -----------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Android\0.47.7\$.uno
// -------------------------------------------------------------------------

// public static extern class AndroidProperties :617
// {
...
// private static string GetReleaseVersion() [static] :637
uString* AndroidProperties::GetReleaseVersion()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetReleaseVersion338", "()Ljava/lang/String;");
...
// public static int get_BuildVersion() [static] :622
int AndroidProperties::BuildVersion()
{
    return AndroidProperties::GetBuildVersion();
}

// public static string get_ReleaseVersion() [static] :627
...
// public override sealed Uno.Collections.IList<Fuse.Node> get_Children() :567
...
// private void OnTick(object sender, Uno.Platform.TimerEventArgs args) [instance] :575
...
// private void PropagateBackground() [instance] :599
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\0.47.7\\$.uno");
...
void Binding::Root(::g::Fuse::Node* parent)
{
    ...
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 456, ::STRINGS[4/*"Root"*/]);
...
void Binding::Unroot()
{
    ...
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 465, ::STRINGS[6/*"Unroot"*/]);
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Common\0.47.7\$.uno
// ------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Marshal\0.47.7\$.uno
// -------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Triggers\0.47.7\$.uno
// --------------------------------------------------------------------------
...
static void Deferred_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.47.7\\$.uno");
    ::STRINGS[26] = uString::Const("Fuse.IDeferred.Perform");
    ::STRINGS[23] = uString::Const("");
    ::TYPES[16] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[17] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[19] = ::g::Fuse::Node_typeof();
    ::TYPES[20] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[19/*Fuse.Node*/], NULL);
    ::TYPES[21] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(13,
        ::TYPES[17/*Uno.Collections.List<Fuse.Node>*/], offsetof(::g::Fuse::Deferred, _added), 0,
        ...
        ::TYPES[20/*Uno.Collections.IList<Uno.UX.Template>*/], offsetof(::g::Fuse::Deferred, _templates), 0);
    type->Reflection.SetFunctions(4,
        ...
        new uFunction("get_Templates", NULL, (void*)Deferred__get_Templates_fn, 0, false, ::TYPES[20/*Uno.Collections.IList<Uno.UX.Template>*/], 0));
}
...
void Deferred__FuseIDeferredPerform_fn(Deferred* __this)
{
    ...
    if (__this->_added != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[24/*"Duplicate c...*/], __this, ::STRINGS[25/*"C:\\Users\\...*/], 1006, ::STRINGS[26/*"Fuse.IDefer...*/]);

    int childIndex = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[16/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(__this->Parent())->Children(), __this, &ret2), ret2) + 1;
    __this->_added = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[17/*Uno.Collections.List<Fuse.Node>*/]));

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Templates()), ::TYPES[18/*Uno.Collections.ICollection<Uno.UX.Template>*/])); ++i)
    {
        ::g::Fuse::Node* elm = uAs< ::g::Fuse::Node*>(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Templates()), ::TYPES[20/*Uno.Collections.IList<Uno.UX.Template>*/]), uCRef<int>(i), &ret3), ret3))->New1(), ::TYPES[19/*Fuse.Node*/]);
        uPtr(elm)->OverrideContextParent = __this;
        ::g::Uno::Collections::List__Add_fn(uPtr(__this->_added), elm);
    }

    uPtr(__this->Parent())->InsertNodes(childIndex, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[19/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_added), &ret4), ret4)));
...
uObject* Deferred::Templates()
{
    ...
    if (_templates == NULL)
        _templates = (uObject*)((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[21/*Uno.Collections.List<Uno.UX.Template>*/]));
...
{
    DeferredManager::_pending_ = ((::g::Uno::Collections::PriorityQueue*)::g::Uno::Collections::PriorityQueue::New1(::TYPES[22/*Uno.Collections.PriorityQueue<Fuse.IDeferred>*/], 0));
    DeferredManager::TimeLimit_ = 0.002;
}

static void DeferredManager_build(uType* type)
{
    ::TYPES[22] = ::g::Uno::Collections::PriorityQueue_typeof()->MakeType(::g::Fuse::IDeferred_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[23] = ::g::Fuse::IDeferred_typeof();
    type->SetFields(0,
        ::TYPES[22/*Uno.Collections.PriorityQueue<Fuse.IDeferred>*/], (uintptr_t)&::g::Fuse::DeferredManager::_pending_, uFieldFlagsStatic,
...
void DeferredManager::OnUpdate()
{
    ...
    while (!uPtr(DeferredManager::_pending())->Empty())
    {
        ...
        ::g::Fuse::IDeferred::Perform(uInterface(uPtr(r), ::TYPES[23/*Fuse.IDeferred*/]));
...
void Diagnostic__ToString_fn(Diagnostic* __this, uString** __retval)
{
    ...
    if (::g::Uno::String::op_Inequality(__this->FilePath, NULL))
        msg = ::g::Uno::String::op_Addition2(msg, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"<"*/], __this->FilePath), ::STRINGS[33/*":"*/]), uBox<int>(::TYPES[55/*int*/], __this->LineNumber)), ::STRINGS[34/*">"*/]));
...
{
    Diagnostics::_currentDiagnostics_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[24/*Uno.Collections.List<Fuse.Diagnostic>*/]));
}
...
static void Diagnostics_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("");
    ::TYPES[24] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Diagnostic_typeof(), NULL);
    ::TYPES[25] = ::g::Fuse::DiagnosticHandler_typeof();
    type->SetFields(0,
        ::TYPES[24/*Uno.Collections.List<Fuse.Diagnostic>*/], (uintptr_t)&::g::Fuse::Diagnostics::_currentDiagnostics_, uFieldFlagsStatic,
        ::TYPES[25/*Fuse.DiagnosticHandler*/], (uintptr_t)&::g::Fuse::Diagnostics::DiagnosticReported1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(14,
        ...
        new uFunction("add_DiagnosticReported", NULL, (void*)Diagnostics__add_DiagnosticReported_fn, 0, true, uVoid_typeof(), 1, ::TYPES[25/*Fuse.DiagnosticHandler*/]),
        new uFunction("remove_DiagnosticReported", NULL, (void*)Diagnostics__remove_DiagnosticReported_fn, 0, true, uVoid_typeof(), 1, ::TYPES[25/*Fuse.DiagnosticHandler*/]),
...
void Diagnostics::add_DiagnosticReported(uDelegate* value)
{
    ...
    Diagnostics_typeof()->Init();
    Diagnostics::DiagnosticReported1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Diagnostics::DiagnosticReported1(), value), ::TYPES[25/*Fuse.DiagnosticHandler*/]);
}
...
void Diagnostics::remove_DiagnosticReported(uDelegate* value)
{
    ...
    Diagnostics_typeof()->Init();
    Diagnostics::DiagnosticReported1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Diagnostics::DiagnosticReported1(), value), ::TYPES[25/*Fuse.DiagnosticHandler*/]);
}
// }
...
static void DrawContext_build(uType* type)
{
    ...
    ::TYPES[26] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::IRenderViewport_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::RenderTargetEntry_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int4_typeof(), NULL);
    ::TYPES[29] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::PolygonFace_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[29/*Uno.Collections.List<Uno.Graphics.PolygonFace>*/], offsetof(::g::Fuse::DrawContext, _cullFaces), 0,
        ...
        ::TYPES[28/*Uno.Collections.List<int4>*/], offsetof(::g::Fuse::DrawContext, _glScissors), 0,
        ...
        ::TYPES[27/*Uno.Collections.List<Fuse.RenderTargetEntry>*/], offsetof(::g::Fuse::DrawContext, _renderTargets), 0,
        ...
        ::TYPES[26/*Uno.Collections.List<Fuse.IRenderViewport>*/], offsetof(::g::Fuse::DrawContext, _viewports), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::DrawContext, _IsCaching), 0,
        ::TYPES[36/*Uno.EventHandler*/], offsetof(::g::Fuse::DrawContext, RenderTargetChange1), 0);
    type->Reflection.SetFunctions(27,
        ...
        new uFunction("add_RenderTargetChange", NULL, (void*)DrawContext__add_RenderTargetChange_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        new uFunction("remove_RenderTargetChange", NULL, (void*)DrawContext__remove_RenderTargetChange_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
...
{
    _viewports = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[26/*Uno.Collections.List<Fuse.IRenderViewport>*/]));
    _renderTargets = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[27/*Uno.Collections.List<Fuse.RenderTargetEntry>*/]));
    _glScissors = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[28/*Uno.Collections.List<int4>*/]));
    _cullFaces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[29/*Uno.Collections.List<Uno.Graphics.PolygonFace>*/]));
    _handle = (void*)NULL;
    _viewport = viewport;
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 560, ::STRINGS[40/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 708, ::STRINGS[41/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 626, ::STRINGS[49/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 749, ::STRINGS[50/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 793, ::STRINGS[51/*"set_GLViewp...*/]);
}
...
void DrawContext::PopCullFace()
{
    ...
    int ret3;
    _cullFace = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[31/*Uno.Collections.IListExtensions.RemoveLast<Uno.Graphics.PolygonFace>*/], (uObject*)_cullFaces, &ret3), ret3);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    ::g::Fuse::RenderTargetEntry* old = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[32/*Uno.Collections.IListExtensions.RemoveLast<Fuse.RenderTargetEntry>*/], (uObject*)_renderTargets, &ret4), ret4);
    _renderTarget = uPtr(old)->RenderTarget;
    GLFramebuffer(uPtr(old)->GLFramebuffer);
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 670, ::STRINGS[42/*"PopRenderTa...*/]);
...
void DrawContext::PopScissor()
{
    ...
    ::g::Uno::Int4 ret5;
    ::g::Uno::Int4 s = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[33/*Uno.Collections.IListExtensions.RemoveLast<int4>*/], (uObject*)_glScissors, &ret5), ret5);
    GLScissor(s);
}
...
void DrawContext::PopViewport()
{
    ...
    uObject* ret6;
    OnRenderTargetChange();
    _viewport = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[34/*Uno.Collections.IListExtensions.RemoveLast<Fuse.IRenderViewport>*/], (uObject*)_viewports, &ret6), ret6);
}
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"C:\\Users\\...*/], 655, ::STRINGS[43/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    ...
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[44/*"Unpopped Sc...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 586, ::STRINGS[45/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[46/*"Unpopped Cu...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 590, ::STRINGS[45/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[47/*"Unpopped Vi...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 594, ::STRINGS[45/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"Unpopped Re...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 598, ::STRINGS[45/*"ReleaseRoot...*/]);
...
void DrawContext::add_RenderTargetChange(uDelegate* value)
{
    ...
    RenderTargetChange1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RenderTargetChange1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void DrawContext::remove_RenderTargetChange(uDelegate* value)
{
    ...
    RenderTargetChange1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RenderTargetChange1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void DrawHelpers::init_DrawCalls()
{
    ...
    _draw_311c1aa8 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseNodes_bundle::DrawHelpers53a11bf4());
}
...
static void FileSourceConverter_build(uType* type)
{
    ...
    ::TYPES[40] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[41] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[42] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    type->SetInterfaces(
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[39/*string*/]))
    {
        uString* path = uCast<uString*>(obj, ::TYPES[39/*string*/]);

        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[40/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[41/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[42/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret3), ret3);

            if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), path))
                return ::g::Uno::UX::BundleFileSource::New1(f);
        }

        return ::g::Fuse::JSFileSource::New1(uCast<uString*>(obj, ::TYPES[39/*string*/]));
    }
    else if (uIs(obj, ::TYPES[13/*Fuse.IObject*/]))
        return ::g::Fuse::JSFileSource::New1(uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[13/*Fuse.IObject*/]), ::STRINGS[52/*"path"*/]), ::TYPES[39/*string*/]));
...
{
    ::TYPES[43] = ::g::Fuse::IFrustum_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[43/*Fuse.IFrustum*/], offsetof(::g::Fuse::FixedViewport, _frustum), 0,
...
::g::Uno::Float3 FixedViewport::ViewOrigin()
{
    ...
    return ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(_frustum), ::TYPES[43/*Fuse.IFrustum*/]), (uObject*)this);
}
...
::g::Uno::Float2 FixedViewport::ViewRange()
{
    ...
    return ::g::Fuse::IFrustum::GetDepthRange(uInterface(uPtr(_frustum), ::TYPES[43/*Fuse.IFrustum*/]), (uObject*)this);
}
...
static void FramebufferPoolImpl_build(uType* type)
{
    ...
    ::TYPES[44] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), NULL);
    ::TYPES[45] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), ::g::Uno::Int_typeof(), NULL);
    ::TYPES[46] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), NULL);
    ::TYPES[47] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[48] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof(), NULL);
    type->SetInterfaces(
        ::g::Fuse::Resources::ISoftDisposable_typeof(), offsetof(FramebufferPoolImpl_type, interface0));
    type->SetFields(0,
        ::TYPES[47/*Uno.Collections.List<Fuse.CacheFramebuffer>*/], offsetof(::g::Fuse::FramebufferPoolImpl, cacheFramebuffers), 0,
        ::g::Uno::Int_typeof(), offsetof(::g::Fuse::FramebufferPoolImpl, frame), 0,
        ::TYPES[44/*Uno.Collections.List<framebuffer>*/], offsetof(::g::Fuse::FramebufferPoolImpl, framebufferPool), 0,
        ::g::Uno::Int_typeof(), offsetof(::g::Fuse::FramebufferPoolImpl, framebuffersProvidedSinceLastCollect), 0,
        ::TYPES[45/*Uno.Collections.Dictionary<framebuffer, int>*/], offsetof(::g::Fuse::FramebufferPoolImpl, lastFrameUsed), 0,
        ::TYPES[46/*Uno.Collections.HashSet<framebuffer>*/], offsetof(::g::Fuse::FramebufferPoolImpl, lockedFramebuffers), 0,
...
void FramebufferPoolImpl::ctor_()
{
    ...
    framebufferPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[44/*Uno.Collections.List<framebuffer>*/]));
    lastFrameUsed = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[45/*Uno.Collections.Dictionary<framebuffer, int>*/]));
    lockedFramebuffers = ((::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[46/*Uno.Collections.HashSet<framebuffer>*/]));
    cacheFramebuffers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[47/*Uno.Collections.List<Fuse.CacheFramebuffer>*/]));
...
void FramebufferPoolImpl::CollectCacheFramebuffers()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::CacheFramebuffer*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(cacheFramebuffers), &ret3), ret3); enum1.MoveNext(::TYPES[48/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]); )
    {
        ::g::Fuse::CacheFramebuffer* cfb = enum1.Current(::TYPES[48/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]);
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[53/*"Attempted t...*/], uBox<int>(::TYPES[55/*int*/], width)), ::STRINGS[54/*"x"*/]), uBox<int>(::TYPES[55/*int*/], height)), ::STRINGS[55/*" framebuffe...*/]), uBox<int>(::TYPES[55/*int*/], maxSize)), ::STRINGS[54/*"x"*/]), uBox<int>(::TYPES[55/*int*/], maxSize))));
...
void FrustumViewport::Update(uObject* viewport, uObject* frustum)
{
    ...
    if (::g::Fuse::IFrustum::TryGetProjectionTransform(uInterface(uPtr(frustum), ::TYPES[43/*Fuse.IFrustum*/]), viewport, &ProjectionTransform) && ::g::Fuse::IFrustum::TryGetProjectionTransformInverse(uInterface(uPtr(frustum), ::TYPES[43/*Fuse.IFrustum*/]), viewport, &ProjectionTransformInverse))
    {
        ViewTransform = ::g::Fuse::IFrustum::GetViewTransform(uInterface(uPtr(frustum), ::TYPES[43/*Fuse.IFrustum*/]), viewport);
        ViewTransformInverse = ::g::Fuse::IFrustum::GetViewTransformInverse(uInterface(frustum, ::TYPES[43/*Fuse.IFrustum*/]), viewport);
...
{
    GraphicsWorker::_exceptionQueue_ = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[49/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
}

static void GraphicsWorker_build(uType* type)
{
    ::STRINGS[58] = uString::Const("_exceptionQueue mismatch");
    ::STRINGS[59] = uString::Const("GraphicsWorker failed");
    ::STRINGS[60] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Common\\0.47.7\\$.uno");
    ::STRINGS[61] = uString::Const("Run");
    ::TYPES[49] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Exception_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[5] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[50] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::TYPES[6/*Uno.Action*/], NULL);
    ::TYPES[51] = ::g::Uno::Threading::ThreadStart_typeof();
    type->SetFields(0,
        ::TYPES[49/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], (uintptr_t)&::g::Fuse::GraphicsWorker::_exceptionQueue_, uFieldFlagsStatic,
        ...
        ::TYPES[50/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], (uintptr_t)&::g::Fuse::GraphicsWorker::_work_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(2,
...
void GraphicsWorker::DispatchException()
{
    ...
    if (!(::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_exceptionQueue()), (void**)(&e), &ret1), ret1))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[58/*"_exceptionQ...*/]));
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[59/*"GraphicsWor...*/], e, a, ::STRINGS[60/*"C:\\Users\\...*/], 1884, ::STRINGS[61/*"Run"*/]);
...
void GraphicsWorker::Start()
{
    ...
    GraphicsWorker::_work() = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[50/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    GraphicsWorker::_thread() = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[51/*Uno.Threading.ThreadStart*/], (void*)GraphicsWorker__Run_fn));
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Common\0.47.7\resources\$.uno
// ----------------------------------------------------------------------------------
...
{
    ILoadingStatic::IsLoadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[62/*"IsLoading"*/]);
}

static void ILoadingStatic_build(uType* type)
{
    ::STRINGS[62] = uString::Const("IsLoading");
    type->SetFields(0,
...
static void Json_build(uType* type)
{
    ...
    ::STRINGS[66] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[72] = uString::Const("null");
    ::STRINGS[73] = uString::Const("true");
    ::STRINGS[74] = uString::Const("false");
    ::TYPES[52] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[39] = ::g::Uno::String_typeof();
    ::TYPES[53] = ::g::Uno::Double_typeof();
    ::TYPES[54] = ::g::Uno::Float_typeof();
    ::TYPES[55] = ::g::Uno::Int_typeof();
    ::TYPES[56] = ::g::Uno::Bool_typeof();
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    ::TYPES[57] = ::TYPES[39/*string*/]->Array();
    ::TYPES[58] = ::g::Uno::Array_typeof()->MakeMethod(1/*Copy<string>*/, ::TYPES[39/*string*/], NULL);
    ::TYPES[59] = ::g::Uno::Array_typeof()->MakeMethod(3/*Sort<string>*/, ::TYPES[39/*string*/], NULL);
    ::TYPES[60] = ::g::Uno::Comparison_typeof()->MakeType(::TYPES[39/*string*/], NULL);
    ::TYPES[61] = ::g::Fuse::IArray_typeof();
    type->Reflection.SetFunctions(7,
        new uFunction("Escape", NULL, (void*)Json__Escape_fn, 0, true, ::TYPES[39/*string*/], 1, ::TYPES[39/*string*/]),
        new uFunction("Escape", NULL, (void*)Json__Escape1_fn, 0, true, uVoid_typeof(), 2, ::TYPES[39/*string*/], ::g::Uno::Text::StringBuilder_typeof()),
        new uFunction("Stringify", NULL, (void*)Json__Stringify_fn, 0, true, ::TYPES[39/*string*/], 2, uObject_typeof(), ::TYPES[56/*bool*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral_fn, 0, true, ::TYPES[39/*string*/], 1, ::TYPES[56/*bool*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral1_fn, 0, true, ::TYPES[39/*string*/], 1, ::TYPES[53/*double*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral2_fn, 0, true, ::TYPES[39/*string*/], 1, ::TYPES[39/*string*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral3_fn, 0, true, uVoid_typeof(), 2, ::TYPES[39/*string*/], ::g::Uno::Text::StringBuilder_typeof()));
}
...
uString* Json::Stringify(uObject* value, bool normalized)
{
    ...
    ::g::Uno::Text::StringBuilder* sb = ::g::Uno::Text::StringBuilder::New1();
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[52/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    if (uIs(value, ::TYPES[39/*string*/]))
        Json::ToLiteral3(uCast<uString*>(value, ::TYPES[39/*string*/]), sb);
    else if (uIs(value, ::TYPES[53/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[53/*double*/], value)));
    else if (uIs(value, ::TYPES[54/*float*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<float>(::TYPES[54/*float*/], value)));
    else if (uIs(value, ::TYPES[55/*int*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<int>(::TYPES[55/*int*/], value)));
    ...
    else if (uIs(value, ::TYPES[13/*Fuse.IObject*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[66/*"Json.String...*/]));

        ::g::Uno::Collections::HashSet__Add_fn(uPtr(visitedSet), value, &ret2);
        uObject* obj = uAs<uObject*>(value, ::TYPES[13/*Fuse.IObject*/]);
        uPtr(sb)->Append2(::STRINGS[67/*"{"*/]);
        uArray* keys = uArray::New(::TYPES[57/*string[]*/], uPtr(::g::Fuse::IObject::Keys(uInterface(uPtr(obj), ::TYPES[13/*Fuse.IObject*/])))->Length());
        ::g::Uno::Array::Copy1(::TYPES[58/*Uno.Array.Copy<string>*/], ::g::Fuse::IObject::Keys(uInterface(obj, ::TYPES[13/*Fuse.IObject*/])), keys, uPtr(::g::Fuse::IObject::Keys(uInterface(obj, ::TYPES[13/*Fuse.IObject*/])))->Length());
        ...
        sb->Append2(::STRINGS[69/*"}"*/]);
    }
    else if (uIs(value, ::TYPES[61/*Fuse.IArray*/]))
    {
        ...
        uObject* arr = uAs<uObject*>(value, ::TYPES[61/*Fuse.IArray*/]);
        uPtr(sb)->Append2(::STRINGS[70/*"["*/]);

        for (int i1 = 0; i1 < ::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[61/*Fuse.IArray*/])); i1++)
        {
            if (i1 > 0)
                uPtr(sb)->Append2(::STRINGS[68/*","*/]);

            Json::Stringify1(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[61/*Fuse.IArray*/]), i1), normalized, sb, visitedSet);
        }

        sb->Append2(::STRINGS[71/*"]"*/]);
    }
    else
        uPtr(sb)->Append2(::STRINGS[72/*"null"*/]);
}
...
{
    if (b)
        return ::STRINGS[73/*"true"*/];
    else
        return ::STRINGS[74/*"false"*/];
}
...
uString* Json::ToLiteral1(double s)
{
    ...
    if ((double)(int)s == s)
        return ::g::Uno::Int::ToString((int)s, ::TYPES[55/*int*/]);

    return ::g::Uno::Double::ToString(s, ::TYPES[53/*double*/]);
}
...
{
    ::STRINGS[75] = uString::Const("Use CloneAndDerive instead of DeriveClone");
    ::STRINGS[3] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\0.47.7\\$.uno");
    ::STRINGS[76] = uString::Const("DeriveClone");
    ::STRINGS[77] = uString::Const("Use Clone instead of TrueClone");
    ::STRINGS[78] = uString::Const("TrueClone");
    type->SetFields(0,
...
LayoutParams LayoutParams::DeriveClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[75/*"Use CloneAn...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"C:\\Users\\...*/], 1643, ::STRINGS[76/*"DeriveClone"*/]);
...
LayoutParams LayoutParams::TrueClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[77/*"Use Clone i...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"C:\\Users\\...*/], 1614, ::STRINGS[78/*"TrueClone"*/]);
...
{
    Marshal::_computers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[62/*Uno.Collections.Dictionary<Uno.Type, Fuse.Computer>*/]));
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[63/*Uno.Collections.List<Fuse.Marshal.IConverter>*/]));
    ::g::Fuse::NumberComputer* number = ::g::Fuse::NumberComputer::New1();
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[53/*double*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[54/*float*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[55/*int*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[73/*short*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[75/*sbyte*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[72/*uint*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[74/*ushort*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[67/*byte*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[66/*Uno.UX.Size*/], ::g::Fuse::SizeComputer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[71/*Uno.UX.Size2*/], ::g::Fuse::Size2Computer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[39/*string*/], ::g::Fuse::StringComputer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[68/*float2*/], ::g::Fuse::Float2Computer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[69/*float3*/], ::g::Fuse::Float3Computer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[70/*float4*/], ::g::Fuse::Float4Computer::New1());
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[80] = uString::Const("px");
    ::STRINGS[81] = uString::Const("pt");
    ::STRINGS[82] = uString::Const("%");
    ::STRINGS[22] = uString::Const("Subtract");
    ::STRINGS[83] = uString::Const("True");
    ::STRINGS[84] = uString::Const("False");
    ::STRINGS[85] = uString::Const("Cannot convert '");
    ::STRINGS[86] = uString::Const("' to target type '");
    ::STRINGS[11] = uString::Const("'");
    ::STRINGS[87] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Marshal\\0.47.7\\$.uno");
    ::STRINGS[88] = uString::Const("TryConvertTo");
    ::TYPES[62] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ::g::Fuse::Computer_typeof(), NULL);
    ::TYPES[63] = ::g::Uno::Collections::List_typeof()->MakeType(Marshal__IConverter_typeof(), NULL);
    ::TYPES[38] = ::g::Uno::Type_typeof();
    ::TYPES[64] = Marshal__IConverter_typeof();
    ::TYPES[65] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[66] = ::g::Uno::UX::Size_typeof();
    ::TYPES[56] = ::g::Uno::Bool_typeof();
    ::TYPES[39] = ::g::Uno::String_typeof();
    ::TYPES[67] = ::g::Uno::Byte_typeof();
    ::TYPES[53] = ::g::Uno::Double_typeof();
    ::TYPES[54] = ::g::Uno::Float_typeof();
    ::TYPES[55] = ::g::Uno::Int_typeof();
    ::TYPES[68] = ::g::Uno::Float2_typeof();
    ::TYPES[69] = ::g::Uno::Float3_typeof();
    ::TYPES[70] = ::g::Uno::Float4_typeof();
    ::TYPES[71] = ::g::Uno::UX::Size2_typeof();
    ::TYPES[72] = ::g::Uno::UInt_typeof();
    ::TYPES[73] = ::g::Uno::Short_typeof();
    ::TYPES[74] = ::g::Uno::UShort_typeof();
    ::TYPES[75] = ::g::Uno::SByte_typeof();
    ::TYPES[61] = ::g::Fuse::IArray_typeof();
    type->SetFields(0,
        ::TYPES[62/*Uno.Collections.Dictionary<Uno.Type, Fuse.Computer>*/], (uintptr_t)&::g::Fuse::Marshal::_computers_, uFieldFlagsStatic,
        ::TYPES[63/*Uno.Collections.List<Fuse.Marshal.IConverter>*/], (uintptr_t)&::g::Fuse::Marshal::_converters_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(33,
        ...
        new uFunction("AddConverter", NULL, (void*)Marshal__AddConverter_fn, 0, true, uVoid_typeof(), 1, ::TYPES[64/*Fuse.Marshal.IConverter*/]),
        new uFunction("CanConvertClass", NULL, (void*)Marshal__CanConvertClass_fn, 0, true, ::TYPES[56/*bool*/], 1, ::TYPES[38/*Uno.Type*/]),
        ...
        new uFunction("Is", NULL, (void*)Marshal__Is_fn, 0, true, ::TYPES[56/*bool*/], 2, uObject_typeof(), ::TYPES[38/*Uno.Type*/]),
        ...
        new uFunction("Parse", NULL, (void*)Marshal__Parse_fn, 0, true, uObject_typeof(), 1, ::TYPES[39/*string*/]),
        new uFunction("Subtract", NULL, (void*)Marshal__Subtract_fn, 0, true, uObject_typeof(), 2, uObject_typeof(), uObject_typeof()),
        new uFunction("ToBool", NULL, (void*)Marshal__ToBool_fn, 0, true, ::TYPES[56/*bool*/], 1, uObject_typeof()),
        new uFunction("ToByte", NULL, (void*)Marshal__ToByte_fn, 0, true, ::TYPES[73/*short*/], 1, uObject_typeof()),
        new uFunction("ToDouble", NULL, (void*)Marshal__ToDouble_fn, 0, true, ::TYPES[53/*double*/], 1, uObject_typeof()),
        new uFunction("ToDouble", NULL, (void*)Marshal__ToDouble1_fn, 0, true, ::TYPES[56/*bool*/], 2, uObject_typeof(), ::TYPES[53/*double*/]->ByRef()),
        new uFunction("ToDouble", NULL, (void*)Marshal__ToDouble2_fn, 0, true, ::TYPES[56/*bool*/], 2, ::TYPES[39/*string*/], ::TYPES[53/*double*/]->ByRef()),
        new uFunction("ToFloat", NULL, (void*)Marshal__ToFloat_fn, 0, true, ::TYPES[54/*float*/], 1, uObject_typeof()),
        new uFunction("ToFloat2", NULL, (void*)Marshal__ToFloat2_fn, 0, true, ::TYPES[68/*float2*/], 1, uObject_typeof()),
        new uFunction("ToFloat3", NULL, (void*)Marshal__ToFloat3_fn, 0, true, ::TYPES[69/*float3*/], 1, uObject_typeof()),
        new uFunction("ToFloat4", NULL, (void*)Marshal__ToFloat4_fn, 0, true, ::TYPES[70/*float4*/], 1, uObject_typeof()),
        new uFunction("ToInt", NULL, (void*)Marshal__ToInt_fn, 0, true, ::TYPES[55/*int*/], 1, uObject_typeof()),
        new uFunction("ToSByte", NULL, (void*)Marshal__ToSByte_fn, 0, true, ::TYPES[75/*sbyte*/], 1, uObject_typeof()),
        new uFunction("ToShort", NULL, (void*)Marshal__ToShort_fn, 0, true, ::TYPES[73/*short*/], 1, uObject_typeof()),
        new uFunction("ToSize", NULL, (void*)Marshal__ToSize_fn, 0, true, ::TYPES[66/*Uno.UX.Size*/], 1, uObject_typeof()),
        new uFunction("ToSize2", NULL, (void*)Marshal__ToSize2_fn, 0, true, ::TYPES[71/*Uno.UX.Size2*/], 1, uObject_typeof()),
        new uFunction("ToType`1", type->MethodTypes[0], (void*)Marshal__ToType_fn, 0, true, type->MethodTypes[0]->U(0), 1, uObject_typeof()),
        new uFunction("ToUInt", NULL, (void*)Marshal__ToUInt_fn, 0, true, ::TYPES[72/*uint*/], 1, uObject_typeof()),
        new uFunction("ToUShort", NULL, (void*)Marshal__ToUShort_fn, 0, true, ::TYPES[74/*ushort*/], 1, uObject_typeof()),
        new uFunction("TryConvertTo", NULL, (void*)Marshal__TryConvertTo_fn, 0, true, ::TYPES[56/*bool*/], 4, ::TYPES[38/*Uno.Type*/], uObject_typeof(), uObject_typeof()->ByRef(), uObject_typeof()));
}
...
uObject* Marshal::Add(uObject* a, uObject* b)
{
    ...
    if (::g::Uno::Type::op_Equality(ta, ::TYPES[39/*string*/]) || ::g::Uno::Type::op_Equality(tb, ::TYPES[39/*string*/]))
...
bool Marshal::CanConvertClass(uType* t)
{
    ...
    for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        if (Marshal__IConverter::CanConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret4), ret4)), ::TYPES[64/*Fuse.Marshal.IConverter*/]), t))
            return true;
...
uType* Marshal::DominantType(uType* a, uType* b)
{
    ...
    if (::g::Uno::Type::op_Equality(a, ::TYPES[70/*float4*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[70/*float4*/]))
        return b;

    if (::g::Uno::Type::op_Equality(a, ::TYPES[69/*float3*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[69/*float3*/]))
        return b;

    if (::g::Uno::Type::op_Equality(a, ::TYPES[71/*Uno.UX.Size2*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[71/*Uno.UX.Size2*/]))
        return b;

    if (::g::Uno::Type::op_Equality(a, ::TYPES[66/*Uno.UX.Size*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[66/*Uno.UX.Size*/]))
        return b;
...
uObject* Marshal::EqualTo(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret6), ret6))
        return uBox(::TYPES[56/*bool*/], uPtr(c)->EqualTo(a, b));
...
uObject* Marshal::GreaterOrEqual(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret7), ret7))
        return uBox(::TYPES[56/*bool*/], uPtr(c)->GreaterOrEqual(a, b));
...
uObject* Marshal::GreaterThan(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret8), ret8))
        return uBox(::TYPES[56/*bool*/], uPtr(c)->GreaterThan(a, b));
...
uObject* Marshal::LessOrEqual(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret9), ret9))
        return uBox(::TYPES[56/*bool*/], uPtr(c)->LessOrEqual(a, b));
...
uObject* Marshal::LessThan(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret10), ret10))
        return uBox(::TYPES[56/*bool*/], uPtr(c)->LessThan(a, b));
...
uObject* Marshal::Parse(uString* s)
{
    ...
    Marshal_typeof()->Init();
    uArray* p = ::g::Uno::String::Split(uPtr(s), uArray::Init<int>(::TYPES[65/*char[]*/], 1, ','));
    ...
    if (uPtr(p)->Length() == 2)
    {
        ...
        if (uIs(x, ::TYPES[66/*Uno.UX.Size*/]) || uIs(y, ::TYPES[66/*Uno.UX.Size*/]))
            return uBox(::TYPES[71/*Uno.UX.Size2*/], ::g::Uno::UX::Size2__New1(Marshal::ToSize(x), Marshal::ToSize(y)));
        else
            return uBox(::TYPES[68/*float2*/], ::g::Uno::Float2__New2(Marshal::ToFloat(x), Marshal::ToFloat(y)));
    }
    else if (uPtr(p)->Length() == 3)
    {
        ...
        return uBox(::TYPES[69/*float3*/], ::g::Uno::Float3__New2(Marshal::ToFloat(x1), Marshal::ToFloat(y1), Marshal::ToFloat(z)));
    }
    else if (uPtr(p)->Length() == 4)
    {
        ...
        return uBox(::TYPES[70/*float4*/], ::g::Uno::Float4__New2(Marshal::ToFloat(x2), Marshal::ToFloat(y2), Marshal::ToFloat(z1), Marshal::ToFloat(w)));
    }

    if (::g::Uno::String::op_Equality(s, ::STRINGS[73/*"true"*/]))
        return uBox(::TYPES[56/*bool*/], true);

    if (::g::Uno::String::op_Equality(s, ::STRINGS[74/*"false"*/]))
        return uBox(::TYPES[56/*bool*/], false);

    if (::g::Uno::String::Contains(s, ::STRINGS[79/*"#"*/]))
        return uBox(::TYPES[70/*float4*/], ::g::Uno::Color::FromHex(s));

    int unit = 1;

    if (::g::Uno::String::EndsWith(s, ::STRINGS[80/*"px"*/]))
    {
        unit = 3;
        s = ::g::Uno::String::Substring1(uPtr(s), 0, uPtr(s)->Length() - 2);
    }
    else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[81/*"pt"*/]))
    {
        unit = 2;
        s = ::g::Uno::String::Substring1(uPtr(s), 0, uPtr(s)->Length() - 2);
    }
    else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[82/*"%"*/]))
    {
        unit = 3;
    ...
    if (unit != 1)
        return uBox(::TYPES[66/*Uno.UX.Size*/], ::g::Uno::UX::Size__New1((float)v, unit));
    else
        return uBox(::TYPES[53/*double*/], v);
}
...
bool Marshal::ToBool(uObject* v)
{
    ...
    if (uIs(v, ::TYPES[56/*bool*/]))
        return uUnbox<bool>(::TYPES[56/*bool*/], v);
    else if (uIs(v, ::TYPES[39/*string*/]))
    {
        uString* s = uCast<uString*>(v, ::TYPES[39/*string*/]);

        if (::g::Uno::String::op_Equality(s, ::STRINGS[73/*"true"*/]))
            return true;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[83/*"True"*/]))
            return true;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[74/*"false"*/]))
            return false;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[84/*"False"*/]))
            return false;
    }

    U_THROW(::g::Fuse::MarshalException::New4(v, ::TYPES[56/*bool*/]));
}
...
int16_t Marshal::ToByte(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[67/*byte*/]))
        return (int16_t)uUnbox<uint8_t>(::TYPES[67/*byte*/], o);
    else
...
double Marshal::ToDouble(uObject* v)
{
    ...
    U_THROW(::g::Fuse::MarshalException::New4(v, ::TYPES[53/*double*/]));
}
...
bool Marshal::ToDouble1(uObject* v, double* res)
{
    ...
    if (uIs(v, ::TYPES[53/*double*/]))
    {
        *res = uUnbox<double>(::TYPES[53/*double*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[54/*float*/]))
    {
        *res = (double)uUnbox<float>(::TYPES[54/*float*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[39/*string*/]))
        return Marshal::ToDouble2(uCast<uString*>(v, ::TYPES[39/*string*/]), res);
    else if (uIs(v, ::TYPES[55/*int*/]))
    {
        *res = (double)uUnbox<int>(::TYPES[55/*int*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[68/*float2*/]))
    {
        *res = (double)uUnbox< ::g::Uno::Float2>(::TYPES[68/*float2*/], v).X;
        return true;
    }
    else if (uIs(v, ::TYPES[69/*float3*/]))
    {
        *res = (double)uUnbox< ::g::Uno::Float3>(::TYPES[69/*float3*/], v).X;
        return true;
    }
    else if (uIs(v, ::TYPES[70/*float4*/]))
    {
        *res = (double)uUnbox< ::g::Uno::Float4>(::TYPES[70/*float4*/], v).X;
        return true;
    }
    else if (uIs(v, ::TYPES[66/*Uno.UX.Size*/]))
    {
        *res = (double)uUnbox< ::g::Uno::UX::Size>(::TYPES[66/*Uno.UX.Size*/], v).Value;
        return true;
    }
    else if (uIs(v, ::TYPES[71/*Uno.UX.Size2*/]))
    {
        ::g::Uno::UX::Size2 s = uUnbox< ::g::Uno::UX::Size2>(::TYPES[71/*Uno.UX.Size2*/], v);
        ::g::Uno::UX::Size x = s.X;
        *res = (double)x.Value;
        return true;
    }
    else if (uIs(v, ::TYPES[72/*uint*/]))
    {
        *res = (double)uUnbox<uint32_t>(::TYPES[72/*uint*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[73/*short*/]))
    {
        *res = (double)uUnbox<int16_t>(::TYPES[73/*short*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[74/*ushort*/]))
    {
        *res = (double)uUnbox<uint16_t>(::TYPES[74/*ushort*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[67/*byte*/]))
    {
        *res = (double)uUnbox<uint8_t>(::TYPES[67/*byte*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[75/*sbyte*/]))
    {
        *res = (double)uUnbox<int8_t>(::TYPES[75/*sbyte*/], v);
        return true;
    }
...
float Marshal::ToFloat(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[54/*float*/]))
        return uUnbox<float>(::TYPES[54/*float*/], o);
    else
...
::g::Uno::Float2 Marshal::ToFloat2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[68/*float2*/]))
        return uUnbox< ::g::Uno::Float2>(::TYPES[68/*float2*/], o);
    else
...
::g::Uno::Float3 Marshal::ToFloat3(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[69/*float3*/]))
        return uUnbox< ::g::Uno::Float3>(::TYPES[69/*float3*/], o);
    else
...
::g::Uno::Float4 Marshal::ToFloat4(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[70/*float4*/]))
        return uUnbox< ::g::Uno::Float4>(::TYPES[70/*float4*/], o);
    else if (uIs(o, ::TYPES[69/*float3*/]))
    {
        ::g::Uno::Float3 f = uUnbox< ::g::Uno::Float3>(::TYPES[69/*float3*/], o);
        return ::g::Uno::Float4__New2(f.X, f.Y, f.Z, 1.0f);
    }
    else if (uIs(o, ::TYPES[68/*float2*/]))
    {
        ::g::Uno::Float2 f1 = uUnbox< ::g::Uno::Float2>(::TYPES[68/*float2*/], o);
        return ::g::Uno::Float4__New2(f1.X, f1.Y, f1.X, f1.Y);
    }
    else if (uIs(o, ::TYPES[39/*string*/]))
    {
        uString* s = uCast<uString*>(o, ::TYPES[39/*string*/]);

        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[79/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }
    else if (uIs(o, ::TYPES[66/*Uno.UX.Size*/]))
    {
        ::g::Uno::UX::Size s1 = uUnbox< ::g::Uno::UX::Size>(::TYPES[66/*Uno.UX.Size*/], o);
        return ::g::Uno::Float4__New1(s1.Value);
    }
    else if (uIs(o, ::TYPES[71/*Uno.UX.Size2*/]))
    {
        ::g::Uno::UX::Size2 s2 = uUnbox< ::g::Uno::UX::Size2>(::TYPES[71/*Uno.UX.Size2*/], o);
        ::g::Uno::UX::Size x = s2.X;
        ::g::Uno::UX::Size y = s2.Y;
        return ::g::Uno::Float4__New2(x.Value, y.Value, x.Value, y.Value);
    }
    else if (uIs(o, ::TYPES[61/*Fuse.IArray*/]))
    {
        uObject* a = (uObject*)o;
        float x1 = (::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[61/*Fuse.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(a), ::TYPES[61/*Fuse.IArray*/]), 0)) : 0.0f;
        float y1 = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[61/*Fuse.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[61/*Fuse.IArray*/]), 1)) : 0.0f;
        float z = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[61/*Fuse.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[61/*Fuse.IArray*/]), 2)) : 0.0f;
        float w = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[61/*Fuse.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[61/*Fuse.IArray*/]), 3)) : 1.0f;
    ...
    U_THROW(::g::Fuse::MarshalException::New4(o, ::TYPES[70/*float4*/]));
}
...
int Marshal::ToInt(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[55/*int*/]))
        return uUnbox<int>(::TYPES[55/*int*/], o);
    else
...
int8_t Marshal::ToSByte(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[75/*sbyte*/]))
        return uUnbox<int8_t>(::TYPES[75/*sbyte*/], o);
    else
...
int16_t Marshal::ToShort(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[73/*short*/]))
        return uUnbox<int16_t>(::TYPES[73/*short*/], o);
    else
...
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[66/*Uno.UX.Size*/]))
        ...
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[71/*Uno.UX.Size2*/], o).X;
    else
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[71/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[71/*Uno.UX.Size2*/], o);
    else if (uIs(o, ::TYPES[66/*Uno.UX.Size*/]))
        return ::g::Uno::UX::Size2__New1(uUnbox< ::g::Uno::UX::Size>(::TYPES[66/*Uno.UX.Size*/], o), uUnbox< ::g::Uno::UX::Size>(::TYPES[66/*Uno.UX.Size*/], o));
    else
...
uint32_t Marshal::ToUInt(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[72/*uint*/]))
        return uUnbox<uint32_t>(::TYPES[72/*uint*/], o);
    else
...
uint16_t Marshal::ToUShort(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[74/*ushort*/]))
        return uUnbox<uint16_t>(::TYPES[74/*ushort*/], o);
    else
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (::g::Uno::Type::op_Equality(t, ::TYPES[53/*double*/]))
    {
        *res = uBox(::TYPES[53/*double*/], Marshal::ToDouble(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[39/*string*/]))
    {
        *res = ::g::Uno::Object::ToString(uPtr(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[101/*Uno.UX.Selector*/]))
    {
        *res = uBox(::TYPES[101/*Uno.UX.Selector*/], ::g::Uno::UX::Selector__op_Implicit(::g::Uno::Object::ToString(uPtr(o))));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[54/*float*/]))
    {
        *res = uBox(::TYPES[54/*float*/], Marshal::ToFloat(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[55/*int*/]))
    {
        *res = uBox<int>(::TYPES[55/*int*/], Marshal::ToInt(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[56/*bool*/]))
    {
        *res = uBox(::TYPES[56/*bool*/], Marshal::ToBool(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[66/*Uno.UX.Size*/]))
    {
        *res = uBox(::TYPES[66/*Uno.UX.Size*/], Marshal::ToSize(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[71/*Uno.UX.Size2*/]))
    {
        *res = uBox(::TYPES[71/*Uno.UX.Size2*/], Marshal::ToSize2(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[68/*float2*/]))
    {
        *res = uBox(::TYPES[68/*float2*/], Marshal::ToFloat2(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[69/*float3*/]))
    {
        *res = uBox(::TYPES[69/*float3*/], Marshal::ToFloat3(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[70/*float4*/]))
    {
        *res = uBox(::TYPES[70/*float4*/], Marshal::ToFloat4(o));
        return true;
    }
    else if (::g::Uno::Type::IsEnum(uPtr(t)) && uIs(o, ::TYPES[39/*string*/]))
    {
        *res = ::g::Uno::Enum::Parse(t, uCast<uString*>(o, ::TYPES[39/*string*/]));
        return true;
    }
    else
        ...
        for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        {
            uObject* c = Marshal__IConverter::TryConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret15), ret15)), ::TYPES[64/*Fuse.Marshal.IConverter*/]), t, o);
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[85/*"Cannot conv...*/], o), ::STRINGS[86/*"' to target...*/]), t), ::STRINGS[11/*"'"*/]), diagnosticSource, ::STRINGS[87/*"C:\\Users\\...*/], 621, ::STRINGS[88/*"TryConvertTo"*/], NULL);
...
{
    ::STRINGS[85] = uString::Const("Cannot convert '");
    ::STRINGS[89] = uString::Const("' to required target type '");
    ::STRINGS[11] = uString::Const("'");
    type->SetFields(3);
    type->Reflection.SetFunctions(1,
...
{
    ctor_1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[85/*"Cannot conv...*/], v), ::STRINGS[89/*"' to requir...*/]), t), ::STRINGS[11/*"'"*/]));
}
...
{
    ::TYPES[5] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[76] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof(), NULL);
    type->SetFields(0,
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyDown(uDelegate::New(::TYPES[76/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyUp(uDelegate::New(::TYPES[76/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
}
...
{
    NameRegistry::_nameToObj_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[77/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/]));
    NameRegistry::_names_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[78/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/]));
    NameRegistry::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[79/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/]));
}

static void NameRegistry_build(uType* type)
{
    ::TYPES[77] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), NULL);
    ::TYPES[78] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), ::g::Uno::UX::Selector_typeof(), NULL);
    ::TYPES[79] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof(), NULL), NULL);
    ::TYPES[80] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof(), NULL);
    ::TYPES[81] = ::g::Fuse::INameListener_typeof();
    ::TYPES[82] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::TYPES[80/*Uno.Collections.List<Fuse.INameListener>*/], NULL);
    ::TYPES[17] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[79/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/], (uintptr_t)&::g::Fuse::NameRegistry::_listeners_, uFieldFlagsStatic,
        ::TYPES[78/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/], (uintptr_t)&::g::Fuse::NameRegistry::_names_, uFieldFlagsStatic,
        ::TYPES[77/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/], (uintptr_t)&::g::Fuse::NameRegistry::_nameToObj_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(5,
        new uFunction("AddListener", NULL, (void*)NameRegistry__AddListener_fn, 0, true, uVoid_typeof(), 2, ::g::Uno::UX::Selector_typeof(), ::TYPES[81/*Fuse.INameListener*/]),
        ...
        new uFunction("RemoveListener", NULL, (void*)NameRegistry__RemoveListener_fn, 0, true, uVoid_typeof(), 1, ::TYPES[81/*Fuse.INameListener*/]),
...
void NameRegistry::AddListener(::g::Uno::UX::Selector name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[80/*Uno.Collections.List<Fuse.INameListener>*/]));
...
void NameRegistry::NotifyNameChanged(::g::Fuse::Node* obj, ::g::Uno::UX::Selector name)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret12), ret12))
        ...
        for (array2 = (uArray*)uPtr((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret13), ret13))->ToArray(), index3 = 0, length4 = uPtr(array2)->Length(); index3 < length4; ++index3)
        {
            ...
            ::g::Fuse::INameListener::OnNameChanged(uInterface(uPtr(listener), ::TYPES[81/*Fuse.INameListener*/]), obj, name);
        }
}
...
void NameRegistry::RemoveListener(uObject* listener)
{
    ...
    for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(NameRegistry::_listeners())->Values()), &ret14), ret14); enum1.MoveNext(::TYPES[82/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* list = enum1.Current(::TYPES[82/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]);
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), &ret24), ret24))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[17/*Uno.Collections.List<Fuse.Node>*/]));
...
{
    Node::_emptyBindings_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[83/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Binding>*/], uArray::New(::TYPES[84/*Fuse.Binding[]*/], 0)));
    Node::_dataListeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[85/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Node.IDataListener>>*/]));
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[86/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[87/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[90/*"_createWatc...*/], uDelegate::New(::TYPES[88/*Uno.Func<Fuse.Scripting.Context, Fuse.Node, object[], object>*/], (void*)Node___createWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[87/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[91/*"_destroyWat...*/], uDelegate::New(::TYPES[89/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___destroyWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[92/*"findData"*/], 1, ::STRINGS[93/*"function(ke...*/])));
}

static void Node_build(uType* type)
{
    ::STRINGS[90] = uString::Const("_createWatcher");
    ::STRINGS[91] = uString::Const("_destroyWatcher");
    ::STRINGS[92] = uString::Const("findData");
    ::STRINGS[93] = uString::Const("function(key) { return Observable._getDataObserver(this, key); }");
    ::STRINGS[23] = uString::Const("");
    ::STRINGS[94] = uString::Const("Incomplete or duplicate rooting: ");
    ::STRINGS[95] = uString::Const("/");
    ::STRINGS[96] = uString::Const("Node is already rooted with a different parent");
    ::STRINGS[97] = uString::Const("Invalid RootStage post rooting: ");
    ::STRINGS[98] = uString::Const("  ");
    ::STRINGS[99] = uString::Const(", Name: ");
    ::STRINGS[100] = uString::Const("Incomplete or duplicate unrooting: ");
    ::TYPES[83] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    ::TYPES[84] = ::g::Fuse::Binding_typeof()->Array();
    ::TYPES[85] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(Node__IDataListener_typeof(), NULL), NULL);
    ::TYPES[38] = ::g::Uno::Type_typeof();
    ::TYPES[86] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[87] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[88] = ::g::Uno::Func3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[89] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[39] = ::g::Uno::String_typeof();
    ::TYPES[90] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[91] = Node__DataWatcher_typeof();
    ::TYPES[92] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[93] = ::g::Fuse::Binding_typeof();
    ::TYPES[94] = ::g::Uno::Collections::List_typeof()->MakeType(Node__IDataListener_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    ::TYPES[95] = Node__ISubtreeDataProvider_typeof();
    ::TYPES[96] = Node__IDataEnumerator_typeof();
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(type, NULL);
    ::TYPES[97] = Node__ISiblingDataProvider_typeof();
    ::TYPES[98] = ::g::Uno::Collections::IList_typeof()->MakeType(type, NULL);
    ::TYPES[99] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[93/*Fuse.Binding*/], NULL);
    ::TYPES[100] = Node__IDataListener_typeof();
    ::TYPES[8] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    ::TYPES[101] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[102] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[93/*Fuse.Binding*/], NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[93/*Fuse.Binding*/], NULL), offsetof(Node_type, interface0),
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[93/*Fuse.Binding*/], NULL), offsetof(Node_type, interface4),
        ::TYPES[102/*Uno.Collections.IEnumerable<Fuse.Binding>*/], offsetof(Node_type, interface5));
    type->SetFields(2,
        uObject_typeof(), offsetof(::g::Fuse::Node, _bindings), 0,
        ::TYPES[101/*Uno.UX.Selector*/], offsetof(::g::Fuse::Node, _name), 0,
        ...
        ::TYPES[85/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Node.IDataListener>>*/], (uintptr_t)&::g::Fuse::Node::_dataListeners_, uFieldFlagsStatic,
        ::TYPES[102/*Uno.Collections.IEnumerable<Fuse.Binding>*/], (uintptr_t)&::g::Fuse::Node::_emptyBindings_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFunctions(20,
        new uFunction("Add", NULL, (void*)Node__Add_fn, 0, false, uVoid_typeof(), 1, ::TYPES[93/*Fuse.Binding*/]),
        new uFunction("AddDataListener", NULL, (void*)Node__AddDataListener_fn, 0, false, uVoid_typeof(), 2, ::TYPES[39/*string*/], ::TYPES[100/*Fuse.Node.IDataListener*/]),
        new uFunction("get_Bindings", NULL, (void*)Node__get_Bindings_fn, 0, false, ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[93/*Fuse.Binding*/], NULL), 0),
        new uFunction("get_ContextParent", NULL, (void*)Node__get_ContextParent_fn, 0, false, type, 0),
        new uFunction("EnumerateData", NULL, (void*)Node__EnumerateData_fn, 0, false, uVoid_typeof(), 1, ::TYPES[96/*Fuse.Node.IDataEnumerator*/]),
        new uFunction("FindNodeByName", NULL, (void*)Node__FindNodeByName_fn, 0, false, type, 2, ::TYPES[101/*Uno.UX.Selector*/], ::g::Uno::Predicate_typeof()->MakeType(type, NULL)),
        new uFunction("GetFirstData", NULL, (void*)Node__GetFirstData_fn, 0, false, uObject_typeof(), 0),
        new uFunction("Insert", NULL, (void*)Node__Insert_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Int_typeof(), ::TYPES[93/*Fuse.Binding*/]),
        ...
        new uFunction("get_Name", NULL, (void*)Node__get_Name_fn, 0, false, ::TYPES[101/*Uno.UX.Selector*/], 0),
        new uFunction("set_Name", NULL, (void*)Node__set_Name_fn, 0, false, uVoid_typeof(), 1, ::TYPES[101/*Uno.UX.Selector*/]),
        new uFunction("OnDataChanged", NULL, (void*)Node__OnDataChanged_fn, 0, false, uVoid_typeof(), 2, ::TYPES[39/*string*/], uObject_typeof()),
        new uFunction("get_Parent", NULL, (void*)Node__get_Parent_fn, 0, false, ::TYPES[10/*Fuse.Visual*/], 0),
        new uFunction("get_Properties", NULL, (void*)Node__get_Properties_fn, 0, false, ::g::Fuse::Properties_typeof(), 0),
        new uFunction("Remove", NULL, (void*)Node__Remove_fn, 0, false, ::g::Uno::Bool_typeof(), 1, ::TYPES[93/*Fuse.Binding*/]),
        new uFunction("RemoveDataListener", NULL, (void*)Node__RemoveDataListener_fn, 0, false, uVoid_typeof(), 2, ::TYPES[39/*string*/], ::TYPES[100/*Fuse.Node.IDataListener*/]),
        new uFunction("SubtreeToString", NULL, (void*)Node__SubtreeToString_fn, 0, false, ::TYPES[39/*string*/], 0),
        new uFunction("TryGetResource", NULL, NULL, offsetof(Node_type, fp_TryGetResource), false, ::g::Uno::Bool_typeof(), 3, ::TYPES[39/*string*/], ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL), uObject_typeof()->ByRef()),
...
void Node__ToString_fn(Node* __this, uString** __retval)
{
    ...
    if (!__this->Name().IsNull())
        return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((::g::Uno::Object__ToString_fn(__this, &ret12), ret12), ::STRINGS[99/*", Name: "*/]), __this->Name().ToString(::TYPES[101/*Uno.UX.Selector*/])), void();
    else
...
void Node__UnoCollectionsICollectionFuseBindingget_Count_fn(Node* __this, int* __retval)
{
    ...
    if (uIs((uObject*)__this->_bindings, ::TYPES[93/*Fuse.Binding*/]))
...
void Node__UnoCollectionsIEnumerableFuseBindingGetEnumerator_fn(Node* __this, uObject** __retval)
{
    ...
    if (__this->_bindings == NULL)
        return *__retval = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Node::_emptyBindings()), ::TYPES[102/*Uno.Collections.IEnumerable<Fuse.Binding>*/])), void();

    if (uIs((uObject*)__this->_bindings, ::TYPES[93/*Fuse.Binding*/]))
        __this->MakeBindingList(NULL);

    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[93/*Fuse.Binding*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->BindingList()), &ret15), ret15)), void();
}
...
void Node::Add(::g::Fuse::Binding* item)
{
    ...
    if (_bindings == NULL)
        _bindings = item;
    else if (uIs((uObject*)_bindings, ::TYPES[93/*Fuse.Binding*/]))
...
void Node::AddDataListener(uString* key, uObject* listener)
{
    ...
    {
        listeners = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List<Fuse.Node.IDataListener>*/]);
...
{
    return uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[93/*Fuse.Binding*/]);
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() [instance] :2189
::g::Uno::Collections::List* Node::BindingList()
{
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[99/*Uno.Collections.List<Fuse.Binding>*/]);
}
...
void Node::EnumerateData(uObject* e)
{
    ...
    while (n != NULL)
    {
        ...
        if (np != NULL)
        {
            uObject* subdp = uAs<uObject*>(np, ::TYPES[95/*Fuse.Node.ISubtreeDataProvider*/]);

            if (subdp != NULL)
            {
                uObject* data = Node__ISubtreeDataProvider::GetData(uInterface(uPtr(subdp), ::TYPES[95/*Fuse.Node.ISubtreeDataProvider*/]), n);

                if ((data != NULL) && !Node__IDataEnumerator::NextData(uInterface(uPtr(e), ::TYPES[96/*Fuse.Node.IDataEnumerator*/]), data))
                    return;
            }
        }
        ...
        if (p != NULL)
            ...
            {
                uObject* sibdp = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[97/*Fuse.Node.ISiblingDataProvider*/]);

                if (sibdp != NULL)
                {
                    uObject* data1 = Node__ISiblingDataProvider::Data(uInterface(uPtr(sibdp), ::TYPES[97/*Fuse.Node.ISiblingDataProvider*/]));

                    if ((data1 != NULL) && !Node__IDataEnumerator::NextData(uInterface(uPtr(e), ::TYPES[96/*Fuse.Node.IDataEnumerator*/]), Node__ISiblingDataProvider::Data(uInterface(sibdp, ::TYPES[97/*Fuse.Node.ISiblingDataProvider*/]))))
                        return;
                }
            }
...
void Node::Insert(int index, ::g::Fuse::Binding* item)
{
    ...
    {
        if (uIs((uObject*)_bindings, ::TYPES[93/*Fuse.Binding*/]))
...
void Node::MakeBindingList(::g::Fuse::Binding* newItem)
{
    ...
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[99/*Uno.Collections.List<Fuse.Binding>*/]);
    ::g::Fuse::Binding* oldItem = uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[93/*Fuse.Binding*/]);
...
void Node::OnDataChanged(uString* key, uObject* newValue)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Node::_dataListeners()), key, (void**)(&listeners), &ret6), ret6))
        ...
        for (int i = 0; i < uPtr(listeners)->Count(); i++)
            Node__IDataListener::OnDataChanged(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(listeners), uCRef<int>(i), &ret7), ret7)), ::TYPES[100/*Fuse.Node.IDataListener*/]));
}
...
bool Node::Remove(::g::Fuse::Binding* item)
{
    ...
    if ((_bindings == NULL) || uIs((uObject*)_bindings, ::TYPES[93/*Fuse.Binding*/]))
        return false;
...
void Node::RootInternalImpl(::g::Fuse::Visual* parent)
{
    ...
    if (_rootStage != 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[94/*"Incomplete ...*/], this), ::STRINGS[95/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));

    if (_parent != NULL)
    {
        if (_parent != parent)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[96/*"Node is alr...*/]));
        else
            return;
    }
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[97/*"Invalid Roo...*/], this), ::STRINGS[95/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
}
...
void Node::UnrootInternal()
{
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[100/*"Incomplete ...*/], this), ::STRINGS[95/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
...
uObject* Node::_createWatcher(::g::Fuse::Scripting::Context* c, Node* n, uArray* args)
{
    ...
    Node_typeof()->Init();
    uString* key = uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[39/*string*/]);
    ::g::Fuse::Scripting::Function* callback = uCast< ::g::Fuse::Scripting::Function*>(args->Strong<uObject*>(1), ::TYPES[90/*Fuse.Scripting.Function*/]);
...
void Node::_destroyWatcher(::g::Fuse::Scripting::Context* c, Node* n, uArray* args)
{
    ...
    Node_typeof()->Init();
    Node__DataWatcher* watcher = uCast<Node__DataWatcher*>(uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[92/*Fuse.Scripting.External*/]))->Object, ::TYPES[91/*Fuse.Node.DataWatcher*/]);
...
{
    ::STRINGS[101] = uString::Const("AddContent called prior to having a Parent");
    ::STRINGS[3] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\0.47.7\\$.uno");
    ::STRINGS[102] = uString::Const("AddContent");
    ::STRINGS[103] = uString::Const("Could not locate node in parent, content not added");
    ::TYPES[103] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[104] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[98] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[105] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[106] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[107] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[108] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Node_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Node_type, interface2),
    ...
    type->SetFields(13,
        ...
        ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/], offsetof(::g::Fuse::NodeGroupBase, _nodes), 0,
        ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/], offsetof(::g::Fuse::NodeGroupBase, _resources), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::NodeGroupBase, _useContent), 0);
    type->Reflection.SetFunctions(2,
        new uFunction("get_Nodes", NULL, (void*)NodeGroupBase__get_Nodes_fn, 0, false, ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/], 0),
        new uFunction("get_Resources", NULL, (void*)NodeGroupBase__get_Resources_fn, 0, false, ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/], 0));
}
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[101/*"AddContent ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 3161, ::STRINGS[102/*"AddContent"*/]);
        return;
    }

    if (_resources != NULL)

        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_resources), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
            ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_resources), ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret2), ret2));
    ...
    int where = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[16/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), this, &ret3), ret3);

    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[103/*"Could not l...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 3180, ::STRINGS[102/*"AddContent"*/]);
        return;
    }
    ...
    {
        ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_nodes), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i1), &ret4), ret4);
        uPtr(n)->OverrideContextParent = (ind1 = uPtr(n)->OverrideContextParent, ((ind1 != NULL) ? ind1 : this));
    }

    uPtr(Parent())->InsertNodes(where, (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_nodes), ::TYPES[105/*Uno.Collections.IEnumerable<Fuse.Node>*/])));
}
...
uObject* NodeGroupBase::Nodes()
{
    ...
    if (_nodes == NULL)
        _nodes = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[106/*Uno.Collections.ObservableList<Fuse.Node>*/], uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Node>*/], (void*)NodeGroupBase__OnNodeAdded_fn, this), uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Node>*/], (void*)NodeGroupBase__OnNodeRemoved_fn, this)));
...
void NodeGroupBase::OnResourceAdded(::g::Uno::UX::Resource* r)
{
    ...
    if (IsRootingCompleted() && UseContent())
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), r);
}
...
void NodeGroupBase::OnResourceRemoved(::g::Uno::UX::Resource* r)
{
    ...
    if (IsRootingCompleted() && UseContent())
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), r, &ret5);
}
...
void NodeGroupBase::RemoveContent()
{
    ...
    if (_resources != NULL)
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_resources), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_resources), ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret7), ret7), &ret6);

    if (_nodes != NULL)

        for (int i1 = 0; i1 < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_nodes), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i1)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_nodes), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i1), &ret8), ret8);
...
uObject* NodeGroupBase::Resources()
{
    ...
    if (_resources == NULL)
        _resources = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[107/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[108/*Uno.Action<Uno.UX.Resource>*/], (void*)NodeGroupBase__OnResourceAdded_fn, this), uDelegate::New(::TYPES[108/*Uno.Action<Uno.UX.Resource>*/], (void*)NodeGroupBase__OnResourceRemoved_fn, this)));
...
static void OrthographicFrustum_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("TryGetProjectionTransform", NULL, (void*)OrthographicFrustum__TryGetProjectionTransform_fn, 0, false, ::g::Uno::Bool_typeof(), 2, ::TYPES[35/*Fuse.ICommonViewport*/], ::g::Uno::Float4x4_typeof()->ByRef()),
        new uFunction("TryGetProjectionTransformInverse", NULL, (void*)OrthographicFrustum__TryGetProjectionTransformInverse_fn, 0, false, ::g::Uno::Bool_typeof(), 2, ::TYPES[35/*Fuse.ICommonViewport*/], ::g::Uno::Float4x4_typeof()->ByRef()));
}
...
::g::Uno::Float4x4 OrthographicFrustum::GetViewTransform(uObject* viewport)
{
    ...
    ::g::Uno::Float2 viewSize = _hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[35/*Fuse.ICommonViewport*/]));
...
{
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[104/*"Parameter"*/]);
}

static void Visual__ParameterProperty_build(uType* type)
{
    ::STRINGS[104] = uString::Const("Parameter");
...
{
    ::TYPES[109] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[110] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[111] = ::g::Fuse::PlacedHandler_typeof();
    type->SetInterfaces(
...
uObject* TranslationModes__ParentSizeMode::Subscribe(uObject* transform)
{
    ...
    uObject* n = uAs<uObject*>(uPtr(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[110/*Fuse.ITransformRelative*/])))->Parent(), ::TYPES[109/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[109/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[111/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[110/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
...
void TranslationModes__ParentSizeMode::Unsubscribe(uObject* transform, uObject* sub)
{
    ...
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[109/*Fuse.IActualPlacement*/])), ::TYPES[109/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[111/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[110/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}
...
static void PerspectiveFrustum_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(9,
        ...
        new uFunction("TryGetProjectionTransform", NULL, (void*)PerspectiveFrustum__TryGetProjectionTransform_fn, 0, false, ::g::Uno::Bool_typeof(), 2, ::TYPES[35/*Fuse.ICommonViewport*/], ::g::Uno::Float4x4_typeof()->ByRef()),
        new uFunction("TryGetProjectionTransformInverse", NULL, (void*)PerspectiveFrustum__TryGetProjectionTransformInverse_fn, 0, false, ::g::Uno::Bool_typeof(), 2, ::TYPES[35/*Fuse.ICommonViewport*/], ::g::Uno::Float4x4_typeof()->ByRef()));
}
...
bool PerspectiveFrustum::TryGetProjectionTransform(uObject* viewport, ::g::Uno::Float4x4* result)
{
    ...
    return ::g::Fuse::Internal::FrustumMatrix::TryPerspectiveProjection(::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[35/*Fuse.ICommonViewport*/])), 10.0f, 5000.0f + Distance(), Distance(), result);
}
...
bool PerspectiveFrustum::TryGetProjectionTransformInverse(uObject* viewport, ::g::Uno::Float4x4* result)
{
    ...
    return ::g::Fuse::Internal::FrustumMatrix::TryPerspectiveProjectionInverse(::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[35/*Fuse.ICommonViewport*/])), 10.0f, 5000.0f + Distance(), Distance(), result);
}
...
{
    ::STRINGS[54] = uString::Const("x");
    ::STRINGS[105] = uString::Const("y");
    ::STRINGS[106] = uString::Const("width");
    ::STRINGS[107] = uString::Const("height");
    ::TYPES[112] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("Serialize", NULL, (void*)PlacedArgs__Serialize_fn, 0, false, uVoid_typeof(), 1, ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]));
}
...
void PlacedArgs::Serialize(uObject* serializer)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[54/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[105/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[106/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[107/*"height"*/], (double)NewSize().Y);
}
...
{
    ::TYPES[15] = uObject_typeof()->Array();
    ::TYPES[113] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("ForeachInList", NULL, (void*)Properties__ForeachInList_fn, 0, false, uVoid_typeof(), 3, ::g::Fuse::PropertyHandle_typeof(), ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), ::TYPES[15/*object[]*/], NULL), ::TYPES[15/*object[]*/]),
        ...
        new uFunction("ToArray", NULL, (void*)Properties__ToArray_fn, 0, false, ::TYPES[15/*object[]*/], 1, ::g::Fuse::PropertyHandle_typeof()),
...
uArray* Properties::ToArray(::g::Fuse::PropertyHandle* handle)
{
    ...
    if (_handle == NULL)
        return uArray::New(::TYPES[15/*object[]*/], 0);

    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[113/*Uno.Collections.List<object>*/]);
    Properties* p = this;
...
{
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[114] = ::g::Fuse::ITransformMode_typeof();
    type->SetInterfaces(
...
void RelativeTransform::CheckSubscription(bool fromRooted)
{
    ...
    ClearSubscription();
    _subscription = ::g::Fuse::ITransformMode::Subscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[114/*Fuse.ITransformMode*/])), ::TYPES[114/*Fuse.ITransformMode*/]), (uObject*)this);
...
void RelativeTransform::ClearSubscription()
{
    ...
    {
        ::g::Fuse::ITransformMode::Unsubscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[114/*Fuse.ITransformMode*/])), ::TYPES[114/*Fuse.ITransformMode*/]), (uObject*)this, _subscription);
        _subscription = NULL;
    }
}
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Desktop\0.47.7\$.uno
// -------------------------------------------------------------------------
...
// private sealed class App.RootViewHost :536
// {
...
// public generated RootViewHost() :536
void App__RootViewHost__ctor__fn(App__RootViewHost* __this)
{
    __this->ctor_();
}

// private void Fuse.Controls.INativeViewRoot.Add(Fuse.Controls.Native.ViewHandle handle) :538
...
// private void Fuse.Controls.INativeViewRoot.Remove(Fuse.Controls.Native.ViewHandle handle) :539
...
// public generated RootViewHost New() :536
void App__RootViewHost__New1_fn(App__RootViewHost** __retval)
{
    *__retval = App__RootViewHost::New1();
}

// public generated RootViewHost() [instance] :536
void App__RootViewHost::ctor_()
{
}

// public generated RootViewHost New() [static] :536
...
static void RootViewport_build(uType* type)
{
    ...
    ::TYPES[98] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[43] = ::g::Fuse::IFrustum_typeof();
    ::TYPES[115] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    type->SetInterfaces(
        ...
        ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/], offsetof(RootViewport_type, interface6),
    ...
    type->SetFields(55,
        ...
        ::TYPES[43/*Fuse.IFrustum*/], offsetof(::g::Fuse::RootViewport, Frustum), 0,
        ::TYPES[115/*Uno.Action<float2>*/], offsetof(::g::Fuse::RootViewport, Resized1), 0);
    type->Reflection.SetFunctions(17,
        ...
        new uFunction("add_Resized", NULL, (void*)RootViewport__add_Resized_fn, 0, false, uVoid_typeof(), 1, ::TYPES[115/*Uno.Action<float2>*/]),
        new uFunction("remove_Resized", NULL, (void*)RootViewport__remove_Resized_fn, 0, false, uVoid_typeof(), 1, ::TYPES[115/*Uno.Action<float2>*/]),
...
void RootViewport__Draw_fn(RootViewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[10/*Fuse.Visual*/]);
        uPtr(v)->Draw(dc);
    }
}
...
void RootViewport::ctor_3()
{
    ...
    EstablishSize();
    ::g::Fuse::Platform::SystemUI::add_FrameChanged(uDelegate::New(::TYPES[36/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
    uPtr(_frustumViewport)->Update((uObject*)this, Frustum);
    RootInternal(NULL);
...
void RootViewport::add_Resized(uDelegate* value)
{
    ...
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Resized1, value), ::TYPES[115/*Uno.Action<float2>*/]);
}
...
void RootViewport::remove_Resized(uDelegate* value)
{
    ...
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Resized1, value), ::TYPES[115/*Uno.Action<float2>*/]);
}
...
::g::Uno::Float3 RootViewport::ViewOrigin()
{
    ...
    return ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(Frustum), ::TYPES[43/*Fuse.IFrustum*/]), (uObject*)this);
}
...
::g::Uno::Float2 RootViewport::ViewRange()
{
    ...
    return ::g::Fuse::IFrustum::GetDepthRange(uInterface(uPtr(Frustum), ::TYPES[43/*Fuse.IFrustum*/]), (uObject*)this);
}
...
{
    ::TYPES[116] = ::g::Fuse::IScalingMode_typeof();
...
::g::Uno::Float3 Scaling::EffectiveVector()
{
    ...
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[116/*Fuse.IScalingMode*/]), this);
}
...
uObject* TranslationModes__SizeMode::Subscribe(uObject* transform)
{
    ...
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[110/*Fuse.ITransformRelative*/])), ::TYPES[109/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[109/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[111/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[110/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return ::g::Fuse::ITransformRelative::RelativeNode(uInterface(transform, ::TYPES[110/*Fuse.ITransformRelative*/]));
}
...
{
    ::TYPES[117] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof(), NULL);
    ::TYPES[118] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Stage, HasListenersRemoved), 0,
        ::TYPES[117/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, Listeners), 0,
        ::TYPES[117/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, Onces), 0,
        ::TYPES[117/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, OncesPending), 0,
        ::TYPES[118/*Uno.Collections.List<Fuse.UpdateAction>*/], offsetof(::g::Fuse::Stage, PhaseDeferredActions), 0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[117/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[117/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[117/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    PhaseDeferredActions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[118/*Uno.Collections.List<Fuse.UpdateAction>*/]));
...
{
    Toast::_queue_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[119/*Uno.Collections.List<Fuse.Toast>*/]));
}

static void Toast_build(uType* type)
{
    ::TYPES[119] = ::g::Uno::Collections::List_typeof()->MakeType(type, NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[98] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetFields(0,
        ...
        ::TYPES[119/*Uno.Collections.List<Fuse.Toast>*/], (uintptr_t)&::g::Fuse::Toast::_queue_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(3,
...
void Toast::Dismiss()
{
    ...
    if (Toast::_ongoing() == this)
    {
        ...
        {
            Toast::_ongoing() = NULL;
            uPtr(uPtr(::g::Fuse::AppBase::Current2())->ChildrenVisual())->BeginRemoveVisual(_visual, uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)Toast__DispatchNext_fn));
        }
        else
            Toast::DispatchNext();
    }
...
void Toast::DispatchNext()
{
    ...
    ::g::Uno::Collections::IList::Insert_ex(uInterface(uPtr(uPtr(::g::Fuse::AppBase::Current2())->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(0), uPtr(Toast::_ongoing())->_visual);
...
{
    ::TYPES[120] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    type->SetInterfaces(
    ...
    type->SetFields(13,
        ::TYPES[120/*Uno.Action<Fuse.Transform>*/], offsetof(::g::Fuse::Transform, MatrixChanged1), 0);
    type->Reflection.SetFunctions(3,
...
void Transform::add_MatrixChanged(uDelegate* value)
{
    ...
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[120/*Uno.Action<Fuse.Transform>*/]);
}
...
void Transform::remove_MatrixChanged(uDelegate* value)
{
    ...
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[120/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    ::TYPES[121] = ::g::Fuse::ITranslationMode_typeof();
...
void Translation__AppendTo_fn(Translation* __this, ::g::Fuse::FastMatrix* m, float* weight)
{
    ...
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[121/*Fuse.ITranslationMode*/]), __this), weight_);
...
void Translation__PrependTo_fn(Translation* __this, ::g::Fuse::FastMatrix* m)
{
    ...
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[121/*Fuse.ITranslationMode*/]), __this);
...
::g::Uno::Float3 TranslationModes::SizeOf(::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[109/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return ::g::Uno::Float3__New1(0.0f);

    return ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[109/*Fuse.IActualPlacement*/]));
}
// }
...
{
    ::TYPES[122] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
        ...
        ::TYPES[122/*Fuse.IUpdateListener*/], offsetof(::g::Fuse::UpdateListener, update), 0);
}
...
void UpdateListener::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[122/*Fuse.IUpdateListener*/]));
}
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[123/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[124/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[124/*Uno.Collections.List<Uno.Action>*/]));
...
{
    ::STRINGS[108] = uString::Const("no Action found to remove");
    ::STRINGS[109] = uString::Const("no OnceAction found to remove");
    ::TYPES[123] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof(), NULL);
    ::TYPES[124] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Exception_typeof();
    ::TYPES[125] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[3/*Uno.Exception*/], NULL);
    type->SetFields(0,
        ...
        ::TYPES[124/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&::g::Fuse::UpdateManager::_postActions_, uFieldFlagsStatic,
        ::TYPES[124/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&::g::Fuse::UpdateManager::_postActionsSwap_, uFieldFlagsStatic,
        ::TYPES[123/*Uno.Collections.List<Fuse.Stage>*/], (uintptr_t)&::g::Fuse::UpdateManager::_stages_, uFieldFlagsStatic,
...
// internal static Fuse.UpdateStage get_CurrentStage() :3248
...
void UpdateManager::ProcessDeferredActions(::g::Fuse::Stage* stage, ::g::Uno::Collections::List** _exceptions)
{
    ...
    for (; stage->PhaseDeferredActionsAt < uPtr(stage->PhaseDeferredActions)->Count(); ++stage->PhaseDeferredActionsAt)
        ...
        catch (const uThrowable& __t)
        {
            ...
            if (*_exceptions == NULL)
                *_exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[125/*Uno.Collections.List<Uno.Exception>*/]);
...
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[108/*"no Action f...*/]));
...
void UpdateManager::RemoveOnceAction(uDelegate* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Onces, pu, NULL))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[109/*"no OnceActi...*/]));
}
...
// internal static Fuse.UpdateStage get_CurrentStage() [static] :3248
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.UserEvents\0.47.7\$.uno
// ----------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[86/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[126/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[110/*"raise"*/], uDelegate::New(::TYPES[127/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[110] = uString::Const("raise");
    ::STRINGS[111] = uString::Const("UserEvent requires a Name");
    ::STRINGS[112] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.47.7\\$.uno");
    ::STRINGS[113] = uString::Const("OnRooted");
    ::STRINGS[114] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[115] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[116] = uString::Const("Trying to Raise on unrooted UserEvent");
    ::STRINGS[117] = uString::Const("Raise");
    ::STRINGS[118] = uString::Const("Unknown event: ");
    ::STRINGS[119] = uString::Const("RaiseEvent");
    ::TYPES[38] = ::g::Uno::Type_typeof();
    ::TYPES[86] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[126] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[127] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[128] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[129] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[98] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction("Raise", NULL, (void*)UserEvent__Raise_fn, 0, false, uVoid_typeof(), 1, ::TYPES[129/*Uno.Collections.Dictionary<string, object>*/]),
        new uFunction("RaiseEvent", NULL, (void*)UserEvent__RaiseEvent_fn, 0, true, uVoid_typeof(), 3, ::TYPES[10/*Fuse.Visual*/], ::g::Uno::UX::Selector_typeof(), ::TYPES[129/*Uno.Collections.Dictionary<string, object>*/]));
}
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[111/*"UserEvent r...*/], __this, ::STRINGS[112/*"C:\\Users\\...*/], 654, ::STRINGS[113/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[116/*"Trying to R...*/], this, ::STRINGS[112/*"C:\\Users\\...*/], 701, ::STRINGS[117/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[114/*"Raise must ...*/], n, ::STRINGS[112/*"C:\\Users\\...*/], 421, ::STRINGS[110/*"raise"*/], NULL);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[128/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[115/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[112/*"C:\\Users\\...*/], 428, ::STRINGS[110/*"raise"*/], NULL);
        return;
    }

    uArray* keys = uPtr(so)->Keys();
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[129/*Uno.Collections.Dictionary<string, object>*/]);
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[118/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[112/*"C:\\Users\\...*/], 714, ::STRINGS[119/*"RaiseEvent"*/]);
        return;
    }
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            {
                UserEvent* ue = uAs<UserEvent*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), UserEvent_typeof());
...
{
    ::STRINGS[120] = uString::Const("name");
    ::TYPES[112] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    ::TYPES[130] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[131] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[120/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));

    if (__this->Args() != NULL)

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->Args()), &ret3), ret3); enum1.MoveNext(::TYPES[130/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > m = enum1.Current(::TYPES[130/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[112/*Fuse.Scripting.IEventSerializer*/]), m.Key(::TYPES[131/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[131/*Uno.Collections.KeyValuePair<string, object>*/]));
        }
}
...
{
    UserEventDispatch::_userEvents_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[132/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/]));
}

static void UserEventDispatch_build(uType* type)
{
    ::TYPES[132] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), type, NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[133] = ::g::Fuse::UserEventHandler_typeof();
    type->SetFields(0,
        ::g::Uno::UX::Selector_typeof(), offsetof(::g::Fuse::UserEventDispatch, _Name), 0,
        ::TYPES[133/*Fuse.UserEventHandler*/], offsetof(::g::Fuse::UserEventDispatch, Raised1), 0,
        ::TYPES[132/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/], (uintptr_t)&::g::Fuse::UserEventDispatch::_userEvents_, uFieldFlagsStatic);
}
...
void UserEventDispatch::add_Raised(uDelegate* value)
{
    ...
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[133/*Fuse.UserEventHandler*/]);
}
...
void UserEventDispatch::remove_Raised(uDelegate* value)
{
    ...
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[133/*Fuse.UserEventHandler*/]);
}
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[121/*"IsEnabled"*/]);
    ...
    Visual::ParameterName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[104/*"Parameter"*/]);
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[86/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[134/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[104/*"Parameter"*/], uDelegate::New(::TYPES[135/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[122/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[136/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[123/*"onParameter...*/], uDelegate::New(::TYPES[137/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[136/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[124/*"bringIntoView"*/], uDelegate::New(::TYPES[137/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[121] = uString::Const("IsEnabled");
    ::STRINGS[104] = uString::Const("Parameter");
    ::STRINGS[122] = uString::Const(".notNull().parseJson()");
    ::STRINGS[123] = uString::Const("onParameterChanged");
    ::STRINGS[124] = uString::Const("bringIntoView");
    ::STRINGS[125] = uString::Const("index");
    ::STRINGS[126] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[127] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[38] = ::g::Uno::Type_typeof();
    ::TYPES[86] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[134] = ::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(type, ::g::Uno::String_typeof(), NULL);
    ::TYPES[135] = ::g::Uno::Func1_typeof()->MakeType(type, ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), NULL);
    ::TYPES[136] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[137] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[138] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::Function_typeof(), NULL);
    ::TYPES[139] = ::g::Fuse::Scripting::IScriptObject_typeof();
    ::TYPES[15] = uObject_typeof()->Array();
    ::TYPES[140] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[98] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[141] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(type, NULL);
    ::TYPES[142] = ::g::Fuse::Transform_typeof();
    ::TYPES[113] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[143] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof(), NULL);
    ::TYPES[144] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof(), NULL);
    ::TYPES[145] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[146] = ::g::Uno::Comparison_typeof()->MakeType(type, NULL);
    ::TYPES[147] = ::g::Fuse::FastProperty1Link1_typeof();
    ::TYPES[148] = ::g::Fuse::FastProperty2Link1_typeof();
    ::TYPES[18] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[20] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[11] = ::g::Fuse::IViewport_typeof();
    ::TYPES[149] = ::g::Fuse::HitTestCallback_typeof();
    ::TYPES[150] = ::g::Uno::Collections::HashSet_typeof()->MakeType(type, NULL);
    ::TYPES[151] = ::g::Fuse::Internal::MiniList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[41] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[152] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[36] = ::g::Uno::EventHandler_typeof();
    ::TYPES[153] = ::g::Uno::EventArgs_typeof();
    ::TYPES[154] = ::g::Fuse::IBeginRemoveVisualListener_typeof();
    ::TYPES[155] = ::g::Fuse::IParentObserver_typeof();
    ::TYPES[90] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[156] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[157] = ::g::Fuse::ITemplateObserver_typeof();
    ::TYPES[120] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[142/*Fuse.Transform*/], NULL);
    ::TYPES[35] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[158] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof(), NULL);
    ::TYPES[103] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[104] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[159] = type->MakeMethod(3/*FirstChild<Fuse.Visual>*/, type, NULL);
    ::TYPES[107] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[108] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[160] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[161] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(type, NULL);
    ::TYPES[162] = ::g::Fuse::RequestBringIntoViewHandler_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[147/*Fuse.FastProperty1Link`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[148/*Fuse.FastProperty2Link`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL));
    ...
    type->MethodTypes[7]->SetPrecalc(
        ::TYPES[147/*Fuse.FastProperty1Link`1*/]->MakeType(type->MethodTypes[7]->U(0), NULL));
    type->MethodTypes[8]->SetPrecalc(
        ::TYPES[148/*Fuse.FastProperty2Link`1*/]->MakeType(type->MethodTypes[8]->U(0), NULL));
    ...
    type->SetInterfaces(
        ...
        ::TYPES[139/*Fuse.Scripting.IScriptObject*/], offsetof(Visual_type, interface1),
        ...
        ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/], offsetof(Visual_type, interface6),
    ...
    type->SetFields(13,
        ...
        ::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], offsetof(::g::Fuse::Visual, _children), 0,
        ...
        ::TYPES[141/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>*/], offsetof(::g::Fuse::Visual, _interactions), 0,
        ...
        ::TYPES[138/*Uno.Collections.List<Fuse.Scripting.Function>*/], offsetof(::g::Fuse::Visual, _parameterListeners), 0,
        ...
        ::TYPES[20/*Uno.Collections.IList<Uno.UX.Template>*/], offsetof(::g::Fuse::Visual, _templates), 0,
        ...
        ::TYPES[36/*Uno.EventHandler*/], offsetof(::g::Fuse::Visual, IsInteractingChanged1), 0,
        ::TYPES[162/*Fuse.RequestBringIntoViewHandler*/], offsetof(::g::Fuse::Visual, RequestBringIntoView1), 0,
        ::TYPES[36/*Uno.EventHandler*/], offsetof(::g::Fuse::Visual, ZOrderChanged1), 0,
    ...
    type->Reflection.SetFunctions(86,
        ...
        new uFunction("get_Children", NULL, (void*)Visual__get_Children_fn, 0, false, ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/], 0),
        ...
        new uFunction("add_IsContextEnabledChanged", NULL, (void*)Visual__add_IsContextEnabledChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        new uFunction("remove_IsContextEnabledChanged", NULL, (void*)Visual__remove_IsContextEnabledChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        ...
        new uFunction("add_IsInteractingChanged", NULL, (void*)Visual__add_IsInteractingChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        new uFunction("remove_IsInteractingChanged", NULL, (void*)Visual__remove_IsInteractingChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        ...
        new uFunction("add_IsVisibleChanged", NULL, (void*)Visual__add_IsVisibleChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        new uFunction("remove_IsVisibleChanged", NULL, (void*)Visual__remove_IsVisibleChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        ...
        new uFunction("add_ParameterChanged", NULL, (void*)Visual__add_ParameterChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        new uFunction("remove_ParameterChanged", NULL, (void*)Visual__remove_ParameterChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        ...
        new uFunction("add_RequestBringIntoView", NULL, (void*)Visual__add_RequestBringIntoView_fn, 0, false, uVoid_typeof(), 1, ::TYPES[162/*Fuse.RequestBringIntoViewHandler*/]),
        new uFunction("remove_RequestBringIntoView", NULL, (void*)Visual__remove_RequestBringIntoView_fn, 0, false, uVoid_typeof(), 1, ::TYPES[162/*Fuse.RequestBringIntoViewHandler*/]),
        new uFunction("get_Resources", NULL, (void*)Visual__get_Resources_fn, 0, false, ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/], 0),
        ...
        new uFunction("get_Templates", NULL, (void*)Visual__get_Templates_fn, 0, false, ::TYPES[20/*Uno.Collections.IList<Uno.UX.Template>*/], 0),
        ...
        new uFunction("add_WorldTransformInvalidated", NULL, (void*)Visual__add_WorldTransformInvalidated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
        new uFunction("remove_WorldTransformInvalidated", NULL, (void*)Visual__remove_WorldTransformInvalidated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Uno.EventHandler*/]),
...
void Visual__OnChildAdded_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret35), ret35);
            uObject* obs = uAs<uObject*>(n, ::TYPES[155/*Fuse.IParentObserver*/]);

            if ((obs != NULL) && uPtr(n)->IsRootingCompleted())
                ::g::Fuse::IParentObserver::OnChildAddedWhileRooted(uInterface(uPtr(obs), ::TYPES[155/*Fuse.IParentObserver*/]), elm);
        }

    if (uIs(elm, ::TYPES[155/*Fuse.IParentObserver*/]))
...
void Visual__OnChildRemoved_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret36), ret36);
            uObject* obs = uAs<uObject*>(n, ::TYPES[155/*Fuse.IParentObserver*/]);

            if ((obs != NULL) && uPtr(n)->IsRootingCompleted())
                ::g::Fuse::IParentObserver::OnChildRemovedWhileRooted(uInterface(uPtr(obs), ::TYPES[155/*Fuse.IParentObserver*/]), elm);
        }
...
void Visual__OnRooted_fn(Visual* __this)
{
    ...
    {
        uArray* children = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[156/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], __this->Children());
...
void Visual__SubtreeToString1_fn(Visual* __this, ::g::Uno::Text::StringBuilder* sb, int* indent)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret45), ret45))->SubtreeToString1(sb, indent_ + 1);
}
...
void Visual__TryGetResource_fn(Visual* __this, uString* key, uDelegate* acceptor, uObject** resource, bool* __retval)
{
    ...
    if (__this->HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret46), ret46);
...
void Visual__UnoCollectionsICollectionFuseNodeClear_fn(Visual* __this)
{
    ...
    for (uObject* enum1 = (uObject*)__this->_children.GetEnumerator(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/]); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[41/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Node* child = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[152/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret48), ret48);
        __this->OnRemoved(child);
    }

    __this->_children.Clear(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/]);
}
...
void Visual__UnoCollectionsICollectionFuseNodeContains_fn(Visual* __this, ::g::Fuse::Node* item, bool* __retval)
{
    ...
    return *__retval = __this->_children.Contains(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], item), void();
}
...
void Visual__UnoCollectionsICollectionFuseNodeget_Count_fn(Visual* __this, int* __retval)
{
    ...
    return *__retval = __this->_children.Count(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/]), void();
}
...
{
    return *__retval = (uObject*)__this->_children.GetEnumerator(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/]), void();
}
...
void Visual__UnoCollectionsIListFuseNodeget_Item_fn(Visual* __this, int* index, ::g::Fuse::Node** __retval)
{
    ...
    int index_ = *index;
    return *__retval = (::g::Fuse::Node*)__this->_children.Item(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], index_), void();
}
...
void Visual__UnoCollectionsIListFuseNodeRemoveAt_fn(Visual* __this, int* index)
{
    ...
    int index_ = *index;
    ::g::Fuse::Node* b = (::g::Fuse::Node*)__this->_children.Item(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], index_);
    __this->_children.RemoveAt(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], index_);
    __this->OnRemoved(b);
}
...
void Visual__VisitSubtree_fn(Visual* __this, uDelegate* action)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret51), ret51))->VisitSubtree(action);
}
...
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    ...
    if (_parameterListeners == NULL)
        _parameterListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[138/*Uno.Collections.List<Fuse.Scripting.Function>*/]));

    ::g::Uno::Collections::List__Add_fn(uPtr(_parameterListeners), func);

    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        uObject* so = uAs<uObject*>(this, ::TYPES[139/*Fuse.Scripting.IScriptObject*/]);

        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[139/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter)));
    }
}
...
void Visual::BeginInteraction(uObject* id, uDelegate* cancelled)
{
    ...
    if (_interactions == NULL)
        _interactions = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[141/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>*/]));
...
bool Visual::CalcIsLocalFlat()
{
    ...
    {
        ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret15), ret15), ::TYPES[142/*Fuse.Transform*/]);
...
void Visual::CancelInteractions(int how)
{
    ...
    if (_interactions != NULL)
    {
        ::g::Uno::Collections::List* ids = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[113/*Uno.Collections.List<object>*/]);

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uObject*>, Visual__InteractionItem> enum3 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(_interactions), &ret16), ret16); enum3.MoveNext(::TYPES[143/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uObject*>, Visual__InteractionItem> i = enum3.Current(::TYPES[143/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]);
            ::g::Uno::Collections::List__Add_fn(uPtr(ids), i.Key(::TYPES[144/*Uno.Collections.KeyValuePair<object, Fuse.Visual.InteractionItem>*/]));
        }

        for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(ids, &ret17), ret17); enum4.MoveNext(::TYPES[145/*Uno.Collections.List<object>.Enumerator*/]); )
        {
            uObject* id = enum4.Current(::TYPES[145/*Uno.Collections.List<object>.Enumerator*/]);
...
void Visual::EnsureSortedZOrder()
{
    ...
    EnsureZOrder();
    uPtr(ZOrder())->Sort(uDelegate::New(::TYPES[146/*Uno.Comparison<Fuse.Visual>*/], (void*)Visual__ZOrderComparator_fn, this));
    _sortedZOrder = true;
...
::g::Uno::UX::Template* Visual::FindTemplate(uString* key)
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_templates), ::TYPES[18/*Uno.Collections.ICollection<Uno.UX.Template>*/])); (i--) > 0; )
    {
        ::g::Uno::UX::Template* t = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_templates), ::TYPES[20/*Uno.Collections.IList<Uno.UX.Template>*/]), uCRef<int>(i), &ret23), ret23);
...
::g::Fuse::Node* Visual::FirstChild(uType* __type)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
    {
        ::g::Fuse::Node* c = uAs< ::g::Fuse::Node*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret24), ret24), __types[0]);
...
Visual* Visual::FirstVisualChild()
{
    ...
    return (Visual*)FirstChild(::TYPES[159/*Fuse.Visual.FirstChild<Fuse.Visual>*/]);
}
...
Visual* Visual::GetHitWindowPoint(::g::Uno::Float2 windowPoint)
{
    ...
    ::g::Fuse::HitTestContext* htc = ::g::Fuse::HitTestContext::New1(windowPoint, uDelegate::New(::TYPES[149/*Fuse.HitTestCallback*/], (void*)Visual__HitTestRecord__HitTestCallback_fn, htr));
...
::g::Uno::Float4x4 Visual::GetTransformTo(Visual* other)
{
    ...
    bool ret25;
    bool ret26;
    ::g::Uno::Collections::HashSet* parents = (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[150/*Uno.Collections.HashSet<Fuse.Visual>*/]);
    Visual* q = this;
...
Visual* Visual::GetVisualChild(int index)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret27), ret27), Visual_typeof());
...
bool Visual::HasChildren()
{
    ...
    return _children.Count(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/]) > 0;
}
...
void Visual::Insert1(int index, ::g::Fuse::Node* item)
{
    ...
    InsertCleanup(item);
    _children.Insert(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], index, item);
    OnAdded(item);
}
...
void Visual::InsertNodes(int index, uObject* items)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[125/*"index"*/]));

    while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(items), ::TYPES[41/*Uno.Collections.IEnumerator*/])))
        InsertCleanup((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[152/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret31), ret31));
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::IEnumerator::Reset(uInterface(uPtr(items), ::TYPES[41/*Uno.Collections.IEnumerator*/]));

        while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[41/*Uno.Collections.IEnumerator*/])))
            _children.Insert(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], index++, (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[152/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret32), ret32));

        ::g::Uno::Collections::IEnumerator::Reset(uInterface(items, ::TYPES[41/*Uno.Collections.IEnumerator*/]));

        while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[41/*Uno.Collections.IEnumerator*/])))
            OnAdded((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[152/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret33), ret33));
    }
}
...
void Visual::InvalidateLayout(int reason)
{
    ...
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[126/*"Layout was ...*/]));
...
void Visual::InvokeEventHandler(uObject* obj, uObject* args)
{
    ...
    uPtr(uCast<uDelegate*>(obj, ::TYPES[36/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[153/*Uno.EventArgs*/]));
}
...
void Visual::add_IsInteractingChanged(uDelegate* value)
{
    ...
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(IsInteractingChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void Visual::remove_IsInteractingChanged(uDelegate* value)
{
    ...
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(IsInteractingChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
Visual* Visual::LastVisualChild()
{
    ...
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret52), ret52), Visual_typeof());
...
void Visual::OnAdded(::g::Fuse::Node* b)
{
    ...
    ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>(b, ::TYPES[142/*Fuse.Transform*/]);
...
void Visual::OnBeginRemoveVisual(::g::Fuse::PendingRemoveVisual* args)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        uObject* rvl = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret34), ret34), ::TYPES[154/*Fuse.IBeginRemoveVisualListener*/]);

        if (rvl != NULL)
            ::g::Fuse::IBeginRemoveVisualListener::OnBeginRemoveVisual(uInterface(uPtr(rvl), ::TYPES[154/*Fuse.IBeginRemoveVisualListener*/]), args);
    }
}
...
void Visual::OnParameterChanged()
{
    ...
    if (_parameterListeners != NULL)
    {
        ...
        if (so != NULL)
        {
            uObject* param = uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[139/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter);

            for (int i = 0; i < uPtr(_parameterListeners)->Count(); i++)
                uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_parameterListeners), uCRef<int>(i), &ret38), ret38))->Call(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, param));
        }
    }
...
void Visual::OnTemplatesChanged(::g::Uno::UX::Template* t)
{
    ...
    if (IsRootingCompleted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            uObject* to = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret39), ret39), ::TYPES[157/*Fuse.ITemplateObserver*/]);

            if (to != NULL)
                ::g::Fuse::ITemplateObserver::OnTemplatesChangedWileRooted(uInterface(uPtr(to), ::TYPES[157/*Fuse.ITemplateObserver*/]));
        }
}
...
void Visual::OnTransformAdded(::g::Fuse::Transform* t)
{
    ...
    _transformCount++;
    uPtr(t)->add_MatrixChanged(uDelegate::New(::TYPES[120/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
void Visual::OnTransformRemoved(::g::Fuse::Transform* t)
{
    ...
    _transformCount--;
    uPtr(t)->remove_MatrixChanged(uDelegate::New(::TYPES[120/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
void Visual::PrependExplicitTransforms(::g::Fuse::FastMatrix* m)
{
    ...
    if (HasExplicitTransforms())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret41), ret41), ::TYPES[142/*Fuse.Transform*/]);
...
void Visual::RaiseEvent(::g::Fuse::PropertyHandle* ph, int ne)
{
    ...
    if (HasBit2(ne))
        uPtr(Properties())->ForeachInList1(ph, uDelegate::New(::TYPES[158/*Uno.Action<object, object>*/], (void*)Visual__InvokeEventHandler_fn, this), ::g::Uno::EventArgs::Empty());
}
...
void Visual::RearrangeMarginBox()
{
    ...
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[127/*"Invalid cal...*/]));
...
bool Visual::Remove1(::g::Fuse::Node* item)
{
    ...
    if (_children.Remove(::TYPES[151/*Fuse.Internal.MiniList<Fuse.Node>*/], item))
    {
        OnRemoved(item);
        return true;
    }
...
void Visual::RemoveAllChildren(uType* __type)
{
    ...
    while (i >= 0)
    {
        if (uIs((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret42), ret42), __types[0]))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), i);
...
void Visual::add_RequestBringIntoView(uDelegate* value)
{
    ...
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RequestBringIntoView1, value), ::TYPES[162/*Fuse.RequestBringIntoViewHandler*/]);
}
...
void Visual::remove_RequestBringIntoView(uDelegate* value)
{
    ...
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RequestBringIntoView1, value), ::TYPES[162/*Fuse.RequestBringIntoViewHandler*/]);
}
...
uObject* Visual::Resources()
{
    ...
    {
        SetBit4(1);
        uPtr(Properties())->Set(Visual::_resourcesHandle(), (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[107/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[108/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[108/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this)));
    }
...
void Visual::SetResource(uString* key, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); ++i)
    {
        ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret44), ret44);

        if (::g::Uno::String::op_Equality(uPtr(r)->Key(), key))
        {
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(resources), ::TYPES[104/*Uno.Collections.IList<Uno.UX.Resource>*/]), i);
            break;
        }
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(resources), ::TYPES[103/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), ::g::Uno::UX::Resource::New1(key, value));
}
...
uObject* Visual::Templates()
{
    ...
    return (ind7 != NULL) ? ind7 : (uObject*)(_templates = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[160/*Uno.Collections.ObservableList<Uno.UX.Template>*/], uDelegate::New(::TYPES[161/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[161/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this))));
}
...
void Visual::UpdateContextSnapToPixelsCache()
{
    ...
    if (newValue != SnapToPixels())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret49), ret49), Visual_typeof());
...
void Visual::UpdateLayout()
{
    ...
    switch (_layoutDirty)
    {
        ...
        case 1:
        {
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret50), ret50), Visual_typeof());
...
void Visual::add_ZOrderChanged(uDelegate* value)
{
    ...
    ZOrderChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ZOrderChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void Visual::remove_ZOrderChanged(uDelegate* value)
{
    ...
    ZOrderChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ZOrderChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void Visual::AssignZOrder(uObject* nodes)
{
    ...
    Visual_typeof()->Init();
    ::g::Fuse::Node* ret10;
    uArray* current = uArray::Init<int>(::TYPES[140/*int[]*/], 4, 0, 0, 0, 0);

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* visual = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[98/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret10), ret10), Visual_typeof());
...
void Visual::onParameterChanged(::g::Fuse::Scripting::Context* c, Visual* v, uArray* args)
{
    ...
    Visual_typeof()->Init();
    uPtr(v)->AddParameterChangedListener(uCast< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[90/*Fuse.Scripting.Function*/]));
}
// }
...
{
    ::STRINGS[128] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[129] = uString::Const("../../../Packages/Fuse.Nodes/0.47.7/$.uno");
    ::TYPES[163] = ::g::Uno::Collections::List_typeof();
    ::TYPES[3] = ::g::Uno::Exception_typeof();
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[164] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array(), NULL);
    ::TYPES[15] = uObject_typeof()->Array();
    type->SetPrecalc(
        ...
        type->T(1));
    type->SetFields(0,
        ::TYPES[163/*Uno.Collections.List`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::VisualEvent, _globalHandlers), 0,
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[164/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[164/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[128/*"Invalid Rai...*/], 1, ::STRINGS[129/*"../../../Pa...*/], 987);
            return;
        }
    }
...
{
    ::STRINGS[130] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[130/*"visual"*/]));
...
{
    VisualListCache::_visualListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[165/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/]));
}

static void VisualListCache_build(uType* type)
{
    ::TYPES[165] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), NULL);
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[165/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/], (uintptr_t)&::g::Fuse::VisualListCache::_visualListCache_, uFieldFlagsStatic);
}
...
{
    ::STRINGS[131] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
{
    ctor_2(::STRINGS[131/*"Wrapped Exc...*/], inner);
}
