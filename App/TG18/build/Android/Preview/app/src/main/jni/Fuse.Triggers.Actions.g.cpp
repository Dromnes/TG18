...
#include <Fuse.Triggers.Actions-10ca8acd.h>
#include <Fuse.Triggers.Actions-19aca435.h>
#include <Fuse.Triggers.Actions-1c5d7b33.h>
#include <Fuse.Triggers.Actions-1dda770c.h>
#include <Fuse.Triggers.Actions-1ecbf880.h>
#include <Fuse.Triggers.Actions-254e6a02.h>
#include <Fuse.Triggers.Actions-27912a3b.h>
#include <Fuse.Triggers.Actions-2bea2999.h>
#include <Fuse.Triggers.Actions-442c79fe.h>
#include <Fuse.Triggers.Actions-4e380e56.h>
#include <Fuse.Triggers.Actions-504f1beb.h>
#include <Fuse.Triggers.Actions-53b6ae74.h>
#include <Fuse.Triggers.Actions-598112db.h>
#include <Fuse.Triggers.Actions-5a595422.h>
#include <Fuse.Triggers.Actions-6e8373b3.h>
#include <Fuse.Triggers.Actions-770d983.h>
#include <Fuse.Triggers.Actions-a9e252c4.h>
#include <Fuse.Triggers.Actions-b140479e.h>
#include <Fuse.Triggers.Actions-c1198770.h>
#include <Fuse.Triggers.Actions-c9bb231d.h>
#include <Fuse.Triggers.Actions-cea11b76.h>
#include <Fuse.Triggers.Actions-d3d6294.h>
#include <Fuse.Triggers.Actions-d5e73d8f.h>
#include <Fuse.Triggers.Actions-dbbca1cb.h>
#include <Fuse.Triggers.Actions-dd0879e5.h>
#include <Fuse.Triggers.Actions-ec2327b1.h>
#include <Fuse.Triggers.Actions-f0c555a.h>
#include <Fuse.Triggers.Actions-f3a67441.h>
#include <Fuse.Triggers.Actions-f84ec3c1.h>
#include <Fuse.Triggers.Actions-fda38800.h>
#include <Fuse.Triggers.Actions-fe42da8a.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Elements\0.47.7\triggers\actions\$.uno
// -------------------------------------------------------------------------------------------
...
static void PlayTo_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.47.7\\actions\\$.uno");
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.47.7\\$.uno");
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.47.7\\$.uno");
    ::STRINGS[12] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
