...
#include <FuseJS.FileReaderImpl-c53a76b9.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\FuseJS\0.47.7\$.uno
// -------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[55] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\FuseJS\\0.47.7\\$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[54/*"Cannot find...*/], Name), this, ::STRINGS[55/*"C:\\Users\\...*/], 889, ::STRINGS[56/*"Raise"*/], NULL);
        return;
    }
