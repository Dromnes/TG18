...
#include <Fuse.Effects.DropShad-882510a4.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Effects\0.47.7\$.uno
// -------------------------------------------------------------------------
...
void DropShadow__Blitter::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* element, ::g::Uno::Rect elementRect, float padding, ::g::Uno::Int2 tempSize, ::g::Uno::Graphics::Texture2D* blurTexture, float spreadScale, ::g::Uno::Float2 offset, ::g::Uno::Float4 color)
{
    ...
    _draw_3fea72d7.Sampler3(6, blurTexture, ::g::Uno::Graphics::SamplerState__LinearClamp());
...
void Blur__OnRender_fn(Blur* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Rect* elementRect)
{
    ...
    __this->_draw_71e4915d.Sampler3(3, uPtr(blur)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
...
void Desaturate__OnRender_fn(Desaturate* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Rect* elementRect)
{
    ...
    __this->_draw_86b72be7.Sampler3(4, uPtr(original)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
...
static void Duotone_build(uType* type)
{
    ...
    type->SetFields(17,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Fuse::Effects::Duotone, _draw_d2c2c0f4), 0,
        ...
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Effects::Duotone, OnRender_LocalTransform_d2c2c0f4_4_9_2), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Effects::Duotone, OnRender_LocalTransform_d2c2c0f4_4_9_3), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Effects::Duotone, OnRender_VertexData_d2c2c0f4_7_2_1), 0);
...
void Duotone__OnRender_fn(Duotone* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Rect* elementRect)
{
    ...
    ::g::Uno::Float4x4 LocalTransform_d2c2c0f4_4_9_4 = ::g::Uno::Matrix::Mul10(__this->OnRender_LocalTransform_d2c2c0f4_4_9_2, ::g::Uno::Matrix::Scaling1(elementRect_.Size().X, elementRect_.Size().Y, 1.0f), __this->OnRender_LocalTransform_d2c2c0f4_4_9_3, ::g::Uno::Matrix::Translation(elementRect_.Minimum().X, elementRect_.Minimum().Y, 0.0f));
    __this->_draw_d2c2c0f4.BlendEnabled(true);
    __this->_draw_d2c2c0f4.DepthTestEnabled(false);
    __this->_draw_d2c2c0f4.CullFace(uPtr(dc)->CullFace());
    __this->_draw_d2c2c0f4.BlendSrcRgb(2);
    __this->_draw_d2c2c0f4.BlendDstRgb(3);
    __this->_draw_d2c2c0f4.BlendDstAlpha(3);
    __this->_draw_d2c2c0f4.Use();
    __this->_draw_d2c2c0f4.Attrib1(0, 2, __this->OnRender_VertexData_d2c2c0f4_7_2_1, 8, 0);
    __this->_draw_d2c2c0f4.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[0/*Fuse.IRenderViewport*/])));
    __this->_draw_d2c2c0f4.Uniform6(2, __this->_shadow);
    __this->_draw_d2c2c0f4.Uniform6(3, __this->_light);
    __this->_draw_d2c2c0f4.Uniform(4, __this->Amount());
    __this->_draw_d2c2c0f4.Uniform12(5, (__this->Element() != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_d2c2c0f4_4_9_4, uPtr(__this->Element())->WorldTransform()) : LocalTransform_d2c2c0f4_4_9_4);
    __this->_draw_d2c2c0f4.Sampler3(6, uPtr(original)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
    __this->_draw_d2c2c0f4.DrawArrays(6);
    ::g::Fuse::FramebufferPool::Release(original);
}
...
void Duotone::init_DrawCalls()
{
    ...
    OnRender_VertexData_d2c2c0f4_7_2_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(uArray::Init< ::g::Uno::Float2>(::TYPES[1/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f))), 0);
    OnRender_LocalTransform_d2c2c0f4_4_9_2 = ::g::Uno::Matrix::Translation(-::g::Uno::Float2__New1(0.0f).X, -::g::Uno::Float2__New1(0.0f).Y, 0.0f);
    OnRender_LocalTransform_d2c2c0f4_4_9_3 = ::g::Uno::Matrix::RotationZ(0.0f);
    _draw_d2c2c0f4 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseEffects_bundle::Duotonef0ae9d3a());
}
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Elements\0.47.7\effects\$.uno
// ----------------------------------------------------------------------------------
...
void Halftone__OnRender_fn(Halftone* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Rect* elementRect)
{
    ...
    __this->_draw_a4fda2a4.Sampler3(13, uPtr(original)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
...
void Mask__OnRender_fn(Mask* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Rect* elementRect)
{
    ...
    switch (__this->_mode)
    {
        case 0:
        {
            ...
            __this->_draw_21360147.Sampler3(5, uPtr(original)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
        ...
        case 1:
        {
            ...
            __this->_draw_193b0147.Sampler3(5, uPtr(original)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
        ...
        case 2:
        {
            ...
            __this->_draw_312c0147.Sampler3(5, uPtr(original)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
