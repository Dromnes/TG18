...
#include <Fuse.Controls.ScrollP-40b272d3.h>
...
#include <Fuse.Gestures.Circula-9540c317.h>
#include <Fuse.Gestures.Clicked.h>
#include <Fuse.Gestures.ClickedArgs.h>
#include <Fuse.Gestures.ClickedHandler.h>
#include <Fuse.Gestures.Clicker.h>
#include <Fuse.Gestures.Clicker-63ebb43e.h>
...
#include <Fuse.Gestures.DoubleT-fe4d5869.h>
#include <Fuse.Gestures.Edge.h>
#include <Fuse.Gestures.EdgeSwi-6f66aa89.h>
#include <Fuse.Gestures.Interna-1fb74f35.h>
#include <Fuse.Gestures.Interna-2634f6cd.h>
#include <Fuse.Gestures.Interna-40f52e14.h>
#include <Fuse.Gestures.Interna-4ebf99fc.h>
#include <Fuse.Gestures.Interna-5ee863d1.h>
#include <Fuse.Gestures.Interna-8014833b.h>
#include <Fuse.Gestures.Interna-b40f9dda.h>
#include <Fuse.Gestures.Interna-d11b2f49.h>
...
#include <Fuse.Gestures.LinearR-c7364e91.h>
#include <Fuse.Gestures.LongPre-dd6de702.h>
...
#include <Fuse.Gestures.Scrolle-aa988f9c.h>
...
#include <Fuse.Gestures.ToggleS-bac6e013.h>
#include <Fuse.Gestures.TransformGesture.h>
#include <Fuse.Gestures.WhileCl-41538da9.h>
...
#include <Fuse.Input.PointerEnt-133e3c6c.h>
...
#include <Fuse.Input.PointerWhe-2f1235d9.h>
...
#include <Fuse.Motion.Simulatio-906f30a9.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.47.7\rangecontrols\$.uno
// ---------------------------------------------------------------------------------------------------
...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\0.47.7\\rangecontrols\\$.uno");
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Gestures\0.47.7\$.uno
// --------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Gestures\0.47.7\internal\$.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\0.47.7\$.uno
// -------------------------------------------------------------------------------------
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\0.47.7\\$.uno");
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Invalid scr...*/], NULL, ::STRINGS[9/*"C:\\Users\\...*/], 435, ::STRINGS[13/*"OnUpdated"*/]);
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"inconsisten...*/], NULL, ::STRINGS[9/*"C:\\Users\\...*/], 218, ::STRINGS[15/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"inconsisten...*/], NULL, ::STRINGS[9/*"C:\\Users\\...*/], 225, ::STRINGS[15/*"UpdatePoint...*/]);
        else
        {
            uPtr(_gesture)->Dispose();
            _gesture = NULL;
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\0.47.7\\$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[17/*"Element"*/], __this->Parent(), __this, ::STRINGS[18/*"C:\\Users\\...*/], 1126, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }
