...
#include <Fuse.Input.PointerWhe-a5bbc093.h>
...
#include <jni.h>
#include <Outracks.Simulator.Ag-b2968c6d.h>
#include <Outracks.Simulator.Ap-1650505d.h>
#include <Outracks.Simulator.Ap-999e7f5a.h>
...
#include <Outracks.Simulator.By-c6309127.h>
#include <Outracks.Simulator.By-f964b10f.h>
#include <Outracks.Simulator.ChangeIp.h>
#include <Outracks.Simulator.Closure.h>
#include <Outracks.Simulator.Co-33b10b30.h>
#include <Outracks.Simulator.Co-86f5f845.h>
#include <Outracks.Simulator.Co-883cc57.h>
#include <Outracks.Simulator.Co-ace6329f.h>
#include <Outracks.Simulator.Co-b47b0508.h>
#include <Outracks.Simulator.Co-c715bdc9.h>
#include <Outracks.Simulator.Connected.h>
#include <Outracks.Simulator.Connecting.h>
#include <Outracks.Simulator.Context.h>
#include <Outracks.Simulator.De-2d97e856.h>
#include <Outracks.Simulator.DeviceInfo.h>
#include <Outracks.Simulator.Di-21d6f27f.h>
#include <Outracks.Simulator.Di-289155e3.h>
#include <Outracks.Simulator.Di-bb741075.h>
#include <Outracks.Simulator.Du-e06814bd.h>
#include <Outracks.Simulator.En-3a89fa78.h>
#include <Outracks.Simulator.En-5625ea01.h>
#include <Outracks.Simulator.ErrorToast.h>
#include <Outracks.Simulator.Exceptions.h>
#include <Outracks.Simulator.Fa-5db051cf.h>
#include <Outracks.Simulator.Fa-8d0d447f.h>
#include <Outracks.Simulator.Fa-920345f4.h>
#include <Outracks.Simulator.Fa-dde75e4a.h>
#include <Outracks.Simulator.FakeApp.h>
#include <Outracks.Simulator.Faulted.h>
#include <Outracks.Simulator.Flasher.h>
#include <Outracks.Simulator.Fo-a0fb4ba5.h>
#include <Outracks.Simulator.Fo-a0fb4ba6.h>
#include <Outracks.Simulator.Forget-2.h>
#include <Outracks.Simulator.Forget-3.h>
#include <Outracks.Simulator.Ge-19efe557.h>
#include <Outracks.Simulator.GoOffline.h>
#include <Outracks.Simulator.Idle.h>
#include <Outracks.Simulator.IE-4f9891a4.h>
#include <Outracks.Simulator.Im-c984c489.h>
#include <Outracks.Simulator.In-991d97c3.h>
#include <Outracks.Simulator.In-b3e552d1.h>
#include <Outracks.Simulator.InputMode.h>
#include <Outracks.Simulator.IS-553170fc.h>
#include <Outracks.Simulator.List.h>
#include <Outracks.Simulator.Lo-fa2e4809.h>
#include <Outracks.Simulator.ModalDialog.h>
#include <Outracks.Simulator.No-16ff05e1.h>
#include <Outracks.Simulator.Of-5bccded0.h>
#include <Outracks.Simulator.Pr-2072d9a4.h>
#include <Outracks.Simulator.Pr-2f2b13f3.h>
#include <Outracks.Simulator.Pr-3426b3cc.h>
#include <Outracks.Simulator.Pr-3494b812.h>
#include <Outracks.Simulator.Pr-53d722cb.h>
#include <Outracks.Simulator.Pr-5981e2f7.h>
#include <Outracks.Simulator.Pr-7aa936e3.h>
#include <Outracks.Simulator.Pr-9e9a9b3b.h>
#include <Outracks.Simulator.Pr-c197dd.h>
#include <Outracks.Simulator.Pr-d2b1abe0.h>
...
#include <Outracks.Simulator.Se-6bc686d2.h>
#include <Outracks.Simulator.Sh-80a6ce89.h>
#include <Outracks.Simulator.Sh-bbec5a41.h>
#include <Outracks.Simulator.Si-334a0169.h>
#include <Outracks.Simulator.St-a40ac2e1.h>
#include <Outracks.Simulator.State.h>
#include <Outracks.Simulator.Ta-9b1bb554.h>
#include <Outracks.Simulator.Task-1.h>
#include <Outracks.Simulator.Tasks.h>
#include <Outracks.Simulator.Un-d3f047b3.h>
#include <Outracks.Simulator.Us-39932f4a.h>
#include <Outracks.Simulator.Wa-93fe7492.h>
...
#include <Uno.Collections.ReadO-9f0438b5.h>
#include <Uno.Color.h>
...
#include <Uno.Platform.Applicat-e6eaed1.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Fuse\App\app-0.36.1.12010\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\$.uno
// ---------------------------------------------------------------------------------------------------------------------
...
static void Application_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.36.1.12010\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
...
// C:\Users\marti\AppData\Local\Fusetools\Fuse\App\app-0.36.1.12010\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\common\$.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Fuse\App\app-0.36.1.12010\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\concurrency\$.uno
// ---------------------------------------------------------------------------------------------------------------------------------
...
// public static extern string GetGUID() :1689
void DeviceInfo__GetGUID_fn(uString** __retval)
{
    *__retval = DeviceInfo::GetGUID();
}

// public static extern string GetName() :1683
...
// public static extern string GetGUID() [static] :1689
uString* DeviceInfo::GetGUID()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetGUID346", "()Ljava/lang/String;");
...
// public static extern string GetName() [static] :1683
uString* DeviceInfo::GetName()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetName347", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
static void Running_build(uType* type)
{
    ...
    ::STRINGS[60] = uString::Const("Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[38] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[46] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
...
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[59/*"Density cha...*/], 1, ::STRINGS[60/*"Packages/Ou...*/], 562);
...
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[60/*"Packages/Ou...*/], 1540);
    return *__retval = __this, void();
}
...
{
    ::STRINGS[61] = uString::Const("Ok");
    ::STRINGS[62] = uString::Const("Cancel");
...
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ;
    uPtr(collection1)->Text(::STRINGS[61/*"Ok"*/]);
    ::STRINGS[61/*"Ok"*/];
    ...
    ;
    uPtr(collection2)->Text(::STRINGS[62/*"Cancel"*/]);
    ::STRINGS[62/*"Cancel"*/];
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[63/*"# "*/], __this->_header), 1, ::STRINGS[60/*"Packages/Ou...*/], 1450);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[60/*"Packages/Ou...*/], 1451);
...
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[60/*"Packages/Ou...*/], 1045);
    }
}
