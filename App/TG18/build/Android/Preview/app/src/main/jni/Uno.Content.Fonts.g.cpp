...
#include <Uno.Content.Fonts.Bit-37dac05f.h>
#include <Uno.Content.Fonts.Bit-d334a7e5.h>
#include <Uno.Content.Fonts.BitmapFont.h>
#include <Uno.Content.Fonts.Cpp-de3af34d.h>
#include <Uno.Content.Fonts.CppFontFace.h>
#include <Uno.Content.Fonts.Def-4a6def7f.h>
#include <Uno.Content.Fonts.Fon-2d909829.h>
#include <Uno.Content.Fonts.FontFace.h>
#include <Uno.Content.Fonts.Ren-93b3e294.h>
#include <Uno.Content.Fonts.Sdf-fcdf4d8e.h>
#include <Uno.Content.Fonts.Spr-ac459106.h>
#include <Uno.Content.Fonts.Tex-257638a0.h>
#include <Uno.Content.Fonts.Tex-d2fe174c.h>
...
#include <Uno.Graphics.VertexAt-1f8449a6.h>
...
#include <Uno.Runtime.Implement-c1cd04fd.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\UnoCore\0.47.13\source\uno\content\fonts\$.uno
// ----------------------------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("../../../Packages/UnoCore/0.47.13/source/uno/content/fonts/$.uno");
    type->SetFields(0,
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[1/*"DefaultText...*/], 1, ::STRINGS[2/*"../../../Pa...*/], 321);
    return *__retval = __this->_matrix, void();
}
