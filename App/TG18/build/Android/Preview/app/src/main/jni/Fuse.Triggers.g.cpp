...
#include <Fuse.Animations.Playe-f7ddf41d.h>
#include <Fuse.Animations.PlayMode.h>
#include <Fuse.Animations.TrackAnimator.h>
#include <Fuse.Animations.Trans-8bdd6c45.h>
#include <Fuse.Animations.Trigg-93c253f8.h>
#include <Fuse.Animations.Trigg-957ef503.h>
#include <Fuse.Animations.Trigg-e37e6e4c.h>
#include <Fuse.Controls.ITextEditControl.h>
#include <Fuse.Controls.IWebView.h>
#include <Fuse.Controls.Navigat-44108024.h>
#include <Fuse.Controls.Navigat-5cd486b5.h>
#include <Fuse.Controls.Navigat-c30b1c3e.h>
#include <Fuse.Controls.Navigat-d4ced927.h>
#include <Fuse.Controls.Navigator.h>
#include <Fuse.Controls.ScrollDirections.h>
#include <Fuse.Controls.ScrollP-b5c8f9f8.h>
#include <Fuse.Controls.ScrollView.h>
#include <Fuse.Controls.ScrollViewBase.h>
#include <Fuse.Controls.TextInp-2ad76625.h>
#include <Fuse.Controls.TextInp-99f63cb6.h>
#include <Fuse.Controls.TextInp-aeee3f69.h>
#include <Fuse.Controls.WebView.h>
#include <Fuse.Diagnostics.h>
#include <Fuse.Elements.Element.h>
#include <Fuse.Elements.Preplac-247bd81c.h>
...
#include <Fuse.Platform.SystemU-52af75f8.h>
...
#include <Fuse.Triggers.Actions-dbbca1cb.h>
#include <Fuse.Triggers.Actions-ec2327b1.h>
...
#include <Fuse.Triggers.BusyTas-29d338e2.h>
...
#include <Fuse.Triggers.Complet-74999c02.h>
#include <Fuse.Triggers.Completed.h>
#include <Fuse.Triggers.Complet-fae3aabf.h>
#include <Fuse.Triggers.ContainingText.h>
#include <Fuse.Triggers.IBusyHandler.h>
#include <Fuse.Triggers.IMediaPlayback.h>
#include <Fuse.Triggers.Interac-6bd1994c.h>
#include <Fuse.Triggers.iOS.h>
#include <Fuse.Triggers.IPlayback.h>
#include <Fuse.Triggers.IProgress.h>
#include <Fuse.Triggers.IPulseTrigger.h>
#include <Fuse.Triggers.IScroll-58e37172.h>
#include <Fuse.Triggers.IScroll-5f432f1b.h>
#include <Fuse.Triggers.IScroll-98626b56.h>
#include <Fuse.Triggers.IScroll-a084fbf4.h>
#include <Fuse.Triggers.IScrolledLength.h>
#include <Fuse.Triggers.IScrolledLengths.h>
#include <Fuse.Triggers.IValue-1.h>
#include <Fuse.Triggers.IVisibility.h>
#include <Fuse.Triggers.KeyPressHandler.h>
#include <Fuse.Triggers.LayoutA-26c2d2e5.h>
#include <Fuse.Triggers.LayoutAnimation.h>
#include <Fuse.Triggers.LayoutT-26738dd1.h>
#include <Fuse.Triggers.LayoutT-5c476e09.h>
#include <Fuse.Triggers.LayoutT-7e77e515.h>
#include <Fuse.Triggers.LayoutT-8c989cfe.h>
#include <Fuse.Triggers.LayoutT-9dffdf50.h>
#include <Fuse.Triggers.LayoutT-b64ddb63.h>
#include <Fuse.Triggers.LayoutT-b774ec2e.h>
#include <Fuse.Triggers.LayoutTransition.h>
#include <Fuse.Triggers.OnBackButton.h>
#include <Fuse.Triggers.OnKeyPress.h>
#include <Fuse.Triggers.OnUserE-60db16f0.h>
#include <Fuse.Triggers.OnUserEvent.h>
#include <Fuse.Triggers.PageBeginLoading.h>
#include <Fuse.Triggers.PageLoaded.h>
#include <Fuse.Triggers.Progres-6c72ee30.h>
...
#include <Fuse.Triggers.WhileKe-9dca693c.h>
#include <Fuse.Triggers.WhileKe-e286b5d.h>
...
#include <Fuse.Triggers.WhileVi-4c3809e8.h>
#include <Fuse.Triggers.WhileVisible.h>
#include <Fuse.Triggers.WhileWi-2e7b7d8e.h>
#include <Fuse.Triggers.WhileWi-403bcf40.h>
#include <Fuse.Triggers.WhileWi-b6203d01.h>
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\0.47.7\\$.uno");
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.47.7\triggers\$.uno
// ----------------------------------------------------------------------------------------------
...
static void ContainingText_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\0.47.7\\triggers\\$.uno");
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\0.47.7\triggers\$.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Triggers\0.47.7\actions\$.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls\0.47.7\triggers\$.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Elements\0.47.7\triggers\$.uno
// -----------------------------------------------------------------------------------
...
static void LayoutAnimation_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\0.47.7\\triggers\\$.uno");
...
void LayoutAnimation__OnRooted_fn(LayoutAnimation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"LayoutAnima...*/], __this, ::STRINGS[20/*"C:\\Users\\...*/], 228, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
static void OnUserEvent_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\0.47.7\\$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\0.47.7\$.uno
// ----------------------------------------------------------------------------------
...
static void PageBeginLoading_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.WebView\\0.47.7\\$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"C:\\Users\\...*/], 1058, ::STRINGS[21/*"OnRooted"*/]);
}
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"C:\\Users\\...*/], 1117, ::STRINGS[21/*"OnRooted"*/]);
}
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Double remo...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 1729, ::STRINGS[27/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unexpected ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 1742, ::STRINGS[29/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\0.47.7\\triggers\\$.uno");
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"reset takes...*/], s, ::STRINGS[32/*"C:\\Users\\...*/], 242, ::STRINGS[30/*"check"*/], NULL);
        return;
    }
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Cannot call...*/], NULL, ::STRINGS[3/*"C:\\Users\\...*/], 2148, ::STRINGS[37/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"StateGroup....*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 1812, ::STRINGS[40/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[41/*"Unable to f...*/], name), n, ::STRINGS[3/*"C:\\Users\\...*/], 1792, ::STRINGS[42/*"gotoName"*/], NULL);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 2569, ::STRINGS[50/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"C:\\Users\\...*/], 2618, ::STRINGS[52/*"seek"*/], NULL);
        return;
    }
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\0.47.7\$.uno
// -------------------------------------------------------------------------------------
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[57] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\0.47.7\\$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Transition ...*/], t, ::STRINGS[57/*"C:\\Users\\...*/], 2709, ::STRINGS[58/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Transition ...*/], t, ::STRINGS[57/*"C:\\Users\\...*/], 2716, ::STRINGS[58/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[60/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 2911, ::STRINGS[61/*"Fuse.Animat...*/]);
        return;
    }
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"C:\\Users\\...*/], 836, ::STRINGS[21/*"OnRooted"*/]);
}
...
void WhileScrolled__OnRooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 795, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[64/*"`Pulse` on ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 4274, ::STRINGS[65/*"Pulse"*/]);
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"Could not f...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 900, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Parent must...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 907, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Must have a...*/], __this, ::STRINGS[32/*"C:\\Users\\...*/], 913, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
