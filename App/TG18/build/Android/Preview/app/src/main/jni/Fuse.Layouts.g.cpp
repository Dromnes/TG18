...
#include <Fuse.Layouts.ColumnLa-fd8c822.h>
#include <Fuse.Layouts.ColumnLayout.h>
#include <Fuse.Layouts.DefaultLayout.h>
#include <Fuse.Layouts.Definiti-bd4fc4e3.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\0.47.7\layouts\$.uno
// -----------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Panels\\0.47.7\\layouts\\$.uno");
...
void GridLayout::ModifyCount(uType* __type, uObject* list, int count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"RowCount an...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1116, ::STRINGS[7/*"ModifyCount"*/], NULL);
        return;
    }
