...
#include <Fuse.Motion.DelayFunc-5feedff5.h>
...
#include <Fuse.Motion.Simulatio-23d91a78.h>
#include <Fuse.Motion.Simulatio-566660c2.h>
...
#include <Fuse.Motion.Simulatio-c58f2415.h>
#include <Fuse.Motion.Simulatio-d31a266b.h>
#include <Fuse.Motion.Simulatio-e290569c.h>
#include <Fuse.Motion.SpringFun-26a3f09f.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Motion\0.47.7\$.uno
// ------------------------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Motion\\0.47.7\\$.uno");
...
uObject* DestinationMotion::Create()
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"C:\\Users\\...*/], 401, ::STRINGS[2/*"Create"*/], NULL);
