...
#include <Fuse.Scripting.AppIni-f89bd768.h>
...
#include <Fuse.Scripting.Double-23a614ea.h>
#include <Fuse.Scripting.Error.h>
#include <Fuse.Scripting.EventE-8be4e110.h>
#include <Fuse.Scripting.ExecutionThread.h>
#include <Fuse.Scripting.External.h>
#include <Fuse.Scripting.Factor-af5af8f3.h>
...
#include <Fuse.Scripting.JSCall-2477afff.h>
#include <Fuse.Scripting.JSCall-3c81522e.h>
#include <Fuse.Scripting.JSCall-45198518.h>
#include <Fuse.Scripting.JSCall-4519851b.h>
#include <Fuse.Scripting.JSCall-64d2c207.h>
#include <Fuse.Scripting.JSCallback.h>
#include <Fuse.Scripting.JSCall-df28c6c9.h>
#include <Fuse.Scripting.JSCall-eef85ed.h>
#include <Fuse.Scripting.JSObjectUtils.h>
#include <Fuse.Scripting.Module.h>
#include <Fuse.Scripting.ModuleResult.h>
#include <Fuse.Scripting.Native-23dfe193.h>
#include <Fuse.Scripting.Native-8bbe2585.h>
#include <Fuse.Scripting.NativeCallback.h>
#include <Fuse.Scripting.Native-d5022f1e.h>
#include <Fuse.Scripting.Native-df4175fe.h>
#include <Fuse.Scripting.Native-e68cd234.h>
#include <Fuse.Scripting.NativeEvent.h>
#include <Fuse.Scripting.Native-f3c8e77e.h>
#include <Fuse.Scripting.Native-fcfd22ff.h>
#include <Fuse.Scripting.NativeFunction.h>
#include <Fuse.Scripting.NativeMember.h>
#include <Fuse.Scripting.NativeModule.h>
#include <Fuse.Scripting.NativePromise-2.h>
#include <Fuse.Scripting.Object.h>
#include <Fuse.Scripting.Result-f129cd22.h>
#include <Fuse.Scripting.ResultFactory-1.h>
#include <Fuse.Scripting.Script-27b2f32f.h>
#include <Fuse.Scripting.Script-6731f3bf.h>
#include <Fuse.Scripting.Script-bc981f92.h>
#include <Fuse.Scripting.ScriptClass.h>
#include <Fuse.Scripting.Script-ea1a8f8f.h>
...
#include <Fuse.Scripting.String-6e34b3a3.h>
#include <Fuse.Scripting.Value.h>
#include <Fuse.Scripting.ValueC-4cd5cc17.h>
...
#include <Uno.Threading.Concurr-928e25ca.h>
#include <Uno.Threading.Future-1.h>
#include <Uno.Threading.IDispat-8f89e3ba.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Scripting\0.47.7\$.uno
// ---------------------------------------------------------------------------
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("../../../Packages/Fuse.Scripting/0.47.7/$.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[29/*"this.Contex...*/], ::STRINGS[30/*"../../../Pa...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[40] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting\\0.47.7\\$.uno");
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[39/*" was fixed!"*/]), this, ::STRINGS[40/*"C:\\Users\\...*/], 1854, ::STRINGS[41/*"Require"*/]);
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[57/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[58/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[59/*"\n })"*/]);
