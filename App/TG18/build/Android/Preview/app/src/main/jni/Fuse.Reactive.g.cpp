...
#include <Fuse.Reactive.BinaryO-58f3f505.h>
...
#include <Fuse.Reactive.DataToR-d46de42a.h>
...
#include <Fuse.Reactive.Express-c8917901.h>
#include <Fuse.Reactive.Expression.h>
#include <Fuse.Reactive.Functio-c6792cb6.h>
...
#include <Fuse.Reactive.InnerLi-25f01151.h>
#include <Fuse.Reactive.InnerListener.h>
#include <Fuse.Reactive.Instance.h>
#include <Fuse.Reactive.Instant-58eb965c.h>
#include <Fuse.Reactive.Instant-e91fb2fb.h>
#include <Fuse.Reactive.Instantiator.h>
#include <Fuse.Reactive.IObservable.h>
#include <Fuse.Reactive.IObserver.h>
#include <Fuse.Reactive.ISubscription.h>
#include <Fuse.Reactive.IWriteable.h>
#include <Fuse.Reactive.JavaScr-e8845bef.h>
#include <Fuse.Reactive.JavaScript.h>
#include <Fuse.Reactive.LazyObs-bf65a558.h>
...
#include <Fuse.Reactive.Member.-411936c6.h>
...
#include <Fuse.Reactive.Observa-20f9da5.h>
#include <Fuse.Reactive.Observa-258665e3.h>
#include <Fuse.Reactive.Observa-449c533c.h>
#include <Fuse.Reactive.Observa-44b05324.h>
#include <Fuse.Reactive.Observa-773d07dc.h>
#include <Fuse.Reactive.Observa-7efa6418.h>
#include <Fuse.Reactive.Observa-87d533dc.h>
#include <Fuse.Reactive.Observa-922e79c.h>
#include <Fuse.Reactive.Observa-acb5a0ea.h>
...
#include <Fuse.Reactive.Observa-d25b27dc.h>
#include <Fuse.Reactive.Propert-46d161dc.h>
#include <Fuse.Reactive.Property.h>
#include <Fuse.Reactive.PropertyBinding.h>
#include <Fuse.Reactive.Quatern-86ad1bb1.h>
#include <Fuse.Reactive.Quatern-c87683ea.h>
#include <Fuse.Reactive.Resourc-d34b0fa6.h>
#include <Fuse.Reactive.Resource.h>
#include <Fuse.Reactive.ResourceBinding.h>
#include <Fuse.Reactive.Rootabl-c73b22db.h>
#include <Fuse.Reactive.Select.h>
#include <Fuse.Reactive.Snapsho-2c59e608.h>
#include <Fuse.Reactive.Snapshot.h>
#include <Fuse.Reactive.Subtract.h>
#include <Fuse.Reactive.Ternary-4a73a6ec.h>
#include <Fuse.Reactive.TernaryOperator.h>
#include <Fuse.Reactive.This.h>
#include <Fuse.Reactive.ThreadW-16741eac.h>
#include <Fuse.Reactive.ThreadW-753c8bf1.h>
#include <Fuse.Reactive.ThreadW-7728f767.h>
#include <Fuse.Reactive.ThreadWorker.h>
#include <Fuse.Reactive.ToLower.h>
#include <Fuse.Reactive.ToUpper.h>
#include <Fuse.Reactive.UnaryOp-ca38d18.h>
#include <Fuse.Reactive.UnaryOperator.h>
#include <Fuse.Reactive.ValueFo-56db492b.h>
...
#include <Uno.Bool.h>
#include <Uno.Collections.Dicti-a59832d1.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Reactive.Expressions\0.47.7\$.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Reactive.JavaScript\0.47.7\$.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Reactive.Bindings\0.47.7\$.uno
// -----------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\0.47.7\\$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[5/*"JavaScript ...*/], ex, this, ::STRINGS[6/*"C:\\Users\\...*/], 200, ::STRINGS[7/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Reactive.JavaScript\0.47.7\fusejs\$.uno
// --------------------------------------------------------------------------------------------
...
{
    ::STRINGS[13] = uString::Const("../../../Packages/Fuse.Reactive.JavaScript/0.47.7/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[13/*"../../../Pa...*/], 135);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[14/*"null"*/], 1, ::STRINGS[13/*"../../../Pa...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[33] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.Bindings\\0.47.7\\$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[33/*"C:\\Users\\...*/], 409, ::STRINGS[35/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Reactive.Bindings\0.47.7\subscription\$.uno
// ------------------------------------------------------------------------------------------------
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[14/*"null"*/], 1, ::STRINGS[13/*"../../../Pa...*/], 99);
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Reactive\0.47.7\$.uno
// --------------------------------------------------------------------------
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[47/*"Template co...*/], this, ::STRINGS[33/*"C:\\Users\\...*/], 1455, ::STRINGS[48/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Limit canno...*/], this, ::STRINGS[33/*"C:\\Users\\...*/], 1033, ::STRINGS[50/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Offset cann...*/], this, ::STRINGS[33/*"C:\\Users\\...*/], 985, ::STRINGS[52/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[54/*"JavaScript ...*/], FileName()), ::STRINGS[55/*" fixed!"*/]), this, ::STRINGS[6/*"C:\\Users\\...*/], 415, ::STRINGS[56/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[57/*"JavaScript ...*/], se, this, ::STRINGS[6/*"C:\\Users\\...*/], 426, ::STRINGS[56/*"EvaluateMod...*/]);
...
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[110/*"'Select' is...*/], this, ::STRINGS[33/*"C:\\Users\\...*/], 2283, ::STRINGS[111/*".ctor"*/]);
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[113/*"Unexpected ...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 607, ::STRINGS[114/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        ...
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[116/*"Failed to s...*/], ex, this, ::STRINGS[6/*"C:\\Users\\...*/], 619, ::STRINGS[114/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[120/*"Skipped Exc...*/], next, this, ::STRINGS[6/*"C:\\Users\\...*/], 1820, ::STRINGS[121/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[122/*"JavaScript ...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1390, ::STRINGS[123/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[134/*"ThreadWorke...*/], e, this, ::STRINGS[6/*"C:\\Users\\...*/], 1716, ::STRINGS[135/*"Run"*/]);
