// This file was generated based on D:/TG18/TG18_code/App/TG18/build/Android/Preview/cache/ux11/TBuilt.g.uno.
...
// public partial sealed class TBuilt :2
// {
// static TBuilt() :4
static void TBuilt__cctor_4_fn(uType* __type)
{
}

static void TBuilt_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)TBuilt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* TBuilt_typeof()
{
    ...
    options.ObjectSize = sizeof(TBuilt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("TBuilt", options);
    type->fp_build_ = TBuilt_build;
    type->fp_ctor_ = (void*)TBuilt__New4_fn;
    type->fp_cctor_ = TBuilt__cctor_4_fn;
...
// public TBuilt() :8
void TBuilt__ctor_8_fn(TBuilt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void TBuilt__InitializeUX1_fn(TBuilt* __this)
{
    __this->InitializeUX1();
}

// public TBuilt New() :8
void TBuilt__New4_fn(TBuilt** __retval)
{
    *__retval = TBuilt::New4();
}

// public TBuilt() [instance] :8
void TBuilt::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void TBuilt::InitializeUX1()
{
    uStackFrame __("TBuilt", "InitializeUX()");
    Font(::g::MainView::Built());
}

// public TBuilt New() [static] :8
TBuilt* TBuilt::New4()
{
    TBuilt* obj1 = (TBuilt*)uNew(TBuilt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
