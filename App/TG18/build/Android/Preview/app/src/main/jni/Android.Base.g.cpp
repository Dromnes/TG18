...
#include <Android.Base.AndroidB-55118587.h>
...
#include <Android.Base.Primitiv-ca6a2aad.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\UnoCore\0.47.13\targets\android\uno\base\$.uno
// ----------------------------------------------------------------------------------------------
...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("../../../Packages/UnoCore/0.47.13/targets/android/uno/base/$.uno");
...
int64_t JNI::GetUnoRef(jobject obj)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"../../../Pa...*/], 318, uArray::New(::TYPES[1/*object[]*/], 0));
...
jclass JNI::LoadClass1(JNIEnv* jni, const char* name, bool systemClass)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"../../../Pa...*/], 131, uArray::New(::TYPES[1/*object[]*/], 0));
    jclass result;
