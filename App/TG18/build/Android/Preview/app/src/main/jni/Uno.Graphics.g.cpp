...
#include <Uno.Graphics.TextureA-cdadf24a.h>
...
#include <Uno.Runtime.Implement-56fe5cfa.h>
#include <Uno.Runtime.Implement-8c65ef1f.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\UnoCore\0.47.13\source\uno\graphics\$.uno
// -----------------------------------------------------------------------------------------
...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("../../../Packages/UnoCore/0.47.13/source/uno/graphics/$.uno");
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[4/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[5/*"**** Invali...*/], versionString), 1, ::STRINGS[6/*"../../../Pa...*/], 975);
            }
            else throw __t;
        }
    }
