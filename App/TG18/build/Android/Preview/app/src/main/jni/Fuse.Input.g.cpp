...
#include <Fuse.Input.CustomPoin-be858f6a.h>
...
#include <Fuse.Input.FocusPredi-248b93af.h>
#include <Fuse.Input.FocusPredi-7e5e39dc.h>
...
#include <Fuse.Input.IPointerEv-2da5d72b.h>
#include <Fuse.Input.IsFocusabl-51addd69.h>
#include <Fuse.Input.IsFocusabl-8757fa55.h>
#include <Fuse.Input.IsFocusabl-e60027f4.h>
...
#include <Fuse.Input.Pointer.Ca-4c573cf.h>
#include <Fuse.Input.Pointer.De-9ef19394.h>
#include <Fuse.Input.Pointer.h>
#include <Fuse.Input.Pointer.PELHolder.h>
#include <Fuse.Input.Pointer.PELStatus.h>
#include <Fuse.Input.Pointer.Po-745da8f6.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Nodes\0.47.7\input\$.uno
// -----------------------------------------------------------------------------
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\0.47.7\\input\\$.uno");
...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Missing Los...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 631, ::STRINGS[7/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
...
bool Pointer::ExtendCapture(uObject* identity, int pointIndex)
{
    ...
    if (c == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"Attempting ...*/], identity, ::STRINGS[6/*"C:\\Users\\...*/], 1383, ::STRINGS[12/*"ExtendCapture"*/]);
        return false;
    }
...
bool Pointer::ModifyCapture(uObject* identity, int type)
{
    ...
    if (c == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"Attempting ...*/], identity, ::STRINGS[6/*"C:\\Users\\...*/], 1361, ::STRINGS[14/*"ModifyCapture"*/]);
        return false;
    }
...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Capture can...*/], NULL, ::STRINGS[6/*"C:\\Users\\...*/], 1323, ::STRINGS[14/*"ModifyCapture"*/]);
        return false;
    }
...
void PointerEventArgs::DeprecatedReleaseCapture(uObject* behavior)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[19/*"The capture...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1812, ::STRINGS[20/*"DeprecatedR...*/]);
