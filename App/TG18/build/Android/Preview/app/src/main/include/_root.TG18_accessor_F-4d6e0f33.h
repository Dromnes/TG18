...
namespace g{struct TG18_accessor_Fuse_Controls_Page_Title;}
...
struct TG18_accessor_Fuse_Controls_Page_Title : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return TG18_accessor_Fuse_Controls_Page_Title_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return TG18_accessor_Fuse_Controls_Page_Title_typeof()->Init(), Singleton_; }

    void ctor_1();
    static TG18_accessor_Fuse_Controls_Page_Title* New1();
};
// }
