...
#include <Fuse.Reactive.FuseJS.-3a1f9142.h>
#include <Fuse.Reactive.FuseJS.-493d0fb5.h>
#include <Fuse.Reactive.FuseJS.-5895e150.h>
#include <Fuse.Reactive.FuseJS.-7854331c.h>
#include <Fuse.Reactive.FuseJS.Builtins.h>
#include <Fuse.Reactive.FuseJS.-c1882362.h>
#include <Fuse.Reactive.FuseJS.-c2e1ed6c.h>
#include <Fuse.Reactive.FuseJS.-c8e04678.h>
#include <Fuse.Reactive.FuseJS.-cc916ec6.h>
#include <Fuse.Reactive.FuseJS.-d41fe095.h>
...
#include <Uno.Long.h>
#include <Uno.Math.h>
#include <Uno.Net.Http.HttpMess-2734f246.h>
#include <Uno.Net.Http.HttpMess-91b98dc2.h>
#include <Uno.Net.Http.HttpRequestState.h>
#include <Uno.Net.Http.HttpResponseType.h>
#include <Uno.Net.Http.HttpStat-91d6200b.h>
#include <Uno.Net.Http.InvalidR-9c865bd5.h>
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseReactiveJavaScript_bundle::setTimeoutb974978c())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseReactiveJavaScript_bundle::es6promisemin3716a881())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactiveJavaScript_bundle::Diagnostics9ff1c38b()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactiveJavaScript_bundle::Observableff67834e()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\0.47.7\\fusejs\\$.uno");
