...
#include <Fuse.Controls.VideoIm-2107a26f.h>
#include <Fuse.Controls.VideoIm-278c0045.h>
#include <Fuse.Controls.VideoIm-284bd560.h>
#include <Fuse.Controls.VideoIm-2db1f1e.h>
#include <Fuse.Controls.VideoIm-6387b742.h>
#include <Fuse.Controls.VideoIm-7291347a.h>
#include <Fuse.Controls.VideoIm-78f63b56.h>
#include <Fuse.Controls.VideoIm-bb298f12.h>
#include <Fuse.Controls.VideoIm-be834fb0.h>
#include <Fuse.Controls.VideoIm-c4c99a37.h>
#include <Fuse.Controls.VideoIm-cc5828bc.h>
#include <Fuse.Controls.VideoIm-f711c366.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\0.47.7\$.uno
// --------------------------------------------------------------------------------
...
void Scale9Rectangle::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* element, ::g::Uno::Float2 size, ::g::Uno::Float2 scaleTextureSize, ::g::Uno::Graphics::VideoTexture* tex, ::g::Uno::Float4 margin)
{
    ...
    _draw_6354424c.Sampler7(15, tex, ::g::Uno::Graphics::SamplerState__LinearClamp());
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("../../../Packages/Fuse.Controls.Video/0.47.7/$.uno");
...
void VideoDiskCache::OnTerminating(int newState)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(VideoDiskCache::_files()), &ret4), ret4); enum1.MoveNext(::TYPES[15/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ...
        {
            ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[16/*Uno.Collections.KeyValuePair<string, string>*/])), 1, ::STRINGS[3/*"../../../Pa...*/], 910);
...
void VideoDrawElement::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* element, ::g::Uno::Float2 offset, ::g::Uno::Float2 size, ::g::Uno::Float2 uvPosition, ::g::Uno::Float2 uvSize, ::g::Uno::Graphics::VideoTexture* tex, int rotation)
{
    ...
    _draw_f0526a66.Sampler7(6, tex, ::g::Uno::Graphics::SamplerState__LinearClamp());
...
static void VideoVisual_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\0.47.7\\$.uno");
