...
#include <Experimental.Cache.IC-add03308.h>
#include <Experimental.Cache.IC-daf5e82b.h>
#include <Experimental.Http.BinaryLoader.h>
#include <Experimental.Http.Htt-f498a617.h>
#include <Experimental.Http.HttpLoader.h>
#include <Experimental.Http.Int-87489639.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Experimental.Http\0.47.7\$.uno
// ------------------------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("../../../Packages/Experimental.Http/0.47.7/$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 1, ::STRINGS[9/*"../../../Pa...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 1, ::STRINGS[9/*"../../../Pa...*/], 854);
