...
namespace g{struct TG18_ControlPage_HeaderTextColor_Property;}
...
struct TG18_ControlPage_HeaderTextColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::ControlPage*> _obj;

    void ctor_3(::g::ControlPage* obj, ::g::Uno::UX::Selector name);
    static TG18_ControlPage_HeaderTextColor_Property* New1(::g::ControlPage* obj, ::g::Uno::UX::Selector name);
};
// }
