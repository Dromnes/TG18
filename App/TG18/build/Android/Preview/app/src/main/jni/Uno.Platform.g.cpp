...
#include <Uno.Platform.EventSou-295e6cc0.h>
#include <Uno.Platform.FrameCha-7feb1e04.h>
...
#include <Uno.Runtime.Implement-2c3e8c94.h>
#include <Uno.Runtime.Implement-f509f747.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\UnoCore\0.47.13\source\uno\platform\android\$.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\UnoCore\0.47.13\source\uno\platform\$.uno
// -----------------------------------------------------------------------------------------
...
static void CoreApp_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../Packages/UnoCore/0.47.13/source/uno/platform/$.uno");
...
void CoreApp::EnterBackground()
{
    ...
    switch (CoreApp::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"EnterBackgr...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 198);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"EnterBackgr...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 202);
            return;
        }
        case 1:
            return;
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert9 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 216, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert9), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 2)));
    CoreApp::State(1);
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert10 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 224, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert10), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 1)));
}
...
void CoreApp::EnterForeground()
{
    ...
    switch (CoreApp::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"EnterForegr...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 94);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"EnterForegr...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 98);
            return;
        }
        case 1:
            break;
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 110, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert3), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 1)));
    CoreApp::State(2);
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert4 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 118, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert4), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 2)));
}
...
void CoreApp::EnterInteractive()
{
    ...
    switch (CoreApp::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"EnterIntera...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 130);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"EnterIntera...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 134);
            return;
        }
        case 1:
        {
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert5 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 148, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert5), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 2)));
    CoreApp::State(3);
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert6 == 3, ::STRINGS[9/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 156, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert6), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 3)));
}
...
void CoreApp::ExitInteractive()
{
    ...
    switch (CoreApp::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[10/*"ExitInterac...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 167);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[11/*"ExitInterac...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 171);
            return;
        }
        case 1:
        case 2:
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert7 == 3, ::STRINGS[9/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 182, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert7), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 3)));
    CoreApp::State(2);
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert8 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 190, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert8), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 2)));
}
...
void CoreApp::Start()
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == 0, ::STRINGS[12/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 76, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert1), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 0)));
    uStartApp();
    CoreApp::State(1);
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert2 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 86, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert2), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 1)));
}
...
void CoreApp::Terminate()
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert11 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 244, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert11), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), 1)));
    CoreApp::State(-1);
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert12 == -1, ::STRINGS[13/*"Uno.Platfor...*/], ::STRINGS[1/*"../../../Pa...*/], 252, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), assert12), uBox<int>(::g::Uno::Platform::ApplicationState_typeof(), -1)));
    CoreApp::State(0);
}
