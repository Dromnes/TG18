...
#include <Fuse.Scripting.V8.Aut-5025f72a.h>
#include <Fuse.Scripting.V8.Con-e9a9e908.h>
#include <Fuse.Scripting.V8.Context.h>
#include <Fuse.Scripting.V8.Deb-4065056d.h>
#include <Fuse.Scripting.V8.Deb-58993fee.h>
#include <Fuse.Scripting.V8.Deb-6aa6585a.h>
#include <Fuse.Scripting.V8.Deb-8cb6e92e.h>
...
#include <Fuse.Scripting.V8.Mar-eb2a7783.h>
#include <Fuse.Scripting.V8.Marshaller.h>
#include <Fuse.Scripting.V8.Object.h>
#include <Fuse.Scripting.V8.Sim-2031bba9.h>
#include <Fuse.Scripting.V8.Sim-282e399.h>
#include <Fuse.Scripting.V8.Sim-42b33fd6.h>
#include <Fuse.Scripting.V8.Sim-5139ae16.h>
#include <Fuse.Scripting.V8.Sim-513ccff2.h>
#include <Fuse.Scripting.V8.Sim-651ec3cf.h>
#include <Fuse.Scripting.V8.Sim-79f0d8a1.h>
#include <Fuse.Scripting.V8.Sim-8d2440d9.h>
#include <Fuse.Scripting.V8.Sim-962a9b9b.h>
#include <Fuse.Scripting.V8.Sim-9e60cc3d.h>
#include <Fuse.Scripting.V8.Sim-cff51134.h>
#include <Fuse.Scripting.V8.Sim-e2ad9683.h>
#include <Fuse.Scripting.V8.Sim-f08b2d41.h>
#include <Fuse.Scripting.V8.Simple.Debug.h>
#include <Fuse.Scripting.V8.Simple.Value.h>
#include <Fuse.Scripting.V8.V8S-31f3ec34.h>
#include <Fuse.Scripting.V8.V8S-3521bd2.h>
...
#include <Uno.Runtime.InteropSe-5053ab55.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Scripting.V8\0.47.7\$.uno
// ------------------------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../Packages/Fuse.Scripting.V8/0.47.7/$.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 1, ::STRINGS[1/*"../../../Pa...*/], 635);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[14/*"DEBUG_V8: W...*/], uBox<int>(::TYPES[19/*int*/], parent->_port)), ::STRINGS[15/*"..."*/]), 1, ::STRINGS[1/*"../../../Pa...*/], 476);
