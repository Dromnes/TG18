...
#include <Fuse.Elements.BoxSizi-852ccdae.h>
...
#include <Fuse.Elements.Element-293c2016.h>
#include <Fuse.Elements.Element-312bbda3.h>
#include <Fuse.Elements.Element-34d52777.h>
#include <Fuse.Elements.Element-36f7b512.h>
#include <Fuse.Elements.Element-6f76e752.h>
#include <Fuse.Elements.Element-79e29ab.h>
#include <Fuse.Elements.Element-9472ffe4.h>
#include <Fuse.Elements.Element-a1c6a3b2.h>
#include <Fuse.Elements.Element-aa07fc1c.h>
#include <Fuse.Elements.ElementAtlas.h>
#include <Fuse.Elements.Element-b6fdf9f4.h>
#include <Fuse.Elements.ElementBatch.h>
#include <Fuse.Elements.ElementBatcher.h>
#include <Fuse.Elements.Element-c235cef8.h>
#include <Fuse.Elements.Element-d750183.h>
#include <Fuse.Elements.Explici-aa468cb6.h>
#include <Fuse.Elements.FillAsp-5558472f.h>
#include <Fuse.Elements.HeightFunction.h>
#include <Fuse.Elements.HitTestMode.h>
#include <Fuse.Elements.IElemen-96365734.h>
#include <Fuse.Elements.Interac-8bb1897f.h>
#include <Fuse.Elements.ITransformOrigin.h>
#include <Fuse.Elements.ITreeRenderer.h>
#include <Fuse.Elements.LayoutF-5aff1535.h>
#include <Fuse.Elements.LayoutFunction.h>
#include <Fuse.Elements.LayoutM-97d0d66d.h>
#include <Fuse.Elements.LayoutM-9dc16eb3.h>
#include <Fuse.Elements.LayoutMasterAttr.h>
#include <Fuse.Elements.LayoutMasterMode.h>
#include <Fuse.Elements.LimitBoxSizing.h>
#include <Fuse.Elements.NoImpli-28df30cc.h>
#include <Fuse.Elements.Optiona-bfaf403b.h>
#include <Fuse.Elements.Perspec-2f0f2958.h>
#include <Fuse.Elements.Preplac-247bd81c.h>
#include <Fuse.Elements.PreplacementArgs.h>
#include <Fuse.Elements.SimpleAlignment.h>
#include <Fuse.Elements.SingleV-cbfa2cd7.h>
#include <Fuse.Elements.Standar-e4f2b29a.h>
#include <Fuse.Elements.StretchDirection.h>
#include <Fuse.Elements.StretchMode.h>
#include <Fuse.Elements.StretchSizing.h>
#include <Fuse.Elements.Transfo-36b8a655.h>
#include <Fuse.Elements.Transfo-3e6c9633.h>
#include <Fuse.Elements.Transfo-94150c5f.h>
#include <Fuse.Elements.Transfo-b801686b.h>
#include <Fuse.Elements.TransformOrigins.h>
#include <Fuse.Elements.Transla-2a970980.h>
#include <Fuse.Elements.Transla-68d746a1.h>
#include <Fuse.Elements.Transla-8fb43b23.h>
#include <Fuse.Elements.Transla-97de34cd.h>
#include <Fuse.Elements.Transla-b1893703.h>
#include <Fuse.Elements.Transla-c429c6ad.h>
...
#include <Uno.Collections.Linke-cccb5d56.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Elements\0.47.7\$.uno
// --------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Elements\0.47.7\caching\$.uno
// ----------------------------------------------------------------------------------
...
static void CacheHelper_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[4/*float2[]*/], offsetof(::g::Fuse::Elements::CacheHelper, Blit_Vertices_ac95a784_1_0_7), 0);
}
...
void CacheHelper::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Cache* cache, float opacity)
{
    ...
    for (array1 = uPtr(cache)->CacheTiles(), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        _draw_ac95a784.Uniform12(3, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[3/*Fuse.IRenderViewport*/])));
        _draw_ac95a784.Uniform(4, opacity);
        _draw_ac95a784.Sampler3(5, tile.Texture(), ::g::Uno::Graphics::SamplerState__LinearClamp());
...
void CacheHelper::init_DrawCalls()
{
    ...
    uArray* Vertices_ac95a784_1_0_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[4/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("../../../Packages/Fuse.Elements/0.47.7/$.uno");
    ...
    ::STRINGS[9] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\0.47.7\\$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Draw called...*/], __this, ::STRINGS[9/*"C:\\Users\\...*/], 876, ::STRINGS[13/*"Draw"*/]);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[6/*", max-size: "*/]), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[7/*"../../../Pa...*/], 852);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[9/*"C:\\Users\\...*/], 1038, ::STRINGS[10/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"This elemen...*/], this, ::STRINGS[9/*"C:\\Users\\...*/], 1046, ::STRINGS[10/*"Composit"*/]);
    }
}
...
void ElementBatch::Draw(::g::Fuse::DrawContext* dc, ::g::Uno::Float4x4 localToClipTransform, ::g::Uno::Rect scissorRectInClipSpace)
{
    ...
    _draw_9aaabe09.Sampler3(3, tex, ::g::Uno::Graphics::SamplerState__LinearClamp());
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("../../../Packages/Fuse.Elements/0.47.7/caching/$.uno");
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret25), ret25); enum4.MoveNext(::TYPES[51/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[24/*"BUG: atlas-...*/], 1, ::STRINGS[25/*"../../../Pa...*/], 1061);
...
void Viewport__DrawWithChildren_fn(Viewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->Mode() == 2)
    {
        ...
        __this->_draw_66944077.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[3/*Fuse.IRenderViewport*/])));
        ...
        __this->_draw_66944077.Sampler3(3, uPtr(fb)->ColorBuffer(), ::g::Uno::Graphics::SamplerState__LinearClamp());
