...
#include <Fuse.Controls.FuseTex-1a17aa63.h>
#include <Fuse.Controls.FuseTex-4b903040.h>
#include <Fuse.Controls.FuseTex-52d0aecf.h>
#include <Fuse.Controls.FuseTex-55401bfe.h>
#include <Fuse.Controls.FuseTex-78bdbf6a.h>
#include <Fuse.Controls.FuseTex-c7156c79.h>
#include <Fuse.Controls.FuseTex-d514f2df.h>
#include <Fuse.Controls.FuseTex-e0933af9.h>
#include <Fuse.Controls.FuseTex-effa9cec.h>
#include <Fuse.Controls.FuseTex-f2d8624d.h>
#include <Fuse.Controls.FuseTex-fdf18f45.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\0.47.7\textcontrols\fusetextrenderer\$.uno
// -------------------------------------------------------------------------------------------------------------------
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("../../../Packages/Fuse.Controls.Primitives/0.47.7/textcontrols/fusetextrenderer/$.uno");
...
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[3/*"this._cache...*/], ::STRINGS[4/*"../../../Pa...*/], 606, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
