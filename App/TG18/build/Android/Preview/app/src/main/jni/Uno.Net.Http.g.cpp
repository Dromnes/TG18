...
#include <Android.Base.Wrappers-54d398dd.h>
#include <Android.com.fuse.Expe-5896eac2.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Uno.Net.Http\0.47.13\uriparsers\$.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Uno.Net.Http\0.47.13\$.uno
// --------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("../../../Packages/Uno.Net.Http/0.47.13/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"../../../Pa...*/], 17);
    else
