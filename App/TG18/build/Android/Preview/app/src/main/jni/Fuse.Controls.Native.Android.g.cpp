...
#include <_root.FuseControlsNat-bee5a1ee.h>
#include <Android.Base.Primitiv-95b7b52.h>
#include <Android.Base.Wrappers.JWrapper.h>
#include <Android.Base.Wrappers-f1c8189.h>
#include <Fuse.AppBase.h>
#include <Fuse.Controls.AutoCap-abbe846.h>
#include <Fuse.Controls.AutoCorrectHint.h>
#include <Fuse.Controls.Native.-10dbc4d1.h>
#include <Fuse.Controls.Native.-13840398.h>
#include <Fuse.Controls.Native.-19daa2c9.h>
#include <Fuse.Controls.Native.-1b6e2e31.h>
#include <Fuse.Controls.Native.-26dc0a28.h>
#include <Fuse.Controls.Native.-30689ad4.h>
#include <Fuse.Controls.Native.-375d3f95.h>
#include <Fuse.Controls.Native.-395aa7e5.h>
#include <Fuse.Controls.Native.-3ccb803a.h>
#include <Fuse.Controls.Native.-4b960356.h>
#include <Fuse.Controls.Native.-55ad419c.h>
#include <Fuse.Controls.Native.-5a2a71a1.h>
#include <Fuse.Controls.Native.-6192a210.h>
#include <Fuse.Controls.Native.-65c81a89.h>
#include <Fuse.Controls.Native.-660d7551.h>
#include <Fuse.Controls.Native.-6823caff.h>
#include <Fuse.Controls.Native.-80e392be.h>
#include <Fuse.Controls.Native.-8162c4d8.h>
#include <Fuse.Controls.Native.-93003f54.h>
#include <Fuse.Controls.Native.-9707eda8.h>
#include <Fuse.Controls.Native.-98e8148f.h>
#include <Fuse.Controls.Native.-9bf352de.h>
#include <Fuse.Controls.Native.-a587d3c0.h>
#include <Fuse.Controls.Native.-b096ad14.h>
#include <Fuse.Controls.Native.-c41d003c.h>
#include <Fuse.Controls.Native.-c7645e49.h>
#include <Fuse.Controls.Native.-c7f65b6c.h>
#include <Fuse.Controls.Native.-cfc43b5b.h>
#include <Fuse.Controls.Native.-e709cf1b.h>
#include <Fuse.Controls.Native.-e75cc055.h>
#include <Fuse.Controls.Native.-e7e10bd6.h>
#include <Fuse.Controls.Native.-ea24053b.h>
#include <Fuse.Controls.Native.-ec20dc1e.h>
#include <Fuse.Controls.Native.-eef2833d.h>
#include <Fuse.Controls.Native.-f1022ed0.h>
#include <Fuse.Controls.ScrollDirections.h>
#include <Fuse.Controls.TextAlignment.h>
#include <Fuse.Controls.TextInp-99f63cb6.h>
#include <Fuse.Controls.TextInp-f73683b4.h>
...
#include <Fuse.Resources.MultiD-b22363c3.h>
#include <Fuse.Resources.System-9344cef3.h>
#include <Fuse.Time.h>
...
// C:\Users\marti\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\0.47.7\android\$.uno
// -----------------------------------------------------------------------------------------

// internal sealed extern class Blitter :1103
// {
// static Blitter() :1103
...
// public generated Blitter() :1103
void Blitter__ctor__fn(Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) :1107
...
// private generated void init_DrawCalls() :1103
void Blitter__init_DrawCalls_fn(Blitter* __this)
{
    __this->init_DrawCalls();
}

// public generated Blitter New() :1103
...
// public generated Blitter() [instance] :1103
void Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) [instance] :1107
void Blitter::Blit(::g::Uno::Graphics::Texture2D* vt, ::g::Uno::Float2 pos, ::g::Uno::Float2 size, ::g::Uno::Float4x4 localToClipTransform)
{
    ...
    _draw_22e0d2d9.Sampler3(4, vt, ::g::Uno::Graphics::SamplerState__LinearClamp());
    _draw_22e0d2d9.DrawArrays(uPtr(Blit_verts_22e0d2d9_3_3_5)->Length());
}

// private generated void init_DrawCalls() [instance] :1103
...
// public generated Blitter New() [static] :1103
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "UpdateShapeDrawable1111", "(Lcom/uno/UnoObject;Ljava/lang/Object;ZFFFF)V");
        uObject* _uthis=this;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "UpdateShapeDrawable1112", "(Lcom/uno/UnoObject;Ljava/lang/Object;)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// internal sealed extern class FocusChangedListener :2232
// {
...
// private FocusChangedListener(Java.Object view, Uno.Action<Java.Object, bool> callback) :2239
...
// public static Uno.IDisposable AddHandler(Java.Object view, Uno.Action<Java.Object, bool> callback) :2254
...
// private void OnFocusChange(bool hasFocus) :2249
void FocusChangedListener__OnFocusChange_fn(FocusChangedListener* __this, bool* hasFocus)
{
    __this->OnFocusChange(*hasFocus);
}

// private static void SetListener(Java.Object viewHandle, Java.Object listenerHandle) :2278
...
// private FocusChangedListener(Java.Object view, Uno.Action<Java.Object, bool> callback) [instance] :2239
...
// private Java.Object Create() [instance] :2267
::g::Java::Object* FocusChangedListener::Create()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create114", "(Lcom/uno/UnoObject;)Ljava/lang/Object;");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
...
// public void Dispose() [instance] :2261
void FocusChangedListener::Dispose()
{
    FocusChangedListener::ClearListener(_view);
}

// private void OnFocusChange(bool hasFocus) [instance] :2249
...
// public static Uno.IDisposable AddHandler(Java.Object view, Uno.Action<Java.Object, bool> callback) [static] :2254
...
// private static void ClearListener(Java.Object viewHandle) [static] :2284
void FocusChangedListener::ClearListener(::g::Java::Object* viewHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ClearListener113", "(Ljava/lang/Object;)V");
...
// private FocusChangedListener New(Java.Object view, Uno.Action<Java.Object, bool> callback) [static] :2239
...
// private static void SetListener(Java.Object viewHandle, Java.Object listenerHandle) [static] :2278
void FocusChangedListener::SetListener(::g::Java::Object* viewHandle, ::g::Java::Object* listenerHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetListener116", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// internal sealed extern class FocusManager :2160
// {
// static FocusManager() :2160
...
// public generated FocusManager() :2160
void FocusManager__ctor__fn(FocusManager* __this)
{
    __this->ctor_();
}

// public void CompleteFocusLoss() :2168
void FocusManager__CompleteFocusLoss_fn(FocusManager* __this)
{
    __this->CompleteFocusLoss();
}

// public static Java.Object GetContext(Java.Object viewHandle) :2197
...
// public static Java.Object GetWindowToken(Java.Object viewHandle) :2203
...
// public generated FocusManager() [instance] :2160
void FocusManager::ctor_()
{
}

// public void CompleteFocusLoss() [instance] :2168
...
// public static Java.Object GetContext(Java.Object viewHandle) [static] :2197
::g::Java::Object* FocusManager::GetContext(::g::Java::Object* viewHandle)
{
    FocusManager_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetContext117", "(Ljava/lang/Object;)Ljava/lang/Object;");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public static Java.Object GetWindowToken(Java.Object viewHandle) [static] :2203
::g::Java::Object* FocusManager::GetWindowToken(::g::Java::Object* viewHandle)
{
    FocusManager_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetWindowToken118", "(Ljava/lang/Object;)Ljava/lang/Object;");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd,_viewHandle);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
...
// private static bool HasFocus(Java.Object viewHandle) [static] :2185
bool FocusManager::HasFocus(::g::Java::Object* viewHandle)
{
    FocusManager_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "HasFocus119", "(Ljava/lang/Object;)Z");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public generated FocusManager New() [static] :2160
...
// private static void RequestRootViewFocus(Java.Object viewHandle) [static] :2191
void FocusManager::RequestRootViewFocus(::g::Java::Object* viewHandle)
{
    FocusManager_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "RequestRootViewFocus120", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_viewHandle);
...
static void GraphicsView_build(uType* type)
{
    ...
    type->SetFields(4,
        ...
        ::g::Java::Object_typeof(), offsetof(::g::Fuse::Controls::Native::Android::GraphicsView, _graphicsViewHandle), 0,
...
// protected void DestroySurface() [instance] :190
...
// public void EndDraw() [instance] :225
...
// protected Java.Object get_GraphicsViewHandle() [instance] :160
::g::Java::Object* GraphicsView::GraphicsViewHandle()
{
    return _graphicsViewHandle;
}

// protected void SetSurface(Java.Object surfaceHandle) [instance] :175
...
// internal sealed extern class HttpImageLoader :263
// {
static void HttpImageLoader_build(uType* type)
{
    ::TYPES[2] = ::g::Uno::Action1_typeof()->MakeType(::g::Java::Object_typeof(), NULL);
...
// public HttpImageLoader(string url) :266
void HttpImageLoader__ctor_7_fn(HttpImageLoader* __this, uString* url)
{
    __this->ctor_7(url);
}

// public override sealed void Dispose() :308
...
// private void Error(string errorMsg) :277
void HttpImageLoader__Error_fn(HttpImageLoader* __this, uString* errorMsg)
{
    __this->Error(errorMsg);
}

// private static void LoadAsync(string urlString, Uno.Action<Java.Object> success, Uno.Action<string> error) :284
...
void HttpImageLoader::ctor_7(uString* url)
{
    ...
    HttpImageLoader::LoadAsync(url, uDelegate::New(::TYPES[2/*Uno.Action<Java.Object>*/], (void*)HttpImageLoader__Success_fn, this), uDelegate::New(::TYPES[3/*Uno.Action<string>*/], (void*)HttpImageLoader__Error_fn, this));
}

// private void Error(string errorMsg) [instance] :277
...
// private void Success(Java.Object bitmap) [instance] :271
...
// private static void LoadAsync(string urlString, Uno.Action<Java.Object> success, Uno.Action<string> error) [static] :284
void HttpImageLoader::LoadAsync(uString* urlString, uDelegate* success, uDelegate* error)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadAsync121", "(Ljava/lang/String;Lcom/foreign/Uno/Action_Object;Lcom/foreign/Uno/Action_String;)V");
...
// public HttpImageLoader New(string url) [static] :266
...
// internal sealed extern class ImageView :316
// {
static void ImageView_build(uType* type)
{
    ::STRINGS[0] = uString::Const("MultiDensityImageSource in a native context not supported");
    ::STRINGS[1] = uString::Const("C:\\Users\\marti\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Native\\0.47.7\\android\\$.uno");
    ...
    ::TYPES[8] = ::g::Java::Object_typeof();
    ::TYPES[9] = ::g::Fuse::Resources::FileImageSource_typeof();
    ::TYPES[10] = ::g::Fuse::Resources::HttpImageSource_typeof();
    ::TYPES[11] = ::g::Fuse::Resources::MultiDensityImageSource_typeof();
    type->SetInterfaces(
        ::TYPES[7/*Uno.IDisposable*/], offsetof(ImageView_type, interface0),
    ...
    type->SetFields(4,
        ::TYPES[7/*Uno.IDisposable*/], offsetof(::g::Fuse::Controls::Native::Android::ImageView, _imageHandle), 0,
        ::TYPES[8/*Java.Object*/], offsetof(::g::Fuse::Controls::Native::Android::ImageView, _imageView), 0,
...
// private void UpdateImage(Fuse.Resources.HttpImageSource http) :399
void ImageView__UpdateImage1_fn(ImageView* __this, ::g::Fuse::Resources::HttpImageSource* http)
{
    __this->UpdateImage1(http);
}

// private void UpdateImage(Fuse.Resources.MultiDensityImageSource multi) :414
void ImageView__UpdateImage2_fn(ImageView* __this, ::g::Fuse::Resources::MultiDensityImageSource* multi)
{
    __this->UpdateImage2(multi);
}

// public void UpdateImageTransform(float density, float2 origin, float2 scale, float2 drawSize) :361
...
// public ImageView() [instance] :350
void ImageView::ctor_4()
{
    _tintColor = ::g::Uno::Float4__New1(1.0f);
    ctor_2(ImageView::CreateContainer());
    _imageView = ImageView::Create(Handle());
}

// private void set_ImageHandle(Fuse.Controls.Native.ImageHandle value) [instance] :375
void ImageView::ImageHandle(::g::Fuse::Controls::Native::ImageHandle* value)
{
    ...
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_imageHandle), ::TYPES[7/*Uno.IDisposable*/]));
        _imageHandle = NULL;
    ...
    if (_imageHandle != NULL)
    {
        ImageView::SetBitmap(_imageView, uCast< ::g::Java::Object*>(uPtr(value)->Handle(), ::TYPES[8/*Java.Object*/]));
        ImageView::SetTint(_imageView, (int)::g::Uno::Color::ToArgb(_tintColor));
    }
}

// public void set_ImageSource(Fuse.Resources.ImageSource value) [instance] :321
void ImageView::ImageSource(::g::Fuse::Resources::ImageSource* value)
{
    ...
    if (value == NULL)
        ImageHandle(NULL);
    else if (uIs(value, ::TYPES[9/*Fuse.Resources.FileImageSource*/]))
    ...
    else if (uIs(value, ::TYPES[11/*Fuse.Resources.MultiDensityImageSource*/]))
        UpdateImage2(uCast< ::g::Fuse::Resources::MultiDensityImageSource*>(value, ::TYPES[11/*Fuse.Resources.MultiDensityImageSource*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition(value, ::STRINGS[3/*" not suppor...*/])));
}

// private void OnImageLoaded(Fuse.Controls.Native.ImageHandle handle) [instance] :404
...
// private void OnImageLoadFailed(Uno.Exception e) [instance] :409
...
// private void SetImageSize(float2 size) [instance] :437
...
// public void set_TintColor(float4 value) [instance] :341
...
// private void UpdateImage(Fuse.Resources.FileImageSource fileImageSource) [instance] :394
...
// private void UpdateImage(Fuse.Resources.HttpImageSource http) [instance] :399
...
// private void UpdateImage(Fuse.Resources.MultiDensityImageSource multi) [instance] :414
void ImageView::UpdateImage2(::g::Fuse::Resources::MultiDensityImageSource* multi)
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*"MultiDensit...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 416, ::STRINGS[2/*"UpdateImage"*/]);
}

// public void UpdateImageTransform(float density, float2 origin, float2 scale, float2 drawSize) [instance] :361
...
// private static void ClearBitmap(Java.Object handle) [static] :482
void ImageView::ClearBitmap(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ClearBitmap122", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static Java.Object Create(Java.Object container) [static] :489
::g::Java::Object* ImageView::Create(::g::Java::Object* container)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create123", "(Ljava/lang/Object;)Ljava/lang/Object;");
...
// private static Java.Object CreateContainer() [static] :500
::g::Java::Object* ImageView::CreateContainer()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateContainer124", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// public ImageView New() [static] :350
...
// private static void SetBitmap(Java.Object handle, Java.Object bitmapHandle) [static] :466
void ImageView::SetBitmap(::g::Java::Object* handle, ::g::Java::Object* bitmapHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetBitmap126", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetImageMatrix(Java.Object handle, float x, float y, float scaleX, float scaleY) [static] :451
void ImageView::SetImageMatrix(::g::Java::Object* handle, float x, float y, float scaleX, float scaleY)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetImageMatrix127", "(Ljava/lang/Object;FFFF)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _ux=x;
...
// private static void SetImageSize(Java.Object handle, int[] wh) [static] :444
void ImageView::SetImageSize1(::g::Java::Object* handle, uArray* wh)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetImageSize1128", "(Ljava/lang/Object;Lcom/uno/IntArray;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        uArray* _uwh=wh;
...
// private static void SetTint(Java.Object handle, int rgba) [static] :473
void ImageView::SetTint(::g::Java::Object* handle, int rgba)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTint129", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _urgba=rgba;
...
// internal static extern class InputDispatch :526
// {
// static InputDispatch() :526
...
{
    ::TYPES[12] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Java::Object_typeof(), ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::Int_typeof(), NULL);
    ::TYPES[14] = ::g::Fuse::Visual_typeof();
    ::TYPES[15] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[16] = ::g::Uno::Exception_typeof();
    type->SetFields(0,
        ::TYPES[13/*Uno.Collections.HashSet<int>*/], (uintptr_t)&::g::Fuse::Controls::Native::Android::InputDispatch::_activePointers_, uFieldFlagsStatic,
        ::TYPES[12/*Uno.Collections.Dictionary<Java.Object, Fuse.Visual>*/], (uintptr_t)&::g::Fuse::Controls::Native::Android::InputDispatch::_listeners_, uFieldFlagsStatic,
...
// public static void AddListener(Fuse.Controls.Native.ViewHandle viewHandle, Fuse.Visual owner) :668
...
// public static void RaiseEvent(Fuse.Visual visual, Java.Object viewHandle, Fuse.Controls.Native.Android.MotionEvent motionEvent) :553
...
// private static void RaiseMoved(Fuse.Visual visual, Fuse.Input.PointerEventData data) :620
...
// private static void RaisePressed(Fuse.Visual visual, Fuse.Input.PointerEventData data) :605
...
// private static void RaiseReleased(Fuse.Visual visual, Fuse.Input.PointerEventData data) :632
...
// public static void RemoveListener(Fuse.Controls.Native.ViewHandle viewHandle) :674
...
// private static void SetOnTouchListener(Java.Object viewHandle, Java.Object listenerHandle) :696
...
// private static Java.Object get_TouchListener() :535
void InputDispatch__get_TouchListener_fn(::g::Java::Object** __retval)
{
    *__retval = InputDispatch::TouchListener();
}

// private static Fuse.Controls.Native.Android.JavaMap get_ViewVisualMap() :665
...
// public static void AddListener(Fuse.Controls.Native.ViewHandle viewHandle, Fuse.Visual owner) [static] :668
void InputDispatch::AddListener(::g::Fuse::Controls::Native::ViewHandle* viewHandle, ::g::Fuse::Visual* owner)
{
    ...
    uPtr(InputDispatch::ViewVisualMap())->Put1(uPtr(viewHandle)->NativeHandle, owner);
    InputDispatch::SetOnTouchListener(viewHandle->NativeHandle, InputDispatch::TouchListener());
}

// private static void ClearOnTouchListener(Java.Object viewHandle) [static] :702
void InputDispatch::ClearOnTouchListener(::g::Java::Object* viewHandle)
{
    InputDispatch_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ClearOnTouchListener130", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_viewHandle);
...
// private static Java.Object CreateTouchListener() [static] :686
::g::Java::Object* InputDispatch::CreateTouchListener()
{
    InputDispatch_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateTouchListener131", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// private static void DeactivatePointer(int pointerId) [static] :599
...
// private static Fuse.Visual FindRoot(Fuse.Visual visual) [static] :680
...
// private static bool IsPointerActive(int pointerId) [static] :589
...
// private static bool OnTouch(Java.Object view, Java.Object motionEvent) [static] :538
...
// public static void RaiseEvent(Fuse.Visual visual, Java.Object viewHandle, Fuse.Controls.Native.Android.MotionEvent motionEvent) [static] :553
...
// private static void RaiseMoved(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :620
...
// private static void RaisePressed(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :605
...
// private static void RaiseReleased(Fuse.Visual visual, Fuse.Input.PointerEventData data) [static] :632
...
// public static void RemoveListener(Fuse.Controls.Native.ViewHandle viewHandle) [static] :674
void InputDispatch::RemoveListener(::g::Fuse::Controls::Native::ViewHandle* viewHandle)
{
    ...
    InputDispatch_typeof()->Init();
    uPtr(InputDispatch::ViewVisualMap())->Remove(uPtr(viewHandle)->NativeHandle);
    InputDispatch::ClearOnTouchListener(viewHandle->NativeHandle);
}

// private static void SetOnTouchListener(Java.Object viewHandle, Java.Object listenerHandle) [static] :696
void InputDispatch::SetOnTouchListener(::g::Java::Object* viewHandle, ::g::Java::Object* listenerHandle)
{
    InputDispatch_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetOnTouchListener133", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _ulistenerHandle=listenerHandle;
        jobject _listenerHandle = (_ulistenerHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ulistenerHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static Java.Object get_TouchListener() [static] :535
...
// private static Fuse.Controls.Native.Android.JavaMap get_ViewVisualMap() [static] :665
...
// internal sealed extern class JavaMap :711
// {
...
// public bool ContainsKey(Java.Object key) :730
void JavaMap__ContainsKey_fn(JavaMap* __this, ::g::Java::Object* key, bool* __retval)
{
    *__retval = __this->ContainsKey(key);
}

// private static bool ContainsKey(Java.Object handle, Java.Object key) :763
...
// private static Java.Object Create() [static] :741
...
// private static object Get(Java.Object handle, Java.Object key) [static] :771
uObject* JavaMap::Get1(::g::Java::Object* handle, ::g::Java::Object* key)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Get1136", "(Ljava/lang/Object;Ljava/lang/Object;)Lcom/uno/UnoObject;");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _ukey=key;
        jobject _key = (_ukey==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ukey, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void Put(Java.Object handle, Java.Object key, object value) [static] :747
void JavaMap::Put(::g::Java::Object* handle, ::g::Java::Object* key, uObject* value)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Put137", "(Ljava/lang/Object;Ljava/lang/Object;Lcom/uno/UnoObject;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _ukey=key;
        jobject _key = (_ukey==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ukey, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void Remove(Java.Object handle, Java.Object key) [static] :755
void JavaMap::Remove1(::g::Java::Object* handle, ::g::Java::Object* key)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Remove1138", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _ukey=key;
        jobject _key = (_ukey==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ukey, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public abstract extern class LeafView :970
// {
...
// protected LeafView(Java.Object handle) :972
void LeafView__ctor_4_fn(LeafView* __this, ::g::Java::Object* handle)
{
    __this->ctor_4(handle);
}

// protected LeafView(Java.Object handle) [instance] :972
void LeafView::ctor_4(::g::Java::Object* handle)
{
    ctor_3(handle, true);
}
// }
...
// public sealed extern class MotionEvent :780
// {
static void MotionEvent_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        ...
        new uFunction("PointerEventDataForView", NULL, (void*)MotionEvent__PointerEventDataForView_fn, 0, false, ::TYPES[17/*Fuse.Input.PointerEventData[]*/], 2, ::g::Java::Object_typeof(), ::g::Uno::Float_typeof()),
...
// public override sealed bool Equals(object obj) :843
...
// private long GetEventTime(Java.Object handle) :895
...
// private float2 GetLocationOnScreen(Java.Object viewHandle) :855
...
// private int GetLocationOnScreenX(Java.Object viewHandle) :861
...
// private int GetLocationOnScreenY(Java.Object viewHandle) :869
...
// private int GetPointerCount(Java.Object handle) :901
...
// public int GetPointerId(int pointerIndex) :790
...
// private int GetPointerId(Java.Object handle, int pointerIndex) :883
...
// private float GetX(Java.Object handle, int pointerIndex) :907
...
// private float GetY(Java.Object handle, int pointerIndex) :913
...
// private int GetActionMasked(Java.Object handle) [instance] :889
int MotionEvent::GetActionMasked(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetActionMasked141", "(Lcom/uno/UnoObject;Ljava/lang/Object;)I");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private long GetEventTime(Java.Object handle) [instance] :895
int64_t MotionEvent::GetEventTime(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetEventTime142", "(Lcom/uno/UnoObject;Ljava/lang/Object;)J");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private float2 GetLocationOnScreen(Java.Object viewHandle) [instance] :855
...
// private int GetLocationOnScreenX(Java.Object viewHandle) [instance] :861
int MotionEvent::GetLocationOnScreenX(::g::Java::Object* viewHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLocationOnScreenX143", "(Lcom/uno/UnoObject;Ljava/lang/Object;)I");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private int GetLocationOnScreenY(Java.Object viewHandle) [instance] :869
int MotionEvent::GetLocationOnScreenY(::g::Java::Object* viewHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLocationOnScreenY144", "(Lcom/uno/UnoObject;Ljava/lang/Object;)I");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private int GetPointerCount(Java.Object handle) [instance] :901
int MotionEvent::GetPointerCount(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetPointerCount145", "(Lcom/uno/UnoObject;Ljava/lang/Object;)I");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public int GetPointerId(int pointerIndex) [instance] :790
int MotionEvent::GetPointerId(int pointerIndex)
{
    return GetPointerId1(_handle, pointerIndex);
}

// private int GetPointerId(Java.Object handle, int pointerIndex) [instance] :883
int MotionEvent::GetPointerId1(::g::Java::Object* handle, int pointerIndex)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetPointerId1146", "(Lcom/uno/UnoObject;Ljava/lang/Object;I)I");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public float2 GetPosition(int pointerIndex) [instance] :815
...
// private float GetX(Java.Object handle, int pointerIndex) [instance] :907
float MotionEvent::GetX(::g::Java::Object* handle, int pointerIndex)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetX149", "(Lcom/uno/UnoObject;Ljava/lang/Object;I)F");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private float GetY(Java.Object handle, int pointerIndex) [instance] :913
float MotionEvent::GetY(::g::Java::Object* handle, int pointerIndex)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetY151", "(Lcom/uno/UnoObject;Ljava/lang/Object;I)F");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public int get_PointerCount() [instance] :812
int MotionEvent::PointerCount()
{
    return GetPointerCount(_handle);
}

// public Fuse.Input.PointerEventData[] PointerEventDataForView(Java.Object view, float pointDensity) [instance] :820
...
// private static bool Compare(Java.Object handle1, Java.Object handle2) [static] :953
bool MotionEvent::Compare(::g::Java::Object* handle1, ::g::Java::Object* handle2)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Compare139", "(Ljava/lang/Object;Ljava/lang/Object;)Z");
...
// private static int GetPointerIndexMask() [static] :941
int MotionEvent::GetPointerIndexMask()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetPointerIndexMask147", "()I");
...
// private static int GetPointerIndexShift() [static] :947
int MotionEvent::GetPointerIndexShift()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetPointerIndexShift148", "()I");
        jint __jresult = U_JNIVAR->CallStaticIntMethod(__cls,__mtd);
        int __result = (int)__jresult;
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// public MotionEvent New(Java.Object handle) [static] :785
...
// public static int get_PointerIndexMask() [static] :932
int MotionEvent::PointerIndexMask()
{
    return MotionEvent::GetPointerIndexMask();
}

// public static int get_PointerIndexShift() [static] :937
...
// internal sealed extern class NativeViewRenderer :985
// {
...
// private void Fuse.Controls.Native.INativeViewRenderer.Invalidate() :1078
void NativeViewRenderer__FuseControlsNativeINativeViewRendererInvalidate_fn(NativeViewRenderer* __this)
{
    __this->_visualValid = false;
}

// public NativeViewRenderer New(Java.Object viewHandle) :994
...
// private void Uno.IDisposable.Dispose() :1083
void NativeViewRenderer__UnoIDisposableDispose_fn(NativeViewRenderer* __this)
{
    __this->DeleteTexture();
}

// private static void Upload(Java.Object viewHandle, Java.Object bitmapHandle, bool reuse, int w, int h) :1036
...
// public NativeViewRenderer(Java.Object viewHandle) [instance] :994
...
// private void DeleteTexture() [instance] :1088
...
// private static Java.Object CreateBitmap(int w, int h) [static] :1073
::g::Java::Object* NativeViewRenderer::CreateBitmap(int w, int h)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateBitmap153", "(II)Ljava/lang/Object;");
        int _uw=w;
        jint _w = (jint)_uw;
        int _uh=h;
        jint _h = (jint)_uh;
...
// private static void DisposeBitmap(Java.Object bitmap) [static] :1067
void NativeViewRenderer::DisposeBitmap(::g::Java::Object* bitmap)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "DisposeBitmap154", "(Ljava/lang/Object;)V");
...
// public NativeViewRenderer New(Java.Object viewHandle) [static] :994
...
// private static void Upload(Java.Object viewHandle, Java.Object bitmapHandle, bool reuse, int w, int h) [static] :1036
void NativeViewRenderer::Upload(::g::Java::Object* viewHandle, ::g::Java::Object* bitmapHandle, bool reuse, int w, int h)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Upload155", "(Ljava/lang/Object;Ljava/lang/Object;ZII)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _ubitmapHandle=bitmapHandle;
        jobject _bitmapHandle = (_ubitmapHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ubitmapHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// internal sealed extern class Rectangle :1146
// {
...
// public generated Rectangle() :1146
void Rectangle__ctor_5_fn(Rectangle* __this)
{
    __this->ctor_5();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1151
...
// public generated Rectangle New() :1146
void Rectangle__New3_fn(Rectangle** __retval)
{
    *__retval = Rectangle::New3();
}

// protected override sealed void UpdateShapeDrawable(Java.Object handle, float pixelsPerPoint) :1158
...
// private void UpdateShapeDrawable(Java.Object handle, float x, float y, float z, float w) :1165
...
// public generated Rectangle() [instance] :1146
...
// private void UpdateShapeDrawable(Java.Object handle, float x, float y, float z, float w) [instance] :1165
void Rectangle::UpdateShapeDrawable1(::g::Java::Object* handle, float x, float y, float z, float w)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "UpdateShapeDrawable1156", "(Lcom/uno/UnoObject;Ljava/lang/Object;FFFF)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public generated Rectangle New() [static] :1146
...
static void ScrollView_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", NULL, (void*)ScrollView__New3_fn, 0, true, type, 1, ::TYPES[18/*Fuse.Controls.Native.IScrollViewHost*/]),
...
// public ScrollView(Fuse.Controls.Native.IScrollViewHost host) :1198
void ScrollView__ctor_4_fn(ScrollView* __this, uObject* host)
{
    __this->ctor_4(host);
}

// private Java.Object AddCallback(Java.Object handle) :1217
...
// private Java.Object AddCallback(Java.Object handle) [instance] :1217
::g::Java::Object* ScrollView::AddCallback(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddCallback157", "(Lcom/uno/UnoObject;Ljava/lang/Object;)Ljava/lang/Object;");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public void set_AllowedScrollDirections(Fuse.Controls.ScrollDirections value) [instance] :1230
void ScrollView::AllowedScrollDirections(int value)
{
}

// private void OnScrollChanged(int x, int y, int oldx, int oldy) [instance] :1242
...
// public void set_ScrollPosition(float2 value) [instance] :1235
...
// private static Java.Object Create() [static] :1211
::g::Java::Object* ScrollView::Create()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create159", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) [static] :1198
...
// private static void SetScrollPosition(Java.Object handle, int x, int y) [static] :1257
void ScrollView::SetScrollPosition(::g::Java::Object* handle, int x, int y)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetScrollPosition161", "(Ljava/lang/Object;II)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ux=x;
        jint _x = (jint)_ux;
...
// internal abstract extern class Shape :1278
// {
static void Shape_build(uType* type)
{
    ...
    ::TYPES[23] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[24] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*OrderBy<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
...
// protected Shape() :1282
void Shape__ctor_4_fn(Shape* __this)
{
    __this->ctor_4();
}

// private static Java.Object Create() :1445
void Shape__Create_fn(::g::Java::Object** __retval)
{
    *__retval = Shape::Create();
}

// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :1291
...
// private static Java.Object GetLayer(Java.Object handle, int layer) :1457
void Shape__GetLayer_fn(::g::Java::Object* handle, int* layer, ::g::Java::Object** __retval)
{
    *__retval = Shape::GetLayer(handle, *layer);
}

// private static Java.Object MakeLayerDrawable(Java.Object handle, int layerCount) :1464
...
// protected void OnShapeChanged() :1301
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :1369
...
// private void SetBrush(Java.Object shapeDrawable, Fuse.Drawing.Brush brush) :1336
...
// private void SetLinearGradient(Java.Object shapeDrawable, Fuse.Drawing.LinearGradient linearGradient) :1374
...
// private static void SetShapeDrawableColor(Java.Object shapeDrawable, int r, int g, int b, int a, int opacity) :1429
...
// private static void SetShapeDrawableLinearGradient(Java.Object shapeDrawable, float startX, float startY, float endX, float endY, int[] colors, float[] positions) :1401
...
// private static void SetShapeDrawableStrokeWidth(Java.Object shapeDrawable, float width) :1437
...
// private void SetStroke(Java.Object shapeDrawable, Fuse.Drawing.Stroke stroke) :1328
...
// protected Shape() [instance] :1282
void Shape::ctor_4()
{
    ctor_2(Shape::Create());
}

// protected void OnShapeChanged() [instance] :1301
...
// private void SetBrush(Java.Object shapeDrawable, Fuse.Drawing.Brush brush) [instance] :1336
void Shape::SetBrush(::g::Java::Object* shapeDrawable, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[4/*""*/], brush, ::STRINGS[1/*"C:\\Users\\...*/], 1353, ::STRINGS[5/*"SetBrush"*/]);
...
// private void SetLinearGradient(Java.Object shapeDrawable, Fuse.Drawing.LinearGradient linearGradient) [instance] :1374
...
// private void SetStroke(Java.Object shapeDrawable, Fuse.Drawing.Stroke stroke) [instance] :1328
...
// private static Java.Object Create() [static] :1445
...
// private static Java.Object GetLayer(Java.Object handle, int layer) [static] :1457
::g::Java::Object* Shape::GetLayer(::g::Java::Object* handle, int layer)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLayer164", "(Ljava/lang/Object;I)Ljava/lang/Object;");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ulayer=layer;
...
// private static Java.Object MakeLayerDrawable(Java.Object handle, int layerCount) [static] :1464
::g::Java::Object* Shape::MakeLayerDrawable(::g::Java::Object* handle, int layerCount)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "MakeLayerDrawable165", "(Ljava/lang/Object;I)Ljava/lang/Object;");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :1369
...
// private static void SetShapeDrawableColor(Java.Object shapeDrawable, int r, int g, int b, int a, int opacity) [static] :1429
void Shape::SetShapeDrawableColor(::g::Java::Object* shapeDrawable, int r, int g, int b, int a, int opacity)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetShapeDrawableColor166", "(Ljava/lang/Object;IIIII)V");
...
// private static void SetShapeDrawableLinearGradient(Java.Object shapeDrawable, float startX, float startY, float endX, float endY, int[] colors, float[] positions) [static] :1401
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetShapeDrawableLinearGradient167", "(Ljava/lang/Object;FFFFLcom/uno/IntArray;Lcom/uno/FloatArray;)V");
        ::g::Java::Object* _ushapeDrawable=shapeDrawable;
        jobject _shapeDrawable = (_ushapeDrawable==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ushapeDrawable, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetShapeDrawableStrokeWidth(Java.Object shapeDrawable, float width) [static] :1437
void Shape::SetShapeDrawableStrokeWidth(::g::Java::Object* shapeDrawable, float width)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetShapeDrawableStrokeWidth168", "(Ljava/lang/Object;F)V");
        ::g::Java::Object* _ushapeDrawable=shapeDrawable;
        jobject _shapeDrawable = (_ushapeDrawable==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ushapeDrawable, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _uwidth=width;
        jfloat _width = (jfloat)_uwidth;
...
static void Slider_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)Slider__New3_fn, 0, true, type, 1, ::TYPES[27/*Fuse.Controls.Native.IRangeViewHost*/]),
...
// private void AddChangedCallback(Java.Object handle) [instance] :1540
void Slider::AddChangedCallback(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddChangedCallback169", "(Lcom/uno/UnoObject;Ljava/lang/Object;)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private void OnSeekBarChanged(double newProgress) [instance] :1551
...
// public void set_Progress(double value) [instance] :1513
void Slider::Progress(double value)
{
    Slider::SetProgress(Handle(), value);
}

// private static Java.Object Create() [static] :1526
...
// public Slider New(Fuse.Controls.Native.IRangeViewHost host) [static] :1519
...
// private static void SetProgress(Java.Object handle, double progress) [static] :1534
void Slider::SetProgress(::g::Java::Object* handle, double progress)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetProgress172", "(Ljava/lang/Object;D)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// internal static extern class SoftKeyboard :2210
// {
...
// public static void HideKeyboard(Java.Object hideKeyboardContext, Java.Object hideKeyboardWindowToken) :2214
...
// public static void ShowKeyboard(Java.Object viewHandle) :2223
void SoftKeyboard__ShowKeyboard_fn(::g::Java::Object* viewHandle)
{
    SoftKeyboard::ShowKeyboard(viewHandle);
}

// public static void HideKeyboard(Java.Object hideKeyboardContext, Java.Object hideKeyboardWindowToken) [static] :2214
void SoftKeyboard::HideKeyboard(::g::Java::Object* hideKeyboardContext, ::g::Java::Object* hideKeyboardWindowToken)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "HideKeyboard173", "(Ljava/lang/Object;Ljava/lang/Object;)V");
...
// public static void ShowKeyboard(Java.Object viewHandle) [static] :2223
void SoftKeyboard::ShowKeyboard(::g::Java::Object* viewHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ShowKeyboard174", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_viewHandle);
...
{
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Controls::Native::Android::GraphicsView_type, interface0),
        ::g::Fuse::Controls::Native::IView_typeof(), offsetof(::g::Fuse::Controls::Native::Android::GraphicsView_type, interface1),
        ::g::Fuse::Controls::Native::IGraphicsView_typeof(), offsetof(::g::Fuse::Controls::Native::Android::GraphicsView_type, interface2),
        ::g::Fuse::Controls::Native::IViewHost_typeof(), offsetof(::g::Fuse::Controls::Native::Android::GraphicsView_type, interface3));
    type->SetFields(8);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SurfaceView__New3_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::Native::Android::GraphicsView_type* SurfaceView_typeof()
{
    ...
    type->fp_ctor_ = (void*)SurfaceView__New3_fn;
    type->interface3.fp_Insert = (void(*)(uObject*, ::g::Fuse::Controls::Native::ViewHandle*))::g::Fuse::Controls::Native::Android::GraphicsView__FuseControlsNativeIViewHostInsert_fn;
    type->interface3.fp_Remove = (void(*)(uObject*, ::g::Fuse::Controls::Native::ViewHandle*))::g::Fuse::Controls::Native::Android::GraphicsView__FuseControlsNativeIViewHostRemove_fn;
...
// private void OnSurfaceChanged(Java.Object holder, int f, int w, int h) [instance] :1582
void SurfaceView::OnSurfaceChanged(::g::Java::Object* holder, int f, int w, int h)
{
}

// private void OnSurfaceCreated(Java.Object holder) [instance] :1583
...
// private void OnSurfaceDestroyed(Java.Object holder) [instance] :1587
void SurfaceView::OnSurfaceDestroyed(::g::Java::Object* holder)
{
    DestroySurface();
}

// private void OnSurfaceRedrawNeeded(Java.Object holder) [instance] :1581
void SurfaceView::OnSurfaceRedrawNeeded(::g::Java::Object* holder)
{
}

// private static Java.Object Create() [static] :1618
...
// private static Java.Object GetSurface(Java.Object holder) [static] :1593
::g::Java::Object* SurfaceView::GetSurface(::g::Java::Object* holder)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetSurface181", "(Ljava/lang/Object;)Ljava/lang/Object;");
...
// public SurfaceView New() [static] :1576
SurfaceView* SurfaceView::New3()
{
...
static void Switch_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)Switch__New3_fn, 0, true, type, 1, ::TYPES[28/*Fuse.Controls.Native.IToggleViewHost*/]),
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :1655
void Switch__ctor_5_fn(Switch* __this, uObject* host)
{
    __this->ctor_5(host);
}

// private void AddCallback(Java.Object handle) :1668
void Switch__AddCallback_fn(Switch* __this, ::g::Java::Object* handle)
{
    __this->AddCallback(handle);
}

// private static Java.Object Create() :1662
void Switch__Create_fn(::g::Java::Object** __retval)
{
    *__retval = Switch::Create();
}

// public override sealed void Dispose() :1688
...
// private void AddCallback(Java.Object handle) [instance] :1668
void Switch::AddCallback(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddCallback182", "(Lcom/uno/UnoObject;Ljava/lang/Object;)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private void OnToggleChanged(bool value) [instance] :1683
...
// public void set_Value(bool value) [instance] :1649
void Switch::Value(bool value)
{
    Switch::SetValue(Handle(), value);
}

// private static Java.Object Create() [static] :1662
::g::Java::Object* Switch::Create()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create184", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :1655
...
// private static void SetValue(Java.Object handle, bool value) [static] :1678
void Switch::SetValue(::g::Java::Object* handle, bool value)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetValue185", "(Ljava/lang/Object;Z)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        bool _uvalue=value;
...
// public sealed extern class TextEdit :1704
// {
static void TextEdit_build(uType* type)
{
    ...
    type->SetFields(13);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)TextEdit__New6_fn, 0, true, type, 2, ::g::Fuse::Controls::Native::ITextEditHost_typeof(), ::g::Uno::Bool_typeof()));
}
...
// public TextEdit(Fuse.Controls.Native.ITextEditHost host, bool isMultiline) :1706
void TextEdit__ctor_8_fn(TextEdit* __this, uObject* host, bool* isMultiline)
{
    __this->ctor_8(host, *isMultiline);
}

// private static void MakeItPlain(Java.Object handle) :1712
void TextEdit__MakeItPlain_fn(::g::Java::Object* handle)
{
    TextEdit::MakeItPlain(handle);
}

// public TextEdit New(Fuse.Controls.Native.ITextEditHost host, bool isMultiline) :1706
void TextEdit__New6_fn(uObject* host, bool* isMultiline, TextEdit** __retval)
{
    *__retval = TextEdit::New6(host, *isMultiline);
}

// public TextEdit(Fuse.Controls.Native.ITextEditHost host, bool isMultiline) [instance] :1706
void TextEdit::ctor_8(uObject* host, bool isMultiline)
{
    ctor_7(host, isMultiline);
    TextEdit::MakeItPlain(Handle());
}

// private static void MakeItPlain(Java.Object handle) [static] :1712
void TextEdit::MakeItPlain(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "MakeItPlain186", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_handle);
...
// public TextEdit New(Fuse.Controls.Native.ITextEditHost host, bool isMultiline) [static] :1706
TextEdit* TextEdit::New6(uObject* host, bool isMultiline)
{
    TextEdit* obj1 = (TextEdit*)uNew(TextEdit_typeof());
    obj1->ctor_8(host, isMultiline);
    return obj1;
}
// }
...
// public extern class TextInput :1723
// {
static void TextInput_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::TYPES[7/*Uno.IDisposable*/], offsetof(TextInput_type, interface0),
    ...
    type->SetFields(4,
        ...
        ::TYPES[7/*Uno.IDisposable*/], offsetof(::g::Fuse::Controls::Native::Android::TextInput, _focusEvent), 0,
    ...
    type->Reflection.SetFunctions(12,
        ...
        new uFunction(".ctor", NULL, (void*)TextInput__New5_fn, 0, true, type, 2, ::TYPES[30/*Fuse.Controls.Native.ITextEditHost*/], ::g::Uno::Bool_typeof()),
...
// public void set_ActionStyle(Fuse.Controls.TextInputActionStyle value) [instance] :1862
...
// private void AddEditorActionListener(Java.Object handle) [instance] :2128
void TextInput::AddEditorActionListener(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddEditorActionListener187", "(Lcom/uno/UnoObject;Ljava/lang/Object;)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private void AddTextChangedListener(Java.Object handle) [instance] :2089
void TextInput::AddTextChangedListener(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddTextChangedListener189", "(Lcom/uno/UnoObject;Ljava/lang/Object;)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public void set_AutoCapitalizationHint(Fuse.Controls.AutoCapitalizationHint value) [instance] :1842
...
// public void set_AutoCorrectHint(Fuse.Controls.AutoCorrectHint value) [instance] :1832
...
// public void set_CaretColor(float4 value) [instance] :1957
void TextInput::CaretColor(::g::Uno::Float4 value)
{
    SetCursorDrawableColor(Handle(), (int)::g::Uno::Color::ToArgb(value));
}

// public void set_InputHint(Fuse.Controls.TextInputHint value) [instance] :1852
...
// public void set_IsMultiline(bool value) [instance] :1802
...
// public void set_IsPassword(bool value) [instance] :1812
...
// public void set_IsReadOnly(bool value) [instance] :1822
...
// private bool OnEditorAction(int actionCode) [instance] :2142
...
// private void OnNativeFocusChanged(Java.Object view, bool hasFocus) [instance] :1736
...
// private void OnTextChanged(string value) [instance] :2137
...
// public void set_PlaceholderColor(float4 value) [instance] :1972
void TextInput::PlaceholderColor(::g::Uno::Float4 value)
{
    TextInput::SetPlaceholderColor(Handle(), (int)::g::Uno::Color::ToArgb(value));
}

// public void set_PlaceholderText(string value) [instance] :1967
void TextInput::PlaceholderText(uString* value)
{
    TextInput::SetPlaceholderText(Handle(), value);
}

// private int get_ReturnKeyType() [instance] :1989
...
// private void ScheduleFocusLoss() [instance] :1751
...
// public void set_SelectionColor(float4 value) [instance] :1962
void TextInput::SelectionColor(::g::Uno::Float4 value)
{
    TextInput::SetSelectionColor(Handle(), (int)::g::Uno::Color::ToArgb(value));
}

// private void SetCursorDrawableColor(Java.Object handle, int color) [instance] :2045
void TextInput::SetCursorDrawableColor(::g::Java::Object* handle, int color)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetCursorDrawableColor195", "(Lcom/uno/UnoObject;Ljava/lang/Object;I)V");
        uObject* _uthis=this;
        jobject _this_ = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(_uthis);
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private void UpdateFlags() [instance] :1869
...
// private static Java.Object Create() [static] :2039
::g::Java::Object* TextInput::Create1()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create1192", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// private static bool HasFocus(Java.Object viewHandle) [static] :1781
bool TextInput::HasFocus(::g::Java::Object* viewHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "HasFocus193", "(Ljava/lang/Object;)Z");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        jboolean __jresult = U_JNIVAR->CallStaticBooleanMethod(__cls,__mtd,_viewHandle);
        bool __result = (bool)__jresult;
...
// public TextInput New(Fuse.Controls.Native.ITextEditHost host, bool isMultiline) [static] :1727
TextInput* TextInput::New5(uObject* host, bool isMultiline)
{
    TextInput* obj1 = (TextInput*)uNew(TextInput_typeof());
    obj1->ctor_7(host, isMultiline);
    return obj1;
}

// private static void RequestFocus(Java.Object viewHandle) [static] :1787
void TextInput::RequestFocus(::g::Java::Object* viewHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "RequestFocus194", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uviewHandle=viewHandle;
        jobject _viewHandle = (_uviewHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uviewHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_viewHandle);
...
// private static void SetImeOptions(Java.Object handle, int value) [static] :2033
void TextInput::SetImeOptions(::g::Java::Object* handle, int value)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetImeOptions196", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uvalue=value;
...
// private static void SetInputType(Java.Object handle, int value) [static] :2010
void TextInput::SetInputType(::g::Java::Object* handle, int value)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetInputType197", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uvalue=value;
        jint _value = (jint)_uvalue;
...
// private static void SetPlaceholderColor(Java.Object handle, int value) [static] :1976
void TextInput::SetPlaceholderColor(::g::Java::Object* handle, int value)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetPlaceholderColor198", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uvalue=value;
        jint _value = (jint)_uvalue;
...
// private static void SetPlaceholderText(Java.Object handle, string value) [static] :1982
void TextInput::SetPlaceholderText(::g::Java::Object* handle, uString* value)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetPlaceholderText199", "(Ljava/lang/Object;Ljava/lang/String;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetSelectionColor(Java.Object handle, int color) [static] :2004
void TextInput::SetSelectionColor(::g::Java::Object* handle, int color)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetSelectionColor200", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ucolor=color;
        jint _color = (jint)_ucolor;
...
// public extern class TextView :2303
// {
static void TextView_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction(".ctor", NULL, (void*)TextView__New4_fn, 0, true, type, 1, ::g::Java::Object_typeof()),
...
// public void set_FontSize(float value) [instance] :2335
void TextView::FontSize(float value)
{
    TextView::SetFontSize(Handle(), value);
}

// public void set_LineSpacing(float value) [instance] :2330
void TextView::LineSpacing(float value)
{
    TextView::SetLineSpacing(Handle(), value);
}

// public void set_MaxLength(int value) [instance] :2316
void TextView::MaxLength(int value)
{
    TextView::SetMaxLength(Handle(), (value == 0) ? 2147483647 : value);
}

// public void set_TextAlignment(Fuse.Controls.TextAlignment value) [instance] :2351
...
// public void set_TextColor(float4 value) [instance] :2364
void TextView::TextColor(::g::Uno::Float4 value)
{
    TextView::SetTextColor(Handle(), (int)::g::Uno::Color::ToArgb(value));
}

// public void set_TextTruncation(Fuse.Controls.TextTruncation value) [instance] :2369
void TextView::TextTruncation(int value)
{
}

// public void set_TextWrapping(Fuse.Controls.TextWrapping value) [instance] :2325
void TextView::TextWrapping(int value)
{
    TextView::SetTextWrapping(Handle(), value == 1);
}

// public void set_Value(string value) [instance] :2311
void TextView::Value(uString* value)
{
    TextView::SetText(Handle(), value);
}

// private static Java.Object Create() [static] :2373
...
// public TextView New() [static] :2307
...
// public TextView New(Java.Object handle) [static] :2305
TextView* TextView::New4(::g::Java::Object* handle)
{
...
// private static void SetFont(Java.Object handle, Java.Object fontHandle) [static] :2406
void TextView::SetFont(::g::Java::Object* handle, ::g::Java::Object* fontHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetFont202", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetFontSize(Java.Object handle, float size) [static] :2400
void TextView::SetFontSize(::g::Java::Object* handle, float size)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetFontSize203", "(Ljava/lang/Object;F)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _usize=size;
...
// private static void SetLineSpacing(Java.Object handle, float spacing) [static] :2394
void TextView::SetLineSpacing(::g::Java::Object* handle, float spacing)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetLineSpacing204", "(Ljava/lang/Object;F)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetMaxLength(Java.Object handle, int maxLength) [static] :2427
void TextView::SetMaxLength(::g::Java::Object* handle, int maxLength)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetMaxLength205", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetText(Java.Object handle, string text) [static] :2379
void TextView::SetText(::g::Java::Object* handle, uString* text)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetText206", "(Ljava/lang/Object;Ljava/lang/String;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        uString* _utext=text;
        jstring _text = JniHelper::UnoToJavaString(_utext);
...
// private static void SetTextAlignment(Java.Object handle, int alignment) [static] :2412
void TextView::SetTextAlignment(::g::Java::Object* handle, int alignment)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTextAlignment207", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SetTextColor(Java.Object handle, int color) [static] :2421
void TextView::SetTextColor(::g::Java::Object* handle, int color)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTextColor208", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ucolor=color;
        jint _color = (jint)_ucolor;
...
// private static void SetTextWrapping(Java.Object handle, bool wrap) [static] :2388
void TextView::SetTextWrapping(::g::Java::Object* handle, bool wrap)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTextWrapping209", "(Ljava/lang/Object;Z)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        bool _uwrap=wrap;
...
// internal sealed extern class Typeface :2450
// {
static void Typeface_build(uType* type)
{
    ::TYPES[8] = ::g::Java::Object_typeof();
    type->SetFields(0,
        ::TYPES[8/*Java.Object*/], offsetof(::g::Fuse::Controls::Native::Android::Typeface, _handle), 0);
}
...
// public Typeface(Java.Object handle) :2460
void Typeface__ctor__fn(Typeface* __this, ::g::Java::Object* handle)
{
    __this->ctor_(handle);
}

// private static Java.Object CreateFromBundleFile(string bundlePath) :2493
...
// public static Fuse.Controls.Native.Android.Typeface CreateFromBundleFile(Uno.IO.BundleFile file) :2482
...
void Typeface__Equals_fn(Typeface* __this, uObject* obj, bool* __retval)
{
    ...
    return *__retval = uIs(obj, ::TYPES[8/*Java.Object*/]) ? ::g::Uno::Object::Equals(uPtr(__this->_handle), uCast< ::g::Java::Object*>(obj, ::TYPES[8/*Java.Object*/])) : false, void();
}

// private static Java.Object GetDefault() :2507
void Typeface__GetDefault_fn(::g::Java::Object** __retval)
{
    *__retval = Typeface::GetDefault();
}

// public override sealed int GetHashCode() :2477
...
// public Java.Object get_Handle() :2454
void Typeface__get_Handle_fn(Typeface* __this, ::g::Java::Object** __retval)
{
    *__retval = __this->Handle();
}

// public Typeface New(Java.Object handle) :2460
void Typeface__New1_fn(::g::Java::Object* handle, Typeface** __retval)
{
    *__retval = Typeface::New1(handle);
}

// public Typeface(Java.Object handle) [instance] :2460
void Typeface::ctor_(::g::Java::Object* handle)
{
    _handle = handle;
}

// public Java.Object get_Handle() [instance] :2454
::g::Java::Object* Typeface::Handle()
{
    return _handle;
}

// private static Java.Object CreateFromBundleFile(string bundlePath) [static] :2493
::g::Java::Object* Typeface::CreateFromBundleFile(uString* bundlePath)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateFromBundleFile210", "(Ljava/lang/String;)Ljava/lang/Object;");
...
// public static Fuse.Controls.Native.Android.Typeface CreateFromBundleFile(Uno.IO.BundleFile file) [static] :2482
...
// public static Fuse.Controls.Native.Android.Typeface CreateFromFile(string path) [static] :2487
Typeface* Typeface::CreateFromFile(uString* path)
{
    return Typeface::New1(Typeface::CreateFromFileImpl(path));
}

// private static Java.Object CreateFromFileImpl(string path) [static] :2501
::g::Java::Object* Typeface::CreateFromFileImpl(uString* path)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateFromFileImpl211", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _upath=path;
...
// private static Java.Object GetDefault() [static] :2507
::g::Java::Object* Typeface::GetDefault()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetDefault212", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// public Typeface New(Java.Object handle) [static] :2460
...
// public static Fuse.Controls.Native.Android.Typeface get_Default() [static] :2467
...
// internal static extern class TypefaceCache :2513
// {
// static TypefaceCache() :2513
...
// public static Fuse.Controls.Native.Android.Typeface GetTypeface(Fuse.Font font) :2518
...
// private static Fuse.Controls.Native.Android.Typeface GetTypefaceFromBundleFile(Uno.IO.BundleFile file) :2525
...
// private static Fuse.Controls.Native.Android.Typeface GetTypefaceFromFileSource(Uno.UX.FileSource fileSource) :2535
...
// public static Fuse.Controls.Native.Android.Typeface GetTypeface(Fuse.Font font) [static] :2518
...
// private static Fuse.Controls.Native.Android.Typeface GetTypefaceFromBundleFile(Uno.IO.BundleFile file) [static] :2525
...
// private static Fuse.Controls.Native.Android.Typeface GetTypefaceFromFileSource(Uno.UX.FileSource fileSource) [static] :2535
...
// protected View(Java.Object handle) :2583
void View__ctor_2_fn(View* __this, ::g::Java::Object* handle)
{
    __this->ctor_2(handle);
}

// protected View(Java.Object handle, bool isLeafView) :2585
void View__ctor_3_fn(View* __this, ::g::Java::Object* handle, bool* isLeafView)
{
    __this->ctor_3(handle, *isLeafView);
}

// public Java.Object get_Handle() :2579
void View__get_Handle_fn(View* __this, ::g::Java::Object** __retval)
{
    *__retval = __this->Handle();
}

// protected View(Java.Object handle) [instance] :2583
void View::ctor_2(::g::Java::Object* handle)
{
    ctor_3(handle, false);
}

// protected View(Java.Object handle, bool isLeafView) [instance] :2585
void View::ctor_3(::g::Java::Object* handle, bool isLeafView)
{
    ctor_1(handle, isLeafView);
    _handle = handle;
}

// public Java.Object get_Handle() [instance] :2579
...
// public generated ViewGroup() :2600
void ViewGroup__ctor__fn(ViewGroup* __this)
{
    __this->ctor_();
}

// internal static void AddView(Java.Object parentHandle, Java.Object childHandle) :2613
...
// internal static void AddView(Java.Object parentHandle, Java.Object childHandle, int index) :2621
...
// internal static Java.Object Create() :2603
void ViewGroup__Create_fn(::g::Java::Object** __retval)
{
    *__retval = ViewGroup::Create();
}

// public generated ViewGroup New() :2600
void ViewGroup__New1_fn(ViewGroup** __retval)
{
    *__retval = ViewGroup::New1();
}

// internal static void RemoveView(Java.Object parentHandle, Java.Object childHandle) :2629
...
// public generated ViewGroup() [instance] :2600
void ViewGroup::ctor_()
{
}

// internal static void AddView(Java.Object parentHandle, Java.Object childHandle) [static] :2613
void ViewGroup::AddView(::g::Java::Object* parentHandle, ::g::Java::Object* childHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddView213", "(Ljava/lang/Object;Ljava/lang/Object;)V");
...
// internal static void AddView(Java.Object parentHandle, Java.Object childHandle, int index) [static] :2621
void ViewGroup::AddView1(::g::Java::Object* parentHandle, ::g::Java::Object* childHandle, int index)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "AddView1214", "(Ljava/lang/Object;Ljava/lang/Object;I)V");
        ::g::Java::Object* _uparentHandle=parentHandle;
        jobject _parentHandle = (_uparentHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uparentHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _uchildHandle=childHandle;
        jobject _childHandle = (_uchildHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uchildHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// internal static Java.Object Create() [static] :2603
...
// public generated ViewGroup New() [static] :2600
...
// internal static void RemoveView(Java.Object parentHandle, Java.Object childHandle) [static] :2629
void ViewGroup::RemoveView(::g::Java::Object* parentHandle, ::g::Java::Object* childHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "RemoveView216", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uparentHandle=parentHandle;
        jobject _parentHandle = (_uparentHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uparentHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _uchildHandle=childHandle;
        jobject _childHandle = (_uchildHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uchildHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
