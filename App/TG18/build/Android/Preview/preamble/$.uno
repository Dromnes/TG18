...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.56.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.100.30"), 12124)}, "D:\\TG18\\TG18_code\\App\\TG18\\TG18.unoproj", GetBundle, new string[] { })
{
